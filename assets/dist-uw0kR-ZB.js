...
`).find(e=>!e.trim().startsWith(`#`)&&e.trim()!==``)?.trim()}async function Po(e){if(!e)return!1;if(/\.m3u8?(\?.*)?$/i.test(e))return!0;if(e.startsWith(`blob:`))return!1;try{let t=(await fetch(e,{method:`HEAD`})).headers.get(`Content-Type`);return vo.some(e=>t===e)}catch(e){return console.error(`Error while trying to get the Content-Type of the manifest`,e),!1}}async function Fo(e){if(!e||e.startsWith(`blob:`))return{videoFormat:void 0,audioFormat:void 0};try{let t=await(await fetch(e)).text(),n=t,r=Mo(t);if(r.length>0){let t=new URL(r[0],e).toString();n=await(await fetch(t)).text()}let i=Ao(No(n)),a=jo(t),o=i;if(a)try{let t=new URL(a,e).toString();o=Ao(No(await(await fetch(t)).text()))??i}catch(e){console.error(`Error while trying to parse the audio rendition playlist`,e)}return{videoFormat:i,audioFormat:o}}catch(e){return console.error(`Error while trying to parse the manifest playlist`,e),{videoFormat:void 0,audioFormat:void 0}}}var Io=new yo,Lo=new WeakSet,Ro;bo(()=>{if(!globalThis.chrome?.cast?.isAvailable){console.debug(`chrome.cast.isAvailable`,globalThis.chrome?.cast?.isAvailable);return}Ro||(Ro=cast.framework,Co().addEventListener(Ro.CastContextEventType.CAST_STATE_CHANGED,e=>{Io.forEach(t=>ho.get(t).onCastStateChanged?.(e))}),Co().addEventListener(Ro.CastContextEventType.SESSION_STATE_CHANGED,e=>{Io.forEach(t=>ho.get(t).onSessionStateChanged?.(e))}),Io.forEach(e=>ho.get(e).init?.()))});var zo=0,Bo=class extends EventTarget{#e;#t;#n;#r;#i=`disconnected`;#a=!1;#o=new Set;#s=new WeakMap;#c=()=>this.#g();constructor(e){super(),this.#e=e,Io.add(this),ho.set(this,{init:()=>this.#m(),onCastStateChanged:()=>this.#f(),onSessionStateChanged:()=>this.#p(),getCastPlayer:()=>this.#l}),this.#m()}destroy(){this.#e?.textTracks?.removeEventListener(`change`,this.#c),this.#r&&this.#n?.controller&&Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.removeEventListener(e,t)}),this.#e&&Lo.delete(this.#e),this.#t=!1}get#l(){if(Lo.has(this.#e))return this.#n}get state(){return this.#i}async watchAvailability(e){if(this.#e.disableRemotePlayback)throw new go(`disableRemotePlayback attribute is present.`);return this.#s.set(e,++zo),this.#o.add(e),queueMicrotask(()=>e(this.#d())),zo}async cancelWatchAvailability(e){if(this.#e.disableRemotePlayback)throw new go(`disableRemotePlayback attribute is present.`);e?this.#o.delete(e):this.#o.clear()}async prompt(){if(this.#e.disableRemotePlayback)throw new go(`disableRemotePlayback attribute is present.`);if(!globalThis.chrome?.cast?.isAvailable)throw new _o(`The RemotePlayback API is disabled on this platform.`);let e=Lo.has(this.#e);Lo.add(this.#e),Oo(this.#e.castOptions),Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.addEventListener(e,t)});try{await Co().requestSession()}catch(t){if(e||Lo.delete(this.#e),t===`cancel`)return;throw Error(t)}ho.get(this.#e)?.loadOnPrompt?.()}#u(){Lo.has(this.#e)&&(Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.removeEventListener(e,t)}),Lo.delete(this.#e),this.#e.muted=this.#n.isMuted,this.#e.currentTime=this.#n.savedPlayerState.currentTime,this.#n.savedPlayerState.isPaused===!1&&this.#e.play())}#d(){let e=Co()?.getCastState();return e&&e!==`NO_DEVICES_AVAILABLE`}#f(){let e=Co().getCastState();if(Lo.has(this.#e)&&e===`CONNECTING`&&(this.#i=`connecting`,this.dispatchEvent(new Event(`connecting`))),!this.#a&&e?.includes(`CONNECT`)){this.#a=!0;for(let e of this.#o)e(!0)}else if(this.#a&&(!e||e===`NO_DEVICES_AVAILABLE`)){this.#a=!1;for(let e of this.#o)e(!1)}}async#p(){let{SESSION_RESUMED:e}=Ro.SessionState;if(Co().getSessionState()===e&&this.#e.castSrc===To()?.media.contentId){Lo.add(this.#e),Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.addEventListener(e,t)});try{await Do(new chrome.cast.media.GetStatusRequest)}catch(e){console.error(e)}this.#r[Ro.RemotePlayerEventType.IS_PAUSED_CHANGED](),this.#r[Ro.RemotePlayerEventType.PLAYER_STATE_CHANGED]()}}#m(){!Ro||this.#t||(this.#t=!0,Oo(this.#e.castOptions),this.#e.textTracks.addEventListener(`change`,this.#c),this.#f(),this.#n=new Ro.RemotePlayer,new Ro.RemotePlayerController(this.#n),this.#r={[Ro.RemotePlayerEventType.IS_CONNECTED_CHANGED]:({value:e})=>{e===!0?(this.#i=`connected`,this.dispatchEvent(new Event(`connect`))):(this.#u(),this.#i=`disconnected`,this.dispatchEvent(new Event(`disconnect`)))},[Ro.RemotePlayerEventType.DURATION_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`durationchange`))},[Ro.RemotePlayerEventType.VOLUME_LEVEL_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`volumechange`))},[Ro.RemotePlayerEventType.IS_MUTED_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`volumechange`))},[Ro.RemotePlayerEventType.CURRENT_TIME_CHANGED]:()=>{this.#l?.isMediaLoaded&&this.#e.dispatchEvent(new Event(`timeupdate`))},[Ro.RemotePlayerEventType.VIDEO_INFO_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`resize`))},[Ro.RemotePlayerEventType.IS_PAUSED_CHANGED]:()=>{this.#e.dispatchEvent(new Event(this.paused?`pause`:`play`))},[Ro.RemotePlayerEventType.PLAYER_STATE_CHANGED]:()=>{this.#l?.playerState!==chrome.cast.media.PlayerState.PAUSED&&this.#e.dispatchEvent(new Event({[chrome.cast.media.PlayerState.PLAYING]:`playing`,[chrome.cast.media.PlayerState.BUFFERING]:`waiting`,[chrome.cast.media.PlayerState.IDLE]:`emptied`}[this.#l?.playerState]))},[Ro.RemotePlayerEventType.IS_MEDIA_LOADED_CHANGED]:async()=>{this.#l?.isMediaLoaded&&(await Promise.resolve(),this.#h())}})}#h(){this.#g()}async#g(){if(!this.#l)return;let e=(this.#n.mediaInfo?.tracks??[]).filter(({type:e})=>e===chrome.cast.media.TrackType.TEXT),t=[...this.#e.textTracks].filter(({kind:e})=>e===`subtitles`||e===`captions`),n=e.map(({language:e,name:n,trackId:r})=>{let{mode:i}=t.find(t=>t.language===e&&t.label===n)??{};return i?{mode:i,trackId:r}:!1}).filter(Boolean),r=n.filter(({mode:e})=>e!==`showing`).map(({trackId:e})=>e),i=n.find(({mode:e})=>e===`showing`),a=wo()?.getSessionObj().media[0]?.activeTrackIds??[],o=a;if(a.length&&(o=o.filter(e=>!r.includes(e))),i?.trackId&&(o=[...o,i.trackId]),o=[...new Set(o)],!((e,t)=>e.length===t.length&&e.every(e=>t.includes(e)))(a,o))try{await Eo(new chrome.cast.media.EditTracksInfoRequest(o))}catch(e){console.error(e)}}},Vo=e=>class extends e{static observedAttributes=[...e.observedAttributes??[],`cast-src`,`cast-content-type`,`cast-stream-type`,`cast-receiver`];#e={paused:!1};#t=ko();#n;#r;get remote(){return this.#r?this.#r:xo()?this.isConnected?(this.disableRemotePlayback||So(),ho.set(this,{loadOnPrompt:()=>this.#a()}),this.#r=new Bo(this)):void 0:super.remote}get#i(){return ho.get(this.#r)?.getCastPlayer?.()}disconnectedCallback(){this.#r?.destroy(),this.#r=null,ho.delete(this),super.disconnectedCallback?.()}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===`cast-receiver`&&n){this.#t.receiverApplicationId=n;return}if(this.#i)switch(e){case`cast-stream-type`:case`cast-src`:this.load();break}}async#a(){this.#e.paused=super.paused,super.pause(),this.muted=super.muted;try{await this.load()}catch(e){console.error(e)}}async load(){if(!this.#i)return super.load();let e=new chrome.cast.media.MediaInfo(this.castSrc,this.castContentType);e.customData=this.castCustomData;let t=[...this.querySelectorAll(`track`)].filter(({kind:e,src:t})=>t&&(e===`subtitles`||e===`captions`)),n=[],r=0;if(t.length&&(e.tracks=t.map(e=>{let t=++r;n.length===0&&e.track.mode===`showing`&&n.push(t);let i=new chrome.cast.media.Track(t,chrome.cast.media.TrackType.TEXT);return i.trackContentId=e.src,i.trackContentType=`text/vtt`,i.subtype=e.kind===`captions`?chrome.cast.media.TextTrackType.CAPTIONS:chrome.cast.media.TextTrackType.SUBTITLES,i.name=e.label,i.language=e.srclang,i})),this.castStreamType===`live`?e.streamType=chrome.cast.media.StreamType.LIVE:e.streamType=chrome.cast.media.StreamType.BUFFERED,e.metadata=new chrome.cast.media.GenericMediaMetadata,e.metadata.title=this.title,e.metadata.images=[{url:this.poster}],await Po(this.castSrc)){e.contentType||=`application/x-mpegURL`;let{videoFormat:t,audioFormat:n}=await Fo(this.castSrc);t?.includes(`m4s`)||t?.includes(`mp4`)||t?.includes(`m4a`)?(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.FMP4,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.FMP4):n?.includes(`aac`)?(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.AAC,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.MPEG2_TS):(t?.includes(`ts`)||n?.includes(`ts`))&&(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.TS,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.MPEG2_TS)}let i=new chrome.cast.media.LoadRequest(e);i.currentTime=super.currentTime??0,i.autoplay=!this.#e.paused,i.activeTrackIds=n,await wo()?.loadMedia(i),this.dispatchEvent(new Event(`volumechange`))}play(){if(this.#i){this.#i.isPaused&&this.#i.controller?.playOrPause();return}return super.play()}pause(){if(this.#i){this.#i.isPaused||this.#i.controller?.playOrPause();return}super.pause()}get castOptions(){return this.#t}get castReceiver(){return this.getAttribute(`cast-receiver`)??void 0}set castReceiver(e){this.castReceiver!=e&&this.setAttribute(`cast-receiver`,`${e}`)}get castSrc(){let e=this.currentSrc,t=e?.startsWith(`blob:`)?void 0:e;return this.getAttribute(`cast-src`)??this.querySelector(`source`)?.src??t??this.getAttribute(`src`)??void 0}set castSrc(e){this.castSrc!=e&&this.setAttribute(`cast-src`,`${e}`)}get castContentType(){return this.getAttribute(`cast-content-type`)??void 0}set castContentType(e){this.setAttribute(`cast-content-type`,`${e}`)}get castStreamType(){return this.getAttribute(`cast-stream-type`)??this.streamType??void 0}set castStreamType(e){this.setAttribute(`cast-stream-type`,`${e}`)}get castCustomData(){return this.#n}set castCustomData(e){let t=typeof e;if(![`object`,`undefined`].includes(t)){console.error(`castCustomData must be nullish or an object but value was of type ${t}`);return}this.#n=e}get readyState(){if(this.#i)switch(this.#i.playerState){case chrome.cast.media.PlayerState.IDLE:return 0;case chrome.cast.media.PlayerState.BUFFERING:return 2;default:return 3}return super.readyState}get paused(){return this.#i?this.#i.isPaused:super.paused}get muted(){return this.#i?this.#i?.isMuted:super.muted}set muted(e){if(this.#i){(e&&!this.#i.isMuted||!e&&this.#i.isMuted)&&this.#i.controller?.muteOrUnmute();return}super.muted=e}get volume(){return this.#i?this.#i?.volumeLevel??1:super.volume}set volume(e){if(this.#i){this.#i.volumeLevel=+e,this.#i.controller?.setVolumeLevel();return}super.volume=e}get duration(){return this.#i&&this.#i?.isMediaLoaded?this.#i?.duration??NaN:super.duration}get currentTime(){return this.#i&&this.#i?.isMediaLoaded?this.#i?.currentTime??0:super.currentTime}set currentTime(e){if(this.#i){this.#i.currentTime=e,this.#i.controller?.seek();return}super.currentTime=e}},Ho=e=>{throw TypeError(e)},Uo=(e,t,n)=>t.has(e)||Ho(`Cannot `+n),Wo=(e,t,n)=>(Uo(e,t,`read from private field`),n?n.call(e):t.get(e)),Go=(e,t,n)=>t.has(e)?Ho(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),Ko=(e,t,n,r)=>(Uo(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),qo=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends qo{}globalThis.DocumentFragment=e}var Jo=class extends qo{},Yo=class extends qo{},Xo={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(Jo)}},Zo,Qo=class{constructor(e,t={}){Go(this,Zo),Ko(this,Zo,t?.detail)}get detail(){return Wo(this,Zo)}initCustomEvent(){}};Zo=new WeakMap;function $o(e,t){return new Jo}var es={document:{createElement:$o},DocumentFragment,customElements:Xo,CustomEvent:Qo,EventTarget:qo,HTMLElement:Jo,HTMLVideoElement:Yo},ts=typeof window>`u`||globalThis.customElements===void 0,ns=ts?es:globalThis;ts?es.document:globalThis.document;var rs,is=class extends Vo(a(mo)){constructor(){super(...arguments),Go(this,rs)}get autoplay(){let e=this.getAttribute(`autoplay`);return e===null?!1:e===``?!0:e}set autoplay(e){e!==this.autoplay&&(e?this.setAttribute(`autoplay`,typeof e==`string`?e:``):this.removeAttribute(`autoplay`))}get muxCastCustomData(){return{mux:{playbackId:this.playbackId,minResolution:this.minResolution,maxResolution:this.maxResolution,renditionOrder:this.renditionOrder,customDomain:this.customDomain,tokens:{drm:this.drmToken},envKey:this.envKey,metadata:this.metadata,disableCookies:this.disableCookies,disableTracking:this.disableTracking,beaconCollectionDomain:this.beaconCollectionDomain,startTime:this.startTime,preferCmcd:this.preferCmcd}}}get castCustomData(){return Wo(this,rs)??this.muxCastCustomData}set castCustomData(e){Ko(this,rs,e)}};rs=new WeakMap,ns.customElements.get(`mux-video`)||(ns.customElements.define(`mux-video`,is),ns.MuxVideoElement=is);var k={MEDIA_PLAY_REQUEST:`mediaplayrequest`,MEDIA_PAUSE_REQUEST:`mediapauserequest`,MEDIA_MUTE_REQUEST:`mediamuterequest`,MEDIA_UNMUTE_REQUEST:`mediaunmuterequest`,MEDIA_LOOP_REQUEST:`medialooprequest`,MEDIA_VOLUME_REQUEST:`mediavolumerequest`,MEDIA_SEEK_REQUEST:`mediaseekrequest`,MEDIA_AIRPLAY_REQUEST:`mediaairplayrequest`,MEDIA_ENTER_FULLSCREEN_REQUEST:`mediaenterfullscreenrequest`,MEDIA_EXIT_FULLSCREEN_REQUEST:`mediaexitfullscreenrequest`,MEDIA_PREVIEW_REQUEST:`mediapreviewrequest`,MEDIA_ENTER_PIP_REQUEST:`mediaenterpiprequest`,MEDIA_EXIT_PIP_REQUEST:`mediaexitpiprequest`,MEDIA_ENTER_CAST_REQUEST:`mediaentercastrequest`,MEDIA_EXIT_CAST_REQUEST:`mediaexitcastrequest`,MEDIA_SHOW_TEXT_TRACKS_REQUEST:`mediashowtexttracksrequest`,MEDIA_HIDE_TEXT_TRACKS_REQUEST:`mediahidetexttracksrequest`,MEDIA_SHOW_SUBTITLES_REQUEST:`mediashowsubtitlesrequest`,MEDIA_DISABLE_SUBTITLES_REQUEST:`mediadisablesubtitlesrequest`,MEDIA_TOGGLE_SUBTITLES_REQUEST:`mediatogglesubtitlesrequest`,MEDIA_PLAYBACK_RATE_REQUEST:`mediaplaybackraterequest`,MEDIA_RENDITION_REQUEST:`mediarenditionrequest`,MEDIA_AUDIO_TRACK_REQUEST:`mediaaudiotrackrequest`,MEDIA_SEEK_TO_LIVE_REQUEST:`mediaseektoliverequest`,REGISTER_MEDIA_STATE_RECEIVER:`registermediastatereceiver`,UNREGISTER_MEDIA_STATE_RECEIVER:`unregistermediastatereceiver`},A={MEDIA_CHROME_ATTRIBUTES:`mediachromeattributes`,MEDIA_CONTROLLER:`mediacontroller`},as={MEDIA_AIRPLAY_UNAVAILABLE:`mediaAirplayUnavailable`,MEDIA_AUDIO_TRACK_ENABLED:`mediaAudioTrackEnabled`,MEDIA_AUDIO_TRACK_LIST:`mediaAudioTrackList`,MEDIA_AUDIO_TRACK_UNAVAILABLE:`mediaAudioTrackUnavailable`,MEDIA_BUFFERED:`mediaBuffered`,MEDIA_CAST_UNAVAILABLE:`mediaCastUnavailable`,MEDIA_CHAPTERS_CUES:`mediaChaptersCues`,MEDIA_CURRENT_TIME:`mediaCurrentTime`,MEDIA_DURATION:`mediaDuration`,MEDIA_ENDED:`mediaEnded`,MEDIA_ERROR:`mediaError`,MEDIA_ERROR_CODE:`mediaErrorCode`,MEDIA_ERROR_MESSAGE:`mediaErrorMessage`,MEDIA_FULLSCREEN_UNAVAILABLE:`mediaFullscreenUnavailable`,MEDIA_HAS_PLAYED:`mediaHasPlayed`,MEDIA_HEIGHT:`mediaHeight`,MEDIA_IS_AIRPLAYING:`mediaIsAirplaying`,MEDIA_IS_CASTING:`mediaIsCasting`,MEDIA_IS_FULLSCREEN:`mediaIsFullscreen`,MEDIA_IS_PIP:`mediaIsPip`,MEDIA_LOADING:`mediaLoading`,MEDIA_MUTED:`mediaMuted`,MEDIA_LOOP:`mediaLoop`,MEDIA_PAUSED:`mediaPaused`,MEDIA_PIP_UNAVAILABLE:`mediaPipUnavailable`,MEDIA_PLAYBACK_RATE:`mediaPlaybackRate`,MEDIA_PREVIEW_CHAPTER:`mediaPreviewChapter`,MEDIA_PREVIEW_COORDS:`mediaPreviewCoords`,MEDIA_PREVIEW_IMAGE:`mediaPreviewImage`,MEDIA_PREVIEW_TIME:`mediaPreviewTime`,MEDIA_RENDITION_LIST:`mediaRenditionList`,MEDIA_RENDITION_SELECTED:`mediaRenditionSelected`,MEDIA_RENDITION_UNAVAILABLE:`mediaRenditionUnavailable`,MEDIA_SEEKABLE:`mediaSeekable`,MEDIA_STREAM_TYPE:`mediaStreamType`,MEDIA_SUBTITLES_LIST:`mediaSubtitlesList`,MEDIA_SUBTITLES_SHOWING:`mediaSubtitlesShowing`,MEDIA_TARGET_LIVE_WINDOW:`mediaTargetLiveWindow`,MEDIA_TIME_IS_LIVE:`mediaTimeIsLive`,MEDIA_VOLUME:`mediaVolume`,MEDIA_VOLUME_LEVEL:`mediaVolumeLevel`,MEDIA_VOLUME_UNAVAILABLE:`mediaVolumeUnavailable`,MEDIA_LANG:`mediaLang`,MEDIA_WIDTH:`mediaWidth`},os=Object.entries(as),j=os.reduce((e,[t,n])=>(e[t]=n.toLowerCase(),e),{}),ss=os.reduce((e,[t,n])=>(e[t]=n.toLowerCase(),e),{USER_INACTIVE_CHANGE:`userinactivechange`,BREAKPOINTS_CHANGE:`breakpointchange`,BREAKPOINTS_COMPUTED:`breakpointscomputed`});Object.entries(ss).reduce((e,[t,n])=>{let r=j[t];return r&&(e[n]=r),e},{userinactivechange:`userinactive`});var cs=Object.entries(j).reduce((e,[t,n])=>{let r=ss[t];return r&&(e[n]=r),e},{userinactive:`userinactivechange`}),ls={SUBTITLES:`subtitles`,CAPTIONS:`captions`,DESCRIPTIONS:`descriptions`,CHAPTERS:`chapters`,METADATA:`metadata`},us={DISABLED:`disabled`,HIDDEN:`hidden`,SHOWING:`showing`},ds={MOUSE:`mouse`,PEN:`pen`,TOUCH:`touch`},fs={UNAVAILABLE:`unavailable`,UNSUPPORTED:`unsupported`},ps={LIVE:`live`,ON_DEMAND:`on-demand`,UNKNOWN:`unknown`},ms={INLINE:`inline`,FULLSCREEN:`fullscreen`,PICTURE_IN_PICTURE:`picture-in-picture`};function hs(e){return e?.map(_s).join(` `)}function gs(e){return e?.split(/\s+/).map(vs)}function _s(e){if(e){let{id:t,width:n,height:r}=e;return[t,n,r].filter(e=>e!=null).join(`:`)}}function vs(e){if(e){let[t,n,r]=e.split(`:`);return{id:t,width:+n,height:+r}}}function ys(e){return e?.map(xs).join(` `)}function bs(e){return e?.split(/\s+/).map(Ss)}function xs(e){if(e){let{id:t,kind:n,language:r,label:i}=e;return[t,n,r,i].filter(e=>e!=null).join(`:`)}}function Ss(e){if(e){let[t,n,r,i]=e.split(`:`);return{id:t,kind:n,language:r,label:i}}}function Cs(e){return e.replace(/[-_]([a-z])/g,(e,t)=>t.toUpperCase())}function ws(e){return typeof e==`number`&&!Number.isNaN(e)&&Number.isFinite(e)}function Ts(e){return typeof e==`string`?!isNaN(e)&&!isNaN(parseFloat(e)):!1}var Es=e=>new Promise(t=>setTimeout(t,e)),Ds={en:{"Start airplay":`Start airplay`,"Stop airplay":`Stop airplay`,Audio:`Audio`,Captions:`Captions`,"Enable captions":`Enable captions`,"Disable captions":`Disable captions`,"Start casting":`Start casting`,"Stop casting":`Stop casting`,"Enter fullscreen mode":`Enter fullscreen mode`,"Exit fullscreen mode":`Exit fullscreen mode`,Mute:`Mute`,Unmute:`Unmute`,Loop:`Loop`,"Enter picture in picture mode":`Enter picture in picture mode`,"Exit picture in picture mode":`Exit picture in picture mode`,Play:`Play`,Pause:`Pause`,"Playback rate":`Playback rate`,"Playback rate {playbackRate}":`Playback rate {playbackRate}`,Quality:`Quality`,"Seek backward":`Seek backward`,"Seek forward":`Seek forward`,Settings:`Settings`,Auto:`Auto`,"audio player":`audio player`,"video player":`video player`,volume:`volume`,seek:`seek`,"closed captions":`closed captions`,"current playback rate":`current playback rate`,"playback time":`playback time`,"media loading":`media loading`,settings:`settings`,"audio tracks":`audio tracks`,quality:`quality`,play:`play`,pause:`pause`,mute:`mute`,unmute:`unmute`,"chapter: {chapterName}":`chapter: {chapterName}`,live:`live`,Off:`Off`,"start airplay":`start airplay`,"stop airplay":`stop airplay`,"start casting":`start casting`,"stop casting":`stop casting`,"enter fullscreen mode":`enter fullscreen mode`,"exit fullscreen mode":`exit fullscreen mode`,"enter picture in picture mode":`enter picture in picture mode`,"exit picture in picture mode":`exit picture in picture mode`,"seek to live":`seek to live`,"playing live":`playing live`,"seek back {seekOffset} seconds":`seek back {seekOffset} seconds`,"seek forward {seekOffset} seconds":`seek forward {seekOffset} seconds`,"Network Error":`Network Error`,"Decode Error":`Decode Error`,"Source Not Supported":`Source Not Supported`,"Encryption Error":`Encryption Error`,"A network error caused the media download to fail.":`A network error caused the media download to fail.`,"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.":`A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.`,"An unsupported error occurred. The server or network failed, or your browser does not support this format.":`An unsupported error occurred. The server or network failed, or your browser does not support this format.`,"The media is encrypted and there are no keys to decrypt it.":`The media is encrypted and there are no keys to decrypt it.`,hour:`hour`,hours:`hours`,minute:`minute`,minutes:`minutes`,second:`second`,seconds:`seconds`,"{time} remaining":`{time} remaining`,"{currentTime} of {totalTime}":`{currentTime} of {totalTime}`,"video not loaded, unknown time.":`video not loaded, unknown time.`}},Os=globalThis.navigator?.language||`en`,ks=e=>{Os=e},As=e=>{let[t]=Os.split(`-`);return Ds[Os]?.[e]||Ds[t]?.[e]||Ds.en?.[e]||e},js=()=>{let[e]=Os.split(`-`);return Ds[Os]?Os:Ds[e]?e:`en`},M=(e,t={})=>As(e).replace(/\{(\w+)\}/g,(e,n)=>n in t?String(t[n]):`{${n}}`),Ms=[{singular:`hour`,plural:`hours`},{singular:`minute`,plural:`minutes`},{singular:`second`,plural:`seconds`}],Ns=(e,t)=>`${e} ${M(e===1?Ms[t].singular:Ms[t].plural)}`,Ps=e=>{if(!ws(e))return``;let t=Math.abs(e),n=t!==e,r=new Date(0,0,0,0,0,t,0),i=[r.getHours(),r.getMinutes(),r.getSeconds()].map((e,t)=>e&&Ns(e,t)).filter(e=>e).join(`, `);return n?M(`{time} remaining`,{time:i}):i};function Fs(e,t){let n=!1;e<0&&(n=!0,e=0-e),e=e<0?0:e;let r=Math.floor(e%60),i=Math.floor(e/60%60),a=Math.floor(e/3600),o=Math.floor(t/60%60),s=Math.floor(t/3600);return(isNaN(e)||e===1/0)&&(a=i=r=`0`),a=a>0||s>0?a+`:`:``,i=((a||o>=10)&&i<10?`0`+i:i)+`:`,r=r<10?`0`+r:r,(n?`-`:``)+a+i+r}Object.freeze({length:0,start(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'start' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0},end(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'end' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0}});var Is=class{addEventListener(){}removeEventListener(){}dispatchEvent(){return!0}},Ls=class extends Is{},Rs=class extends Ls{constructor(){super(...arguments),this.role=null}},zs=class{observe(){}unobserve(){}disconnect(){}},Bs={createElement:function(){return new Vs.HTMLElement},createElementNS:function(){return new Vs.HTMLElement},addEventListener(){},removeEventListener(){},dispatchEvent(e){return!1}},Vs={ResizeObserver:zs,document:Bs,Node:Ls,Element:Rs,HTMLElement:class extends Rs{constructor(){super(...arguments),this.innerHTML=``}get content(){return new Vs.DocumentFragment}},DocumentFragment:class extends Is{},customElements:{get:function(){},define:function(){},whenDefined:function(){}},localStorage:{getItem(e){return null},setItem(e,t){},removeItem(e){}},CustomEvent:function(){},getComputedStyle:function(){},navigator:{languages:[],get userAgent(){return``}},matchMedia(e){return{matches:!1,media:e}},DOMParser:class{parseFromString(e,t){return{body:{textContent:e}}}}},Hs=`global`in globalThis&&(globalThis==null?void 0:globalThis.global)===globalThis||typeof window>`u`||window.customElements===void 0,Us=Object.keys(Vs).every(e=>e in globalThis),N=Hs&&!Us?Vs:globalThis,Ws=Hs&&!Us?Bs:globalThis.document,Gs=new WeakMap,Ks=e=>{let t=Gs.get(e);return t||Gs.set(e,t=new Set),t},qs=new N.ResizeObserver(e=>{for(let t of e)for(let e of Ks(t.target))e(t)});function Js(e,t){Ks(e).add(t),qs.observe(e)}function Ys(e,t){let n=Ks(e);n.delete(t),n.size||qs.unobserve(e)}function Xs(e){let t={};for(let n of e)t[n.name]=n.value;return t}function Zs(e){return Qs(e)??rc(e,`media-controller`)}function Qs(e){let{MEDIA_CONTROLLER:t}=A,n=e.getAttribute(t);if(n)return ac(e)?.getElementById(n)}var $s=(e,t,n=`.value`)=>{let r=e.querySelector(n);r&&(r.textContent=t)},ec=(e,t)=>{let n=`slot[name="${t}"]`,r=e.shadowRoot.querySelector(n);return r?r.children:[]},tc=(e,t)=>ec(e,t)[0],nc=(e,t)=>!e||!t?!1:e?.contains(t)?!0:nc(e,t.getRootNode().host),rc=(e,t)=>e?e.closest(t)||rc(e.getRootNode().host,t):null;function ic(e=document){let t=e?.activeElement;return t?ic(t.shadowRoot)??t:null}function ac(e){let t=(e?.getRootNode)?.call(e);return t instanceof ShadowRoot||t instanceof Document?t:null}function oc(e,{depth:t=3,checkOpacity:n=!0,checkVisibilityCSS:r=!0}={}){if(e.checkVisibility)return e.checkVisibility({checkOpacity:n,checkVisibilityCSS:r});let i=e;for(;i&&t>0;){let e=getComputedStyle(i);if(n&&e.opacity===`0`||r&&e.visibility===`hidden`||e.display===`none`)return!1;i=i.parentElement,t--}return!0}function sc(e,t,n,r){let i=r.x-n.x,a=r.y-n.y,o=i*i+a*a;if(o===0)return 0;let s=((e-n.x)*i+(t-n.y)*a)/o;return Math.max(0,Math.min(1,s))}function cc(e,t){return lc(e,e=>e===t)||uc(e,t)}function lc(e,t){let n;for(n of e.querySelectorAll(`style:not([media])`)??[]){let e;try{e=n.sheet?.cssRules}catch{continue}for(let n of e??[])if(t(n.selectorText))return n}}function uc(e,t){let n=e.querySelectorAll(`style:not([media])`)??[],r=n?.[n.length-1];if(!r?.sheet)return console.warn(`Media Chrome: No style sheet found on style tag of`,e),{style:{setProperty:()=>{},removeProperty:()=>``,getPropertyValue:()=>``}};let i=r?.sheet.insertRule(`${t}{}`,r.sheet.cssRules.length);return r.sheet.cssRules?.[i]}function P(e,t,n=NaN){let r=e.getAttribute(t);return r==null?n:+r}function F(e,t,n){let r=+n;if(n==null||Number.isNaN(r)){e.hasAttribute(t)&&e.removeAttribute(t);return}P(e,t,void 0)!==r&&e.setAttribute(t,`${r}`)}function I(e,t){return e.hasAttribute(t)}function L(e,t,n){if(n==null){e.hasAttribute(t)&&e.removeAttribute(t);return}I(e,t)!=n&&e.toggleAttribute(t,n)}function R(e,t,n=null){return e.getAttribute(t)??n}function z(e,t,n){if(n==null){e.hasAttribute(t)&&e.removeAttribute(t);return}let r=`${n}`;R(e,t,void 0)!==r&&e.setAttribute(t,r)}var dc=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},fc=(e,t,n)=>(dc(e,t,`read from private field`),n?n.call(e):t.get(e)),pc=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},mc=(e,t,n,r)=>(dc(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),hc;function gc(e){return`
  ...
  `}var _c=class extends N.HTMLElement{constructor(){if(super(),pc(this,hc,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER,j.MEDIA_PAUSED]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER&&(t&&((i=(r=fc(this,hc))?.unassociateElement)==null||i.call(r,this),mc(this,hc,null)),n&&this.isConnected&&(mc(this,hc,this.getRootNode()?.getElementById(n)),(o=(a=fc(this,hc))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;this.tabIndex=-1,this.setAttribute(`aria-hidden`,`true`),mc(this,hc,vc(this)),this.getAttribute(A.MEDIA_CONTROLLER)&&((t=(e=fc(this,hc))?.associateElement)==null||t.call(e,this)),fc(this,hc)&&(fc(this,hc).addEventListener(`pointerdown`,this),fc(this,hc).addEventListener(`click`,this),fc(this,hc).hasAttribute(`tabindex`)||(fc(this,hc).tabIndex=0))}disconnectedCallback(){var e,t,n,r;this.getAttribute(A.MEDIA_CONTROLLER)&&((t=(e=fc(this,hc))?.unassociateElement)==null||t.call(e,this)),(n=fc(this,hc))==null||n.removeEventListener(`pointerdown`,this),(r=fc(this,hc))==null||r.removeEventListener(`click`,this),mc(this,hc,null)}handleEvent(e){let t=e.composedPath()?.[0];if([`video`,`media-controller`].includes(t?.localName)){if(e.type===`pointerdown`)this._pointerType=e.pointerType;else if(e.type===`click`){let{clientX:t,clientY:n}=e,{left:r,top:i,width:a,height:o}=this.getBoundingClientRect(),s=t-r,c=n-i;if(s<0||c<0||s>a||c>o||a===0&&o===0)return;let l=this._pointerType||`mouse`;if(this._pointerType=void 0,l===ds.TOUCH){this.handleTap(e);return}else if(l===ds.MOUSE||l===ds.PEN){this.handleMouseClick(e);return}}}}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}handleTap(e){}handleMouseClick(e){let t=this.mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new N.CustomEvent(t,{composed:!0,bubbles:!0}))}};hc=new WeakMap,_c.shadowRootOptions={mode:`open`},_c.getTemplateHTML=gc;function vc(e){let t=e.getAttribute(A.MEDIA_CONTROLLER);return t?e.getRootNode()?.getElementById(t):rc(e,`media-controller`)}N.customElements.get(`media-gesture-receiver`)||N.customElements.define(`media-gesture-receiver`,_c);var yc=_c,bc=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},xc=(e,t,n)=>(bc(e,t,`read from private field`),n?n.call(e):t.get(e)),Sc=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Cc=(e,t,n,r)=>(bc(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),wc=(e,t,n)=>(bc(e,t,`access private method`),n),Tc,Ec,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc,Ic,Lc,Rc,zc,Bc,Vc,Hc,Uc,Wc,B={AUDIO:`audio`,AUTOHIDE:`autohide`,BREAKPOINTS:`breakpoints`,GESTURES_DISABLED:`gesturesdisabled`,KEYBOARD_CONTROL:`keyboardcontrol`,NO_AUTOHIDE:`noautohide`,USER_INACTIVE:`userinactive`,AUTOHIDE_OVER_CONTROLS:`autohideovercontrols`};function Gc(e){return`
    <style>
  ...
  `}var Kc=Object.values(j),qc=`sm:384 md:576 lg:768 xl:960`;function Jc(e){Yc(e.target,e.contentRect.width)}function Yc(e,t){if(!e.isConnected)return;let n=Xc(e.getAttribute(B.BREAKPOINTS)??qc),r=Zc(n,t),i=!1;if(Object.keys(n).forEach(t=>{if(r.includes(t)){e.hasAttribute(`breakpoint${t}`)||(e.setAttribute(`breakpoint${t}`,``),i=!0);return}e.hasAttribute(`breakpoint${t}`)&&(e.removeAttribute(`breakpoint${t}`),i=!0)}),i){let t=new CustomEvent(ss.BREAKPOINTS_CHANGE,{detail:r});e.dispatchEvent(t)}e.breakpointsComputed||(e.breakpointsComputed=!0,e.dispatchEvent(new CustomEvent(ss.BREAKPOINTS_COMPUTED,{bubbles:!0,composed:!0})))}function Xc(e){let t=e.split(/\s+/);return Object.fromEntries(t.map(e=>e.split(`:`)))}function Zc(e,t){return Object.keys(e).filter(n=>t>=parseInt(e[n]))}var Qc=class extends N.HTMLElement{constructor(){if(super(),Sc(this,Nc),Sc(this,Fc),Sc(this,Lc),Sc(this,zc),Sc(this,Vc),Sc(this,Tc,void 0),Sc(this,Ec,0),Sc(this,Dc,null),Sc(this,Oc,null),Sc(this,kc,void 0),this.breakpointsComputed=!1,Sc(this,Ac,e=>{let t=this.media;for(let n of e){if(n.type!==`childList`)continue;let e=n.removedNodes;for(let r of e){if(r.slot!=`media`||n.target!=this)continue;let e=n.previousSibling&&n.previousSibling.previousElementSibling;if(!e||!t)this.mediaUnsetCallback(r);else{let t=e.slot!==`media`;for(;(e=e.previousSibling)!==null;)e.slot==`media`&&(t=!1);t&&this.mediaUnsetCallback(r)}}if(t)for(let e of n.addedNodes)e===t&&this.handleMediaUpdated(t)}}),Sc(this,jc,!1),Sc(this,Mc,e=>{xc(this,jc)||(setTimeout(()=>{Jc(e),Cc(this,jc,!1)},0),Cc(this,jc,!0))}),Sc(this,Uc,void 0),Sc(this,Wc,()=>{if(!xc(this,Uc).assignedElements({flatten:!0}).length){xc(this,Dc)&&this.mediaUnsetCallback(xc(this,Dc));return}this.handleMediaUpdated(this.media)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}Cc(this,Tc,new MutationObserver(xc(this,Ac)))}static get observedAttributes(){return[B.AUTOHIDE,B.GESTURES_DISABLED].concat(Kc).filter(e=>![j.MEDIA_RENDITION_LIST,j.MEDIA_AUDIO_TRACK_LIST,j.MEDIA_CHAPTERS_CUES,j.MEDIA_WIDTH,j.MEDIA_HEIGHT,j.MEDIA_ERROR,j.MEDIA_ERROR_MESSAGE].includes(e))}attributeChangedCallback(e,t,n){e.toLowerCase()==B.AUTOHIDE&&(this.autohide=n)}get media(){let e=this.querySelector(`:scope > [slot=media]`);return e?.nodeName==`SLOT`&&(e=e.assignedElements({flatten:!0})[0]),e}async handleMediaUpdated(e){e&&(Cc(this,Dc,e),e.localName.includes(`-`)&&await N.customElements.whenDefined(e.localName),this.mediaSetCallback(e))}connectedCallback(){var e;xc(this,Tc).observe(this,{childList:!0,subtree:!0}),Js(this,xc(this,Mc));let t=this.getAttribute(B.AUDIO)==null?M(`video player`):M(`audio player`);this.setAttribute(`role`,`region`),this.setAttribute(`aria-label`,t),this.handleMediaUpdated(this.media),this.setAttribute(B.USER_INACTIVE,``),Yc(this,this.getBoundingClientRect().width);let n=this.querySelector(`:scope > slot[slot=media]`);n&&(Cc(this,Uc,n),xc(this,Uc).addEventListener(`slotchange`,xc(this,Wc))),this.addEventListener(`pointerdown`,this),this.addEventListener(`pointermove`,this),this.addEventListener(`pointerup`,this),this.addEventListener(`mouseleave`,this),this.addEventListener(`keyup`,this),(e=N.window)==null||e.addEventListener(`mouseup`,this)}disconnectedCallback(){var e;Ys(this,xc(this,Mc)),clearTimeout(xc(this,Oc)),xc(this,Tc).disconnect(),this.media&&this.mediaUnsetCallback(this.media),(e=N.window)==null||e.removeEventListener(`mouseup`,this),this.removeEventListener(`pointerdown`,this),this.removeEventListener(`pointermove`,this),this.removeEventListener(`pointerup`,this),this.removeEventListener(`mouseleave`,this),this.removeEventListener(`keyup`,this),xc(this,Uc)&&(xc(this,Uc).removeEventListener(`slotchange`,xc(this,Wc)),Cc(this,Uc,null)),Cc(this,jc,!1)}mediaSetCallback(e){}mediaUnsetCallback(e){Cc(this,Dc,null)}handleEvent(e){switch(e.type){case`pointerdown`:Cc(this,Ec,e.timeStamp);break;case`pointermove`:wc(this,Nc,Pc).call(this,e);break;case`pointerup`:wc(this,Fc,Ic).call(this,e);break;case`mouseleave`:wc(this,Lc,Rc).call(this);break;case`mouseup`:this.removeAttribute(B.KEYBOARD_CONTROL);break;case`keyup`:wc(this,Vc,Hc).call(this),this.setAttribute(B.KEYBOARD_CONTROL,``);break}}set autohide(e){let t=Number(e);Cc(this,kc,isNaN(t)?0:t)}get autohide(){return(xc(this,kc)===void 0?2:xc(this,kc)).toString()}get breakpoints(){return R(this,B.BREAKPOINTS)}set breakpoints(e){z(this,B.BREAKPOINTS,e)}get audio(){return I(this,B.AUDIO)}set audio(e){L(this,B.AUDIO,e)}get gesturesDisabled(){return I(this,B.GESTURES_DISABLED)}set gesturesDisabled(e){L(this,B.GESTURES_DISABLED,e)}get keyboardControl(){return I(this,B.KEYBOARD_CONTROL)}set keyboardControl(e){L(this,B.KEYBOARD_CONTROL,e)}get noAutohide(){return I(this,B.NO_AUTOHIDE)}set noAutohide(e){L(this,B.NO_AUTOHIDE,e)}get autohideOverControls(){return I(this,B.AUTOHIDE_OVER_CONTROLS)}set autohideOverControls(e){L(this,B.AUTOHIDE_OVER_CONTROLS,e)}get userInteractive(){return I(this,B.USER_INACTIVE)}set userInteractive(e){L(this,B.USER_INACTIVE,e)}};Tc=new WeakMap,Ec=new WeakMap,Dc=new WeakMap,Oc=new WeakMap,kc=new WeakMap,Ac=new WeakMap,jc=new WeakMap,Mc=new WeakMap,Nc=new WeakSet,Pc=function(e){if(e.pointerType!==`mouse`&&e.timeStamp-xc(this,Ec)<250)return;wc(this,zc,Bc).call(this),clearTimeout(xc(this,Oc));let t=this.hasAttribute(B.AUTOHIDE_OVER_CONTROLS);([this,this.media].includes(e.target)||t)&&wc(this,Vc,Hc).call(this)},Fc=new WeakSet,Ic=function(e){if(e.pointerType===`touch`){let t=!this.hasAttribute(B.USER_INACTIVE);[this,this.media].includes(e.target)&&t?wc(this,Lc,Rc).call(this):wc(this,Vc,Hc).call(this)}else e.composedPath().some(e=>[`media-play-button`,`media-fullscreen-button`].includes(e?.localName))&&wc(this,Vc,Hc).call(this)},Lc=new WeakSet,Rc=function(){if(xc(this,kc)<0||this.hasAttribute(B.USER_INACTIVE))return;this.setAttribute(B.USER_INACTIVE,``);let e=new N.CustomEvent(ss.USER_INACTIVE_CHANGE,{composed:!0,bubbles:!0,detail:!0});this.dispatchEvent(e)},zc=new WeakSet,Bc=function(){if(!this.hasAttribute(B.USER_INACTIVE))return;this.removeAttribute(B.USER_INACTIVE);let e=new N.CustomEvent(ss.USER_INACTIVE_CHANGE,{composed:!0,bubbles:!0,detail:!1});this.dispatchEvent(e)},Vc=new WeakSet,Hc=function(){wc(this,zc,Bc).call(this),clearTimeout(xc(this,Oc));let e=parseInt(this.autohide);e<0||Cc(this,Oc,setTimeout(()=>{wc(this,Lc,Rc).call(this)},e*1e3))},Uc=new WeakMap,Wc=new WeakMap,Qc.shadowRootOptions={mode:`open`},Qc.getTemplateHTML=Gc,N.customElements.get(`media-container`)||N.customElements.define(`media-container`,Qc);var $c=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},el=(e,t,n)=>($c(e,t,`read from private field`),n?n.call(e):t.get(e)),tl=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},nl=(e,t,n,r)=>($c(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),rl,il,al,ol,sl,cl,ll=class{constructor(e,t,{defaultValue:n}={defaultValue:void 0}){tl(this,sl),tl(this,rl,void 0),tl(this,il,void 0),tl(this,al,void 0),tl(this,ol,new Set),nl(this,rl,e),nl(this,il,t),nl(this,al,new Set(n))}[Symbol.iterator](){return el(this,sl,cl).values()}get length(){return el(this,sl,cl).size}get value(){return[...el(this,sl,cl)].join(` `)??``}set value(e){e!==this.value&&(nl(this,ol,new Set),this.add(...e?.split(` `)??[]))}toString(){return this.value}item(e){return[...el(this,sl,cl)][e]}values(){return el(this,sl,cl).values()}forEach(e,t){el(this,sl,cl).forEach(e,t)}add(...e){var t;e.forEach(e=>el(this,ol).add(e)),!(this.value===``&&!el(this,rl)?.hasAttribute(`${el(this,il)}`))&&((t=el(this,rl))==null||t.setAttribute(`${el(this,il)}`,`${this.value}`))}remove(...e){var t;e.forEach(e=>el(this,ol).delete(e)),(t=el(this,rl))==null||t.setAttribute(`${el(this,il)}`,`${this.value}`)}contains(e){return el(this,sl,cl).has(e)}toggle(e,t){return t===void 0?this.contains(e)?(this.remove(e),!1):(this.add(e),!0):t?(this.add(e),!0):(this.remove(e),!1)}replace(e,t){return this.remove(e),this.add(t),e===t}};rl=new WeakMap,il=new WeakMap,al=new WeakMap,ol=new WeakMap,sl=new WeakSet,cl=function(){return el(this,ol).size?el(this,ol):el(this,al)};var ul=(e=``)=>e.split(/\s+/),dl=(e=``)=>{let[t,n,r]=e.split(`:`),i=r?decodeURIComponent(r):void 0;return{kind:t===`cc`?ls.CAPTIONS:ls.SUBTITLES,language:n,label:i}},fl=(e=``,t={})=>ul(e).map(e=>{let n=dl(e);return{...t,...n}}),pl=e=>e?Array.isArray(e)?e.map(e=>typeof e==`string`?dl(e):e):typeof e==`string`?fl(e):[e]:[],ml=({kind:e,label:t,language:n}={kind:`subtitles`})=>t?`${e===`captions`?`cc`:`sb`}:${n}:${encodeURIComponent(t)}`:n,hl=(e=[])=>Array.prototype.map.call(e,ml).join(` `),gl=(e,t)=>n=>n[e]===t,_l=e=>{let t=Object.entries(e).map(([e,t])=>gl(e,t));return e=>t.every(t=>t(e))},vl=(e,t=[],n=[])=>{let r=pl(n).map(_l);Array.from(t).filter(e=>r.some(t=>t(e))).forEach(t=>{t.mode=e})},yl=(e,t=()=>!0)=>{if(!e?.textTracks)return[];let n=typeof t==`function`?t:_l(t);return Array.from(e.textTracks).filter(n)},bl=e=>!!e.mediaSubtitlesShowing?.length||e.hasAttribute(j.MEDIA_SUBTITLES_SHOWING),xl=e=>{let{media:t,fullscreenElement:n}=e;try{let e=n&&`requestFullscreen`in n?`requestFullscreen`:n&&`webkitRequestFullScreen`in n?`webkitRequestFullScreen`:void 0;if(e){let t=n[e]?.call(n);if(t instanceof Promise)return t.catch(()=>{})}else t?.webkitEnterFullscreen?t.webkitEnterFullscreen():t?.requestFullscreen&&t.requestFullscreen()}catch(e){console.error(e)}},Sl=`exitFullscreen`in Ws?`exitFullscreen`:`webkitExitFullscreen`in Ws?`webkitExitFullscreen`:`webkitCancelFullScreen`in Ws?`webkitCancelFullScreen`:void 0,Cl=e=>{let{documentElement:t}=e;if(Sl){let e=(t?.[Sl])?.call(t);if(e instanceof Promise)return e.catch(()=>{})}},wl=`fullscreenElement`in Ws?`fullscreenElement`:`webkitFullscreenElement`in Ws?`webkitFullscreenElement`:void 0,Tl=e=>{let{documentElement:t,media:n}=e,r=t?.[wl];return!r&&`webkitDisplayingFullscreen`in n&&`webkitPresentationMode`in n&&n.webkitDisplayingFullscreen&&n.webkitPresentationMode===ms.FULLSCREEN?n:r},El=e=>{let{media:t,documentElement:n,fullscreenElement:r=t}=e;if(!t||!n)return!1;let i=Tl(e);if(!i)return!1;if(i===r||i===t)return!0;if(i.localName.includes(`-`)){let e=i.shadowRoot;if(!(wl in e))return nc(i,r);for(;e?.[wl];){if(e[wl]===r)return!0;e=e[wl]?.shadowRoot}}return!1},Dl=`fullscreenEnabled`in Ws?`fullscreenEnabled`:`webkitFullscreenEnabled`in Ws?`webkitFullscreenEnabled`:void 0,Ol=e=>{let{documentElement:t,media:n}=e;return!!t?.[Dl]||n&&`webkitSupportsFullscreen`in n},kl,Al=()=>{var e;return kl||(kl=((e=Ws)?.createElement)?.call(e,`video`),kl)},jl=async(e=Al())=>{if(!e)return!1;let t=e.volume;e.volume=t/2+.1;let n=new AbortController,r=await Promise.race([Ml(e,n.signal),Nl(e,t)]);return n.abort(),r},Ml=(e,t)=>new Promise(n=>{e.addEventListener(`volumechange`,()=>n(!0),{signal:t})}),Nl=async(e,t)=>{for(let n=0;n<10;n++){if(e.volume===t)return!1;await Es(10)}return e.volume!==t},Pl=/.*Version\/.*Safari\/.*/.test(N.navigator.userAgent),Fl=(e=Al())=>N.matchMedia(`(display-mode: standalone)`).matches&&Pl?!1:typeof e?.requestPictureInPicture==`function`,Il=(e=Al())=>Ol({documentElement:Ws,media:e}),Ll=Il(),Rl=Fl(),zl=!!N.WebKitPlaybackTargetAvailabilityEvent,Bl=!!N.chrome,Vl=e=>yl(e.media,e=>[ls.SUBTITLES,ls.CAPTIONS].includes(e.kind)).sort((e,t)=>e.kind>=t.kind?1:-1),Hl=e=>yl(e.media,e=>e.mode===us.SHOWING&&[ls.SUBTITLES,ls.CAPTIONS].includes(e.kind)),Ul=(e,t)=>{let n=Vl(e),r=Hl(e),i=!!r.length;if(n.length){if(t===!1||i&&t!==!0)vl(us.DISABLED,n,r);else if(t===!0||!i&&t!==!1){let t=n[0],{options:i}=e;if(!i?.noSubtitlesLangPref){let e=N.localStorage.getItem(`media-chrome-pref-subtitles-lang`),r=e?[e,...N.navigator.languages]:N.navigator.languages,i=n.filter(e=>r.some(t=>e.language.toLowerCase().startsWith(t.split(`-`)[0]))).sort((e,t)=>r.findIndex(t=>e.language.toLowerCase().startsWith(t.split(`-`)[0]))-r.findIndex(e=>t.language.toLowerCase().startsWith(e.split(`-`)[0])));i[0]&&(t=i[0])}let{language:a,label:o,kind:s}=t;vl(us.DISABLED,n,r),vl(us.SHOWING,n,[{language:a,label:o,kind:s}])}}},Wl=(e,t)=>e===t?!0:e==null||t==null||typeof e!=typeof t?!1:typeof e==`number`&&Number.isNaN(e)&&Number.isNaN(t)?!0:typeof e==`object`?Array.isArray(e)?Gl(e,t):Object.entries(e).every(([e,n])=>e in t&&Wl(n,t[e])):!1,Gl=(e,t)=>{let n=Array.isArray(e),r=Array.isArray(t);return n===r?n||r?e.length===t.length?e.every((e,n)=>Wl(e,t[n])):!1:!0:!1},Kl=Object.values(ps),ql,Jl=jl().then(e=>(ql=e,ql)),Yl=async(...e)=>{await Promise.all(e.filter(e=>e).map(async e=>{if(!(`localName`in e&&e instanceof N.HTMLElement))return;let t=e.localName;if(!t.includes(`-`))return;let n=N.customElements.get(t);n&&e instanceof n||(await N.customElements.whenDefined(t),N.customElements.upgrade(e))}))},Xl=new N.DOMParser,Zl=e=>e&&(Xl.parseFromString(e,`text/html`).body.textContent||e),Ql={mediaError:{get(e,t){let{media:n}=e;if(t?.type!==`playing`)return n?.error},mediaEvents:[`emptied`,`error`,`playing`]},mediaErrorCode:{get(e,t){let{media:n}=e;if(t?.type!==`playing`)return n?.error?.code},mediaEvents:[`emptied`,`error`,`playing`]},mediaErrorMessage:{get(e,t){let{media:n}=e;if(t?.type!==`playing`)return n?.error?.message??``},mediaEvents:[`emptied`,`error`,`playing`]},mediaWidth:{get(e){let{media:t}=e;return t?.videoWidth??0},mediaEvents:[`resize`]},mediaHeight:{get(e){let{media:t}=e;return t?.videoHeight??0},mediaEvents:[`resize`]},mediaPaused:{get(e){let{media:t}=e;return t?.paused??!0},set(e,t){var n;let{media:r}=t;r&&(e?r.pause():(n=r.play())==null||n.catch(()=>{}))},mediaEvents:[`play`,`playing`,`pause`,`emptied`]},mediaHasPlayed:{get(e,t){let{media:n}=e;return n?t?t.type===`playing`:!n.paused:!1},mediaEvents:[`playing`,`emptied`]},mediaEnded:{get(e){let{media:t}=e;return t?.ended??!1},mediaEvents:[`seeked`,`ended`,`emptied`]},mediaPlaybackRate:{get(e){let{media:t}=e;return t?.playbackRate??1},set(e,t){let{media:n}=t;n&&Number.isFinite(+e)&&(n.playbackRate=+e)},mediaEvents:[`ratechange`,`loadstart`]},mediaMuted:{get(e){let{media:t}=e;return t?.muted??!1},set(e,t){let{media:n,options:{noMutedPref:r}={}}=t;if(n){n.muted=e;try{let t=N.localStorage.getItem(`media-chrome-pref-muted`)!==null,i=n.hasAttribute(`muted`);if(r){t&&N.localStorage.removeItem(`media-chrome-pref-muted`);return}if(i&&!t)return;N.localStorage.setItem(`media-chrome-pref-muted`,e?`true`:`false`)}catch(e){console.debug(`Error setting muted pref`,e)}}},mediaEvents:[`volumechange`],stateOwnersUpdateHandlers:[(e,t)=>{let{options:{noMutedPref:n}}=t,{media:r}=t;if(!(!r||r.muted||n))try{let n=N.localStorage.getItem(`media-chrome-pref-muted`)===`true`;Ql.mediaMuted.set(n,t),e(n)}catch(e){console.debug(`Error getting muted pref`,e)}}]},mediaLoop:{get(e){let{media:t}=e;return t?.loop},set(e,t){let{media:n}=t;n&&(n.loop=e)},mediaEvents:[`medialooprequest`]},mediaVolume:{get(e){let{media:t}=e;return t?.volume??1},set(e,t){let{media:n,options:{noVolumePref:r}={}}=t;if(n){try{e==null?N.localStorage.removeItem(`media-chrome-pref-volume`):!n.hasAttribute(`muted`)&&!r&&N.localStorage.setItem(`media-chrome-pref-volume`,e.toString())}catch(e){console.debug(`Error setting volume pref`,e)}Number.isFinite(+e)&&(n.volume=+e)}},mediaEvents:[`volumechange`],stateOwnersUpdateHandlers:[(e,t)=>{let{options:{noVolumePref:n}}=t;if(!n)try{let{media:n}=t;if(!n)return;let r=N.localStorage.getItem(`media-chrome-pref-volume`);if(r==null)return;Ql.mediaVolume.set(+r,t),e(+r)}catch(e){console.debug(`Error getting volume pref`,e)}}]},mediaVolumeLevel:{get(e){let{media:t}=e;return t?.volume===void 0?`high`:t.muted||t.volume===0?`off`:t.volume<.5?`low`:t.volume<.75?`medium`:`high`},mediaEvents:[`volumechange`]},mediaCurrentTime:{get(e){let{media:t}=e;return t?.currentTime??0},set(e,t){let{media:n}=t;!n||!ws(e)||(n.currentTime=e)},mediaEvents:[`timeupdate`,`loadedmetadata`]},mediaDuration:{get(e){let{media:t,options:{defaultDuration:n}={}}=e;return n&&(!t||!t.duration||Number.isNaN(t.duration)||!Number.isFinite(t.duration))?n:Number.isFinite(t?.duration)?t.duration:NaN},mediaEvents:[`durationchange`,`loadedmetadata`,`emptied`]},mediaLoading:{get(e){let{media:t}=e;return t?.readyState<3},mediaEvents:[`waiting`,`playing`,`emptied`]},mediaSeekable:{get(e){let{media:t}=e;if(!t?.seekable?.length)return;let n=t.seekable.start(0),r=t.seekable.end(t.seekable.length-1);if(!(!n&&!r))return[Number(n.toFixed(3)),Number(r.toFixed(3))]},mediaEvents:[`loadedmetadata`,`emptied`,`progress`,`seekablechange`]},mediaBuffered:{get(e){let{media:t}=e,n=t?.buffered??[];return Array.from(n).map((e,t)=>[Number(n.start(t).toFixed(3)),Number(n.end(t).toFixed(3))])},mediaEvents:[`progress`,`emptied`]},mediaStreamType:{get(e){let{media:t,options:{defaultStreamType:n}={}}=e,r=[ps.LIVE,ps.ON_DEMAND].includes(n)?n:void 0;if(!t)return r;let{streamType:i}=t;if(Kl.includes(i))return i===ps.UNKNOWN?r:i;let a=t.duration;return a===1/0?ps.LIVE:Number.isFinite(a)?ps.ON_DEMAND:r},mediaEvents:[`emptied`,`durationchange`,`loadedmetadata`,`streamtypechange`]},mediaTargetLiveWindow:{get(e){let{media:t}=e;if(!t)return NaN;let{targetLiveWindow:n}=t,r=Ql.mediaStreamType.get(e);return(n==null||Number.isNaN(n))&&r===ps.LIVE?0:n},mediaEvents:[`emptied`,`durationchange`,`loadedmetadata`,`streamtypechange`,`targetlivewindowchange`]},mediaTimeIsLive:{get(e){let{media:t,options:{liveEdgeOffset:n=10}={}}=e;if(!t)return!1;if(typeof t.liveEdgeStart==`number`)return Number.isNaN(t.liveEdgeStart)?!1:t.currentTime>=t.liveEdgeStart;if(Ql.mediaStreamType.get(e)!==ps.LIVE)return!1;let r=t.seekable;if(!r)return!0;if(!r.length)return!1;let i=r.end(r.length-1)-n;return t.currentTime>=i},mediaEvents:[`playing`,`timeupdate`,`progress`,`waiting`,`emptied`]},mediaSubtitlesList:{get(e){return Vl(e).map(({kind:e,label:t,language:n})=>({kind:e,label:t,language:n}))},mediaEvents:[`loadstart`],textTracksEvents:[`addtrack`,`removetrack`]},mediaSubtitlesShowing:{get(e){return Hl(e).map(({kind:e,label:t,language:n})=>({kind:e,label:t,language:n}))},mediaEvents:[`loadstart`],textTracksEvents:[`addtrack`,`removetrack`,`change`],stateOwnersUpdateHandlers:[(e,t)=>{var n,r;let{media:i,options:a}=t;if(!i)return;let o=e=>{a.defaultSubtitles&&(e&&![ls.CAPTIONS,ls.SUBTITLES].includes(e?.track?.kind)||Ul(t,!0))};return i.addEventListener(`loadstart`,o),(n=i.textTracks)==null||n.addEventListener(`addtrack`,o),(r=i.textTracks)==null||r.addEventListener(`removetrack`,o),()=>{var e,t;i.removeEventListener(`loadstart`,o),(e=i.textTracks)==null||e.removeEventListener(`addtrack`,o),(t=i.textTracks)==null||t.removeEventListener(`removetrack`,o)}}]},mediaChaptersCues:{get(e){let{media:t}=e;if(!t)return[];let[n]=yl(t,{kind:ls.CHAPTERS});return Array.from(n?.cues??[]).map(({text:e,startTime:t,endTime:n})=>({text:Zl(e),startTime:t,endTime:n}))},mediaEvents:[`loadstart`,`loadedmetadata`],textTracksEvents:[`addtrack`,`removetrack`,`change`],stateOwnersUpdateHandlers:[(e,t)=>{let{media:n}=t;if(!n)return;let r=n.querySelector(`track[kind="chapters"][default][src]`),i=n.shadowRoot?.querySelector(`:is(video,audio) > track[kind="chapters"][default][src]`);return r?.addEventListener(`load`,e),i?.addEventListener(`load`,e),()=>{r?.removeEventListener(`load`,e),i?.removeEventListener(`load`,e)}}]},mediaIsPip:{get(e){let{media:t,documentElement:n}=e;if(!t||!n||!n.pictureInPictureElement)return!1;if(n.pictureInPictureElement===t)return!0;if(n.pictureInPictureElement instanceof HTMLMediaElement)return t.localName?.includes(`-`)?nc(t,n.pictureInPictureElement):!1;if(n.pictureInPictureElement.localName.includes(`-`)){let e=n.pictureInPictureElement.shadowRoot;for(;e?.pictureInPictureElement;){if(e.pictureInPictureElement===t)return!0;e=e.pictureInPictureElement?.shadowRoot}}return!1},set(e,t){let{media:n}=t;if(n)if(e){if(!Ws.pictureInPictureEnabled){console.warn(`MediaChrome: Picture-in-picture is not enabled`);return}if(!n.requestPictureInPicture){console.warn(`MediaChrome: The current media does not support picture-in-picture`);return}let e=()=>{console.warn(`MediaChrome: The media is not ready for picture-in-picture. It must have a readyState > 0.`)};n.requestPictureInPicture().catch(t=>{if(t.code===11){if(!n.src){console.warn(`MediaChrome: The media is not ready for picture-in-picture. It must have a src set.`);return}if(n.readyState===0&&n.preload===`none`){let t=()=>{n.removeEventListener(`loadedmetadata`,r),n.preload=`none`},r=()=>{n.requestPictureInPicture().catch(e),t()};n.addEventListener(`loadedmetadata`,r),n.preload=`metadata`,setTimeout(()=>{n.readyState===0&&e(),t()},1e3)}else throw t}else throw t})}else Ws.pictureInPictureElement&&Ws.exitPictureInPicture()},mediaEvents:[`enterpictureinpicture`,`leavepictureinpicture`]},mediaRenditionList:{get(e){let{media:t}=e;return[...t?.videoRenditions??[]].map(e=>({...e}))},mediaEvents:[`emptied`,`loadstart`],videoRenditionsEvents:[`addrendition`,`removerendition`]},mediaRenditionSelected:{get(e){let{media:t}=e;return t?.videoRenditions?.[t.videoRenditions?.selectedIndex]?.id},set(e,t){let{media:n}=t;if(!n?.videoRenditions){console.warn(`MediaController: Rendition selection not supported by this media.`);return}let r=e,i=Array.prototype.findIndex.call(n.videoRenditions,e=>e.id==r);n.videoRenditions.selectedIndex!=i&&(n.videoRenditions.selectedIndex=i)},mediaEvents:[`emptied`],videoRenditionsEvents:[`addrendition`,`removerendition`,`change`]},mediaAudioTrackList:{get(e){let{media:t}=e;return[...t?.audioTracks??[]]},mediaEvents:[`emptied`,`loadstart`],audioTracksEvents:[`addtrack`,`removetrack`]},mediaAudioTrackEnabled:{get(e){let{media:t}=e;return[...t?.audioTracks??[]].find(e=>e.enabled)?.id},set(e,t){let{media:n}=t;if(!n?.audioTracks){console.warn(`MediaChrome: Audio track selection not supported by this media.`);return}let r=e;for(let e of n.audioTracks)e.enabled=r==e.id},mediaEvents:[`emptied`],audioTracksEvents:[`addtrack`,`removetrack`,`change`]},mediaIsFullscreen:{get(e){return El(e)},set(e,t,n){var r;e?(xl(t),n.detail&&!t.media?.inert&&((r=t.media)==null||r.focus())):Cl(t)},rootEvents:[`fullscreenchange`,`webkitfullscreenchange`],mediaEvents:[`webkitbeginfullscreen`,`webkitendfullscreen`,`webkitpresentationmodechanged`]},mediaIsCasting:{get(e){let{media:t}=e;return!t?.remote||t.remote?.state===`disconnected`?!1:t.remote.state===`connected`},set(e,t){let{media:n}=t;if(n&&!(e&&n.remote?.state!==`disconnected`)&&!(!e&&n.remote?.state!==`connected`)){if(typeof n.remote.prompt!=`function`){console.warn(`MediaChrome: Casting is not supported in this environment`);return}n.remote.prompt().catch(()=>{})}},remoteEvents:[`connect`,`connecting`,`disconnect`]},mediaIsAirplaying:{get(){return!1},set(e,t){let{media:n}=t;if(n){if(!(n.webkitShowPlaybackTargetPicker&&N.WebKitPlaybackTargetAvailabilityEvent)){console.error(`MediaChrome: received a request to select AirPlay but AirPlay is not supported in this environment`);return}n.webkitShowPlaybackTargetPicker()}},mediaEvents:[`webkitcurrentplaybacktargetiswirelesschanged`]},mediaFullscreenUnavailable:{get(e){let{media:t}=e;if(!Ll||!Il(t))return fs.UNSUPPORTED}},mediaPipUnavailable:{get(e){let{media:t}=e;if(!Rl||!Fl(t))return fs.UNSUPPORTED;if(t?.disablePictureInPicture)return fs.UNAVAILABLE}},mediaVolumeUnavailable:{get(e){let{media:t}=e;if(ql===!1||t?.volume==null)return fs.UNSUPPORTED},stateOwnersUpdateHandlers:[e=>{ql??Jl.then(t=>e(t?void 0:fs.UNSUPPORTED))}]},mediaCastUnavailable:{get(e,{availability:t=`not-available`}={}){let{media:n}=e;if(!Bl||!n?.remote?.state)return fs.UNSUPPORTED;if(!(t==null||t===`available`))return fs.UNAVAILABLE},stateOwnersUpdateHandlers:[(e,t)=>{var n;let{media:r}=t;if(r)return r.disableRemotePlayback||r.hasAttribute(`disableremoteplayback`)||(n=r?.remote)==null||n.watchAvailability(t=>{e({availability:t?`available`:`not-available`})}).catch(t=>{t.name===`NotSupportedError`?e({availability:null}):e({availability:`not-available`})}),()=>{var e;(e=r?.remote)==null||e.cancelWatchAvailability().catch(()=>{})}}]},mediaAirplayUnavailable:{get(e,t){if(!zl)return fs.UNSUPPORTED;if(t?.availability===`not-available`)return fs.UNAVAILABLE},mediaEvents:[`webkitplaybacktargetavailabilitychanged`],stateOwnersUpdateHandlers:[(e,t)=>{var n;let{media:r}=t;if(r)return r.disableRemotePlayback||r.hasAttribute(`disableremoteplayback`)||(n=r?.remote)==null||n.watchAvailability(t=>{e({availability:t?`available`:`not-available`})}).catch(t=>{t.name===`NotSupportedError`?e({availability:null}):e({availability:`not-available`})}),()=>{var e;(e=r?.remote)==null||e.cancelWatchAvailability().catch(()=>{})}}]},mediaRenditionUnavailable:{get(e){let{media:t}=e;if(!t?.videoRenditions)return fs.UNSUPPORTED;if(!t.videoRenditions?.length)return fs.UNAVAILABLE},mediaEvents:[`emptied`,`loadstart`],videoRenditionsEvents:[`addrendition`,`removerendition`]},mediaAudioTrackUnavailable:{get(e){let{media:t}=e;if(!t?.audioTracks)return fs.UNSUPPORTED;if((t.audioTracks?.length??0)<=1)return fs.UNAVAILABLE},mediaEvents:[`emptied`,`loadstart`],audioTracksEvents:[`addtrack`,`removetrack`]},mediaLang:{get(e){let{options:{mediaLang:t}={}}=e;return t??`en`}}},$l={[k.MEDIA_PREVIEW_REQUEST](e,t,{detail:n}){let{media:r}=t,i=n??void 0,a,o;if(r&&i!=null){let[e]=yl(r,{kind:ls.METADATA,label:`thumbnails`}),t=Array.prototype.find.call(e?.cues??[],(e,t,n)=>t===0?e.endTime>i:t===n.length-1?e.startTime<=i:e.startTime<=i&&e.endTime>i);if(t){let e=/'^(?:[a-z]+:)?\/\//i.test(t.text)?void 0:r?.querySelector(`track[label="thumbnails"]`)?.src,n=new URL(t.text,e);o=new URLSearchParams(n.hash).get(`#xywh`).split(`,`).map(e=>+e),a=n.href}}let s=e.mediaDuration.get(t),c=e.mediaChaptersCues.get(t).find((e,t,n)=>t===n.length-1&&s===e.endTime?e.startTime<=i&&e.endTime>=i:e.startTime<=i&&e.endTime>i)?.text;return n!=null&&c==null&&(c=``),{mediaPreviewTime:i,mediaPreviewImage:a,mediaPreviewCoords:o,mediaPreviewChapter:c}},[k.MEDIA_PAUSE_REQUEST](e,t){e.mediaPaused.set(!0,t)},[k.MEDIA_PLAY_REQUEST](e,t){let n=e.mediaStreamType.get(t)===ps.LIVE,r=!t.options?.noAutoSeekToLive,i=e.mediaTargetLiveWindow.get(t)>0;if(n&&r&&!i){let n=e.mediaSeekable.get(t)?.[1];if(n){let r=n-(t.options?.seekToLiveOffset??0);e.mediaCurrentTime.set(r,t)}}e.mediaPaused.set(!1,t)},[k.MEDIA_PLAYBACK_RATE_REQUEST](e,t,{detail:n}){let r=n;e.mediaPlaybackRate.set(r,t)},[k.MEDIA_MUTE_REQUEST](e,t){e.mediaMuted.set(!0,t)},[k.MEDIA_UNMUTE_REQUEST](e,t){e.mediaVolume.get(t)||e.mediaVolume.set(.25,t),e.mediaMuted.set(!1,t)},[k.MEDIA_LOOP_REQUEST](e,t,{detail:n}){let r=!!n;return e.mediaLoop.set(r,t),{mediaLoop:r}},[k.MEDIA_VOLUME_REQUEST](e,t,{detail:n}){let r=n;r&&e.mediaMuted.get(t)&&e.mediaMuted.set(!1,t),e.mediaVolume.set(r,t)},[k.MEDIA_SEEK_REQUEST](e,t,{detail:n}){let r=n;e.mediaCurrentTime.set(r,t)},[k.MEDIA_SEEK_TO_LIVE_REQUEST](e,t){let n=e.mediaSeekable.get(t)?.[1];if(Number.isNaN(Number(n)))return;let r=n-(t.options?.seekToLiveOffset??0);e.mediaCurrentTime.set(r,t)},[k.MEDIA_SHOW_SUBTITLES_REQUEST](e,t,{detail:n}){let{options:r}=t,i=Vl(t),a=pl(n),o=a[0]?.language;o&&!r.noSubtitlesLangPref&&N.localStorage.setItem(`media-chrome-pref-subtitles-lang`,o),vl(us.SHOWING,i,a)},[k.MEDIA_DISABLE_SUBTITLES_REQUEST](e,t,{detail:n}){let r=Vl(t),i=n??[];vl(us.DISABLED,r,i)},[k.MEDIA_TOGGLE_SUBTITLES_REQUEST](e,t,{detail:n}){Ul(t,n)},[k.MEDIA_RENDITION_REQUEST](e,t,{detail:n}){let r=n;e.mediaRenditionSelected.set(r,t)},[k.MEDIA_AUDIO_TRACK_REQUEST](e,t,{detail:n}){let r=n;e.mediaAudioTrackEnabled.set(r,t)},[k.MEDIA_ENTER_PIP_REQUEST](e,t){e.mediaIsFullscreen.get(t)&&e.mediaIsFullscreen.set(!1,t),e.mediaIsPip.set(!0,t)},[k.MEDIA_EXIT_PIP_REQUEST](e,t){e.mediaIsPip.set(!1,t)},[k.MEDIA_ENTER_FULLSCREEN_REQUEST](e,t,n){e.mediaIsPip.get(t)&&e.mediaIsPip.set(!1,t),e.mediaIsFullscreen.set(!0,t,n)},[k.MEDIA_EXIT_FULLSCREEN_REQUEST](e,t){e.mediaIsFullscreen.set(!1,t)},[k.MEDIA_ENTER_CAST_REQUEST](e,t){e.mediaIsFullscreen.get(t)&&e.mediaIsFullscreen.set(!1,t),e.mediaIsCasting.set(!0,t)},[k.MEDIA_EXIT_CAST_REQUEST](e,t){e.mediaIsCasting.set(!1,t)},[k.MEDIA_AIRPLAY_REQUEST](e,t){e.mediaIsAirplaying.set(!0,t)}},eu=({media:e,fullscreenElement:t,documentElement:n,stateMediator:r=Ql,requestMap:i=$l,options:a={},monitorStateOwnersOnlyWithSubscriptions:o=!0})=>{let s=[],c={options:{...a}},l=Object.freeze({mediaPreviewTime:void 0,mediaPreviewImage:void 0,mediaPreviewCoords:void 0,mediaPreviewChapter:void 0}),u=e=>{e!=null&&(Wl(e,l)||(l=Object.freeze({...l,...e}),s.forEach(e=>e(l))))},d=()=>{u(Object.entries(r).reduce((e,[t,{get:n}])=>(e[t]=n(c),e),{}))},f={},p,m=async(e,t)=>{let n=!!p;if(p={...c,...p??{},...e},n)return;await Yl(...Object.values(e));let i=s.length>0&&t===0&&o,a=c.media!==p.media,l=c.media?.textTracks!==p.media?.textTracks,m=c.media?.videoRenditions!==p.media?.videoRenditions,h=c.media?.audioTracks!==p.media?.audioTracks,g=c.media?.remote!==p.media?.remote,_=c.documentElement!==p.documentElement,ee=!!c.media&&(a||i),te=!!c.media?.textTracks&&(l||i),ne=!!c.media?.videoRenditions&&(m||i),re=!!c.media?.audioTracks&&(h||i),ie=!!c.media?.remote&&(g||i),ae=!!c.documentElement&&(_||i),oe=ee||te||ne||re||ie||ae,se=s.length===0&&t===1&&o,ce=!!p.media&&(a||se),le=!!p.media?.textTracks&&(l||se),ue=!!p.media?.videoRenditions&&(m||se),de=!!p.media?.audioTracks&&(h||se),fe=!!p.media?.remote&&(g||se),pe=!!p.documentElement&&(_||se),me=ce||le||ue||de||fe||pe;if(!(oe||me)){Object.entries(p).forEach(([e,t])=>{c[e]=t}),d(),p=void 0;return}Object.entries(r).forEach(([e,{get:t,mediaEvents:n=[],textTracksEvents:r=[],videoRenditionsEvents:i=[],audioTracksEvents:a=[],remoteEvents:o=[],rootEvents:s=[],stateOwnersUpdateHandlers:l=[]}])=>{f[e]||(f[e]={});let d=n=>{let r=t(c,n);u({[e]:r})},m;m=f[e].mediaEvents,n.forEach(t=>{m&&ee&&(c.media.removeEventListener(t,m),f[e].mediaEvents=void 0),ce&&(p.media.addEventListener(t,d),f[e].mediaEvents=d)}),m=f[e].textTracksEvents,r.forEach(t=>{var n,r;m&&te&&((n=c.media.textTracks)==null||n.removeEventListener(t,m),f[e].textTracksEvents=void 0),le&&((r=p.media.textTracks)==null||r.addEventListener(t,d),f[e].textTracksEvents=d)}),m=f[e].videoRenditionsEvents,i.forEach(t=>{var n,r;m&&ne&&((n=c.media.videoRenditions)==null||n.removeEventListener(t,m),f[e].videoRenditionsEvents=void 0),ue&&((r=p.media.videoRenditions)==null||r.addEventListener(t,d),f[e].videoRenditionsEvents=d)}),m=f[e].audioTracksEvents,a.forEach(t=>{var n,r;m&&re&&((n=c.media.audioTracks)==null||n.removeEventListener(t,m),f[e].audioTracksEvents=void 0),de&&((r=p.media.audioTracks)==null||r.addEventListener(t,d),f[e].audioTracksEvents=d)}),m=f[e].remoteEvents,o.forEach(t=>{var n,r;m&&ie&&((n=c.media.remote)==null||n.removeEventListener(t,m),f[e].remoteEvents=void 0),fe&&((r=p.media.remote)==null||r.addEventListener(t,d),f[e].remoteEvents=d)}),m=f[e].rootEvents,s.forEach(t=>{m&&ae&&(c.documentElement.removeEventListener(t,m),f[e].rootEvents=void 0),pe&&(p.documentElement.addEventListener(t,d),f[e].rootEvents=d)});let h=f[e].stateOwnersUpdateHandlers;if(h&&oe&&(Array.isArray(h)?h:[h]).forEach(e=>{typeof e==`function`&&e()}),me){let t=l.map(e=>e(d,p)).filter(e=>typeof e==`function`);f[e].stateOwnersUpdateHandlers=t.length===1?t[0]:t}else oe&&(f[e].stateOwnersUpdateHandlers=void 0)}),Object.entries(p).forEach(([e,t])=>{c[e]=t}),d(),p=void 0};return m({media:e,fullscreenElement:t,documentElement:n,options:a}),{dispatch(e){let{type:t,detail:n}=e;if(i[t]&&l.mediaErrorCode==null){u(i[t](r,c,e));return}t===`mediaelementchangerequest`?m({media:n}):t===`fullscreenelementchangerequest`?m({fullscreenElement:n}):t===`documentelementchangerequest`?m({documentElement:n}):t===`optionschangerequest`&&(Object.entries(n??{}).forEach(([e,t])=>{c.options[e]=t}),d())},getState(){return l},subscribe(e){return m({},s.length+1),s.push(e),e(l),()=>{let t=s.indexOf(e);t>=0&&(m({},s.length-1),s.splice(t,1))}}}},tu=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},V=(e,t,n)=>(tu(e,t,`read from private field`),n?n.call(e):t.get(e)),nu=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},ru=(e,t,n,r)=>(tu(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),iu=(e,t,n)=>(tu(e,t,`access private method`),n),au,ou,H,su,cu,lu,uu,du,fu,pu,mu,hu,gu,_u,vu,yu=[`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Enter`,` `,`f`,`m`,`k`,`c`,`l`,`j`,`>`,`<`,`p`],bu=10,xu=.025,Su=.25,Cu=.25,wu=2,U={DEFAULT_SUBTITLES:`defaultsubtitles`,DEFAULT_STREAM_TYPE:`defaultstreamtype`,DEFAULT_DURATION:`defaultduration`,FULLSCREEN_ELEMENT:`fullscreenelement`,HOTKEYS:`hotkeys`,KEYBOARD_BACKWARD_SEEK_OFFSET:`keyboardbackwardseekoffset`,KEYBOARD_FORWARD_SEEK_OFFSET:`keyboardforwardseekoffset`,KEYBOARD_DOWN_VOLUME_STEP:`keyboarddownvolumestep`,KEYBOARD_UP_VOLUME_STEP:`keyboardupvolumestep`,KEYS_USED:`keysused`,LANG:`lang`,LOOP:`loop`,LIVE_EDGE_OFFSET:`liveedgeoffset`,NO_AUTO_SEEK_TO_LIVE:`noautoseektolive`,NO_DEFAULT_STORE:`nodefaultstore`,NO_HOTKEYS:`nohotkeys`,NO_MUTED_PREF:`nomutedpref`,NO_SUBTITLES_LANG_PREF:`nosubtitleslangpref`,NO_VOLUME_PREF:`novolumepref`,SEEK_TO_LIVE_OFFSET:`seektoliveoffset`},Tu=class extends Qc{constructor(){super(),nu(this,fu),nu(this,hu),nu(this,_u),this.mediaStateReceivers=[],this.associatedElementSubscriptions=new Map,nu(this,au,new ll(this,U.HOTKEYS)),nu(this,ou,void 0),nu(this,H,void 0),nu(this,su,null),nu(this,cu,void 0),nu(this,lu,void 0),nu(this,uu,e=>{var t;(t=V(this,H))==null||t.dispatch(e)}),nu(this,du,void 0),nu(this,mu,e=>{let{key:t,shiftKey:n}=e;if(!(n&&(t===`/`||t===`?`)||yu.includes(t))){this.removeEventListener(`keyup`,V(this,mu));return}this.keyboardShortcutHandler(e)}),this.associateElement(this);let e={};ru(this,cu,t=>{Object.entries(t).forEach(([t,n])=>{if(t in e&&e[t]===n)return;this.propagateMediaState(t,n);let r=t.toLowerCase(),i=new N.CustomEvent(cs[r],{composed:!0,detail:n});this.dispatchEvent(i)}),e=t})}static get observedAttributes(){return super.observedAttributes.concat(U.NO_HOTKEYS,U.HOTKEYS,U.DEFAULT_STREAM_TYPE,U.DEFAULT_SUBTITLES,U.DEFAULT_DURATION,U.NO_MUTED_PREF,U.NO_VOLUME_PREF,U.LANG,U.LOOP,U.LIVE_EDGE_OFFSET,U.SEEK_TO_LIVE_OFFSET,U.NO_AUTO_SEEK_TO_LIVE)}get mediaStore(){return V(this,H)}set mediaStore(e){var t;if(V(this,H)&&((t=V(this,lu))==null||t.call(this),ru(this,lu,void 0)),ru(this,H,e),!V(this,H)&&!this.hasAttribute(U.NO_DEFAULT_STORE)){iu(this,fu,pu).call(this);return}ru(this,lu,V(this,H)?.subscribe(V(this,cu)))}get fullscreenElement(){return V(this,ou)??this}set fullscreenElement(e){var t;this.hasAttribute(U.FULLSCREEN_ELEMENT)&&this.removeAttribute(U.FULLSCREEN_ELEMENT),ru(this,ou,e),(t=V(this,H))==null||t.dispatch({type:`fullscreenelementchangerequest`,detail:this.fullscreenElement})}get defaultSubtitles(){return I(this,U.DEFAULT_SUBTITLES)}set defaultSubtitles(e){L(this,U.DEFAULT_SUBTITLES,e)}get defaultStreamType(){return R(this,U.DEFAULT_STREAM_TYPE)}set defaultStreamType(e){z(this,U.DEFAULT_STREAM_TYPE,e)}get defaultDuration(){return P(this,U.DEFAULT_DURATION)}set defaultDuration(e){F(this,U.DEFAULT_DURATION,e)}get noHotkeys(){return I(this,U.NO_HOTKEYS)}set noHotkeys(e){L(this,U.NO_HOTKEYS,e)}get keysUsed(){return R(this,U.KEYS_USED)}set keysUsed(e){z(this,U.KEYS_USED,e)}get liveEdgeOffset(){return P(this,U.LIVE_EDGE_OFFSET)}set liveEdgeOffset(e){F(this,U.LIVE_EDGE_OFFSET,e)}get noAutoSeekToLive(){return I(this,U.NO_AUTO_SEEK_TO_LIVE)}set noAutoSeekToLive(e){L(this,U.NO_AUTO_SEEK_TO_LIVE,e)}get noVolumePref(){return I(this,U.NO_VOLUME_PREF)}set noVolumePref(e){L(this,U.NO_VOLUME_PREF,e)}get noMutedPref(){return I(this,U.NO_MUTED_PREF)}set noMutedPref(e){L(this,U.NO_MUTED_PREF,e)}get noSubtitlesLangPref(){return I(this,U.NO_SUBTITLES_LANG_PREF)}set noSubtitlesLangPref(e){L(this,U.NO_SUBTITLES_LANG_PREF,e)}get noDefaultStore(){return I(this,U.NO_DEFAULT_STORE)}set noDefaultStore(e){L(this,U.NO_DEFAULT_STORE,e)}get resolvedLang(){return js()}attributeChangedCallback(e,t,n){var r,i,a,o,s,c,l,u,d,f;if(super.attributeChangedCallback(e,t,n),e===U.NO_HOTKEYS)n!==t&&n===``?(this.hasAttribute(U.HOTKEYS)&&console.warn("Media Chrome: Both `hotkeys` and `nohotkeys` have been set. All hotkeys will be disabled."),this.disableHotkeys()):n!==t&&n===null&&this.enableHotkeys();else if(e===U.HOTKEYS)V(this,au).value=n;else if(e===U.DEFAULT_SUBTITLES&&n!==t)(r=V(this,H))==null||r.dispatch({type:`optionschangerequest`,detail:{defaultSubtitles:this.hasAttribute(U.DEFAULT_SUBTITLES)}});else if(e===U.DEFAULT_STREAM_TYPE)(i=V(this,H))==null||i.dispatch({type:`optionschangerequest`,detail:{defaultStreamType:this.getAttribute(U.DEFAULT_STREAM_TYPE)??void 0}});else if(e===U.LIVE_EDGE_OFFSET&&n!==t)(a=V(this,H))==null||a.dispatch({type:`optionschangerequest`,detail:{liveEdgeOffset:this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0,seekToLiveOffset:this.hasAttribute(U.SEEK_TO_LIVE_OFFSET)?+this.getAttribute(U.SEEK_TO_LIVE_OFFSET):this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0}});else if(e===U.SEEK_TO_LIVE_OFFSET&&n!==t)(o=V(this,H))==null||o.dispatch({type:`optionschangerequest`,detail:{seekToLiveOffset:this.hasAttribute(U.SEEK_TO_LIVE_OFFSET)?+this.getAttribute(U.SEEK_TO_LIVE_OFFSET):this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0}});else if(e===U.NO_AUTO_SEEK_TO_LIVE)(s=V(this,H))==null||s.dispatch({type:`optionschangerequest`,detail:{noAutoSeekToLive:this.hasAttribute(U.NO_AUTO_SEEK_TO_LIVE)}});else if(e===U.FULLSCREEN_ELEMENT){let e=n?this.getRootNode()?.getElementById(n):void 0;ru(this,ou,e),(c=V(this,H))==null||c.dispatch({type:`fullscreenelementchangerequest`,detail:this.fullscreenElement})}else e===U.LANG&&n!==t?(ks(n),(l=V(this,H))==null||l.dispatch({type:`optionschangerequest`,detail:{mediaLang:n}})):e===U.LOOP&&n!==t?(u=V(this,H))==null||u.dispatch({type:k.MEDIA_LOOP_REQUEST,detail:n!=null}):e===U.NO_VOLUME_PREF&&n!==t?(d=V(this,H))==null||d.dispatch({type:`optionschangerequest`,detail:{noVolumePref:this.hasAttribute(U.NO_VOLUME_PREF)}}):e===U.NO_MUTED_PREF&&n!==t&&((f=V(this,H))==null||f.dispatch({type:`optionschangerequest`,detail:{noMutedPref:this.hasAttribute(U.NO_MUTED_PREF)}}))}connectedCallback(){var e,t;this.associateElement(this),!V(this,H)&&!this.hasAttribute(U.NO_DEFAULT_STORE)&&iu(this,fu,pu).call(this),(e=V(this,H))==null||e.dispatch({type:`documentelementchangerequest`,detail:Ws}),(t=V(this,H))==null||t.dispatch({type:`fullscreenelementchangerequest`,detail:this.fullscreenElement}),super.connectedCallback(),V(this,H)&&!V(this,lu)&&ru(this,lu,V(this,H)?.subscribe(V(this,cu))),V(this,du)!==void 0&&V(this,H)&&this.media&&setTimeout(()=>{var e;this.media?.textTracks?.length&&((e=V(this,H))==null||e.dispatch({type:k.MEDIA_TOGGLE_SUBTITLES_REQUEST,detail:V(this,du)}))},0),this.hasAttribute(U.NO_HOTKEYS)?this.disableHotkeys():this.enableHotkeys()}disconnectedCallback(){var e,t,n,r,i;if((e=super.disconnectedCallback)==null||e.call(this),this.disableHotkeys(),V(this,H)){let e=V(this,H).getState();ru(this,du,!!e.mediaSubtitlesShowing?.length),(t=V(this,H))==null||t.dispatch({type:`fullscreenelementchangerequest`,detail:void 0}),(n=V(this,H))==null||n.dispatch({type:`documentelementchangerequest`,detail:void 0}),(r=V(this,H))==null||r.dispatch({type:k.MEDIA_TOGGLE_SUBTITLES_REQUEST,detail:!1})}V(this,lu)&&((i=V(this,lu))==null||i.call(this),ru(this,lu,void 0)),this.unassociateElement(this),V(this,su)&&(V(this,su).remove(),ru(this,su,null))}mediaSetCallback(e){var t;super.mediaSetCallback(e),(t=V(this,H))==null||t.dispatch({type:`mediaelementchangerequest`,detail:e}),e.hasAttribute(`tabindex`)||(e.tabIndex=-1)}mediaUnsetCallback(e){var t;super.mediaUnsetCallback(e),(t=V(this,H))==null||t.dispatch({type:`mediaelementchangerequest`,detail:void 0})}propagateMediaState(e,t){Iu(this.mediaStateReceivers,e,t)}associateElement(e){if(!e)return;let{associatedElementSubscriptions:t}=this;if(t.has(e))return;let n=Lu(e,this.registerMediaStateReceiver.bind(this),this.unregisterMediaStateReceiver.bind(this));Object.values(k).forEach(t=>{e.addEventListener(t,V(this,uu))}),t.set(e,n)}unassociateElement(e){if(!e)return;let{associatedElementSubscriptions:t}=this;t.has(e)&&(t.get(e)(),t.delete(e),Object.values(k).forEach(t=>{e.removeEventListener(t,V(this,uu))}))}registerMediaStateReceiver(e){if(!e)return;let t=this.mediaStateReceivers;t.indexOf(e)>-1||(t.push(e),V(this,H)&&Object.entries(V(this,H).getState()).forEach(([t,n])=>{Iu([e],t,n)}))}unregisterMediaStateReceiver(e){let t=this.mediaStateReceivers,n=t.indexOf(e);n<0||t.splice(n,1)}enableHotkeys(){this.addEventListener(`keydown`,iu(this,hu,gu))}disableHotkeys(){this.removeEventListener(`keydown`,iu(this,hu,gu)),this.removeEventListener(`keyup`,V(this,mu))}get hotkeys(){return V(this,au)}set hotkeys(e){z(this,U.HOTKEYS,e)}keyboardShortcutHandler(e){let t=e.target;if((t.getAttribute(U.KEYS_USED)?.split(` `)??t?.keysUsed??[]).map(e=>e===`Space`?` `:e).filter(Boolean).includes(e.key))return;let n,r,i;if(!V(this,au).contains(`no${e.key.toLowerCase()}`)&&!(e.key===` `&&V(this,au).contains(`nospace`))&&!(e.shiftKey&&(e.key===`/`||e.key===`?`)&&V(this,au).contains(`noshift+/`)))switch(e.key){case` `:case`k`:n=V(this,H).getState().mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST,this.dispatchEvent(new N.CustomEvent(n,{composed:!0,bubbles:!0}));break;case`m`:n=this.mediaStore.getState().mediaVolumeLevel===`off`?k.MEDIA_UNMUTE_REQUEST:k.MEDIA_MUTE_REQUEST,this.dispatchEvent(new N.CustomEvent(n,{composed:!0,bubbles:!0}));break;case`f`:n=this.mediaStore.getState().mediaIsFullscreen?k.MEDIA_EXIT_FULLSCREEN_REQUEST:k.MEDIA_ENTER_FULLSCREEN_REQUEST,this.dispatchEvent(new N.CustomEvent(n,{composed:!0,bubbles:!0}));break;case`c`:this.dispatchEvent(new N.CustomEvent(k.MEDIA_TOGGLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0}));break;case`ArrowLeft`:case`j`:{let e=this.hasAttribute(U.KEYBOARD_BACKWARD_SEEK_OFFSET)?+this.getAttribute(U.KEYBOARD_BACKWARD_SEEK_OFFSET):bu;r=Math.max((this.mediaStore.getState().mediaCurrentTime??0)-e,0),i=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`ArrowRight`:case`l`:{let e=this.hasAttribute(U.KEYBOARD_FORWARD_SEEK_OFFSET)?+this.getAttribute(U.KEYBOARD_FORWARD_SEEK_OFFSET):bu;r=Math.max((this.mediaStore.getState().mediaCurrentTime??0)+e,0),i=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`ArrowUp`:{let e=this.hasAttribute(U.KEYBOARD_UP_VOLUME_STEP)?+this.getAttribute(U.KEYBOARD_UP_VOLUME_STEP):xu;r=Math.min((this.mediaStore.getState().mediaVolume??1)+e,1),i=new N.CustomEvent(k.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`ArrowDown`:{let e=this.hasAttribute(U.KEYBOARD_DOWN_VOLUME_STEP)?+this.getAttribute(U.KEYBOARD_DOWN_VOLUME_STEP):xu;r=Math.max((this.mediaStore.getState().mediaVolume??1)-e,0),i=new N.CustomEvent(k.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`<`:{let e=this.mediaStore.getState().mediaPlaybackRate??1;r=Math.max(e-Su,Cu).toFixed(2),i=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`>`:{let e=this.mediaStore.getState().mediaPlaybackRate??1;r=Math.min(e+Su,wu).toFixed(2),i=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`/`:case`?`:e.shiftKey&&iu(this,_u,vu).call(this);break;case`p`:n=this.mediaStore.getState().mediaIsPip?k.MEDIA_EXIT_PIP_REQUEST:k.MEDIA_ENTER_PIP_REQUEST,i=new N.CustomEvent(n,{composed:!0,bubbles:!0}),this.dispatchEvent(i);break;default:break}}};au=new WeakMap,ou=new WeakMap,H=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakSet,pu=function(){this.mediaStore=eu({media:this.media,fullscreenElement:this.fullscreenElement,options:{defaultSubtitles:this.hasAttribute(U.DEFAULT_SUBTITLES),defaultDuration:this.hasAttribute(U.DEFAULT_DURATION)?+this.getAttribute(U.DEFAULT_DURATION):void 0,defaultStreamType:this.getAttribute(U.DEFAULT_STREAM_TYPE)??void 0,liveEdgeOffset:this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0,seekToLiveOffset:this.hasAttribute(U.SEEK_TO_LIVE_OFFSET)?+this.getAttribute(U.SEEK_TO_LIVE_OFFSET):this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0,noAutoSeekToLive:this.hasAttribute(U.NO_AUTO_SEEK_TO_LIVE),noVolumePref:this.hasAttribute(U.NO_VOLUME_PREF),noMutedPref:this.hasAttribute(U.NO_MUTED_PREF),noSubtitlesLangPref:this.hasAttribute(U.NO_SUBTITLES_LANG_PREF)}})},mu=new WeakMap,hu=new WeakSet,gu=function(e){let{metaKey:t,altKey:n,key:r,shiftKey:i}=e,a=i&&(r===`/`||r===`?`);if(a&&V(this,su)?.open){this.removeEventListener(`keyup`,V(this,mu));return}if(t||n||!a&&!yu.includes(r)){this.removeEventListener(`keyup`,V(this,mu));return}let o=e.target,s=o instanceof HTMLElement&&(o.tagName.toLowerCase()===`media-volume-range`||o.tagName.toLowerCase()===`media-time-range`);[` `,`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`].includes(r)&&!(V(this,au).contains(`no${r.toLowerCase()}`)||r===` `&&V(this,au).contains(`nospace`))&&!s&&e.preventDefault(),this.addEventListener(`keyup`,V(this,mu),{once:!0})},_u=new WeakSet,vu=function(){V(this,su)||(ru(this,su,Ws.createElement(`media-keyboard-shortcuts-dialog`)),this.appendChild(V(this,su))),V(this,su).open=!0};var Eu=Object.values(j),Du=Object.values(as),Ou=e=>{var t;let{observedAttributes:n}=e.constructor;!n&&e.nodeName?.includes(`-`)&&(N.customElements.upgrade(e),{observedAttributes:n}=e.constructor);let r=((t=(e?.getAttribute)?.call(e,A.MEDIA_CHROME_ATTRIBUTES))?.split)?.call(t,/\s+/);return Array.isArray(n||r)?(n||r).filter(e=>Eu.includes(e)):[]},ku=e=>(e.nodeName?.includes(`-`)&&N.customElements.get(e.nodeName?.toLowerCase())&&!(e instanceof N.customElements.get(e.nodeName.toLowerCase()))&&N.customElements.upgrade(e),Du.some(t=>t in e)),Au=e=>ku(e)||!!Ou(e).length,ju=e=>(e?.join)?.call(e,`:`),Mu={[j.MEDIA_SUBTITLES_LIST]:hl,[j.MEDIA_SUBTITLES_SHOWING]:hl,[j.MEDIA_SEEKABLE]:ju,[j.MEDIA_BUFFERED]:e=>e?.map(ju).join(` `),[j.MEDIA_PREVIEW_COORDS]:e=>e?.join(` `),[j.MEDIA_RENDITION_LIST]:hs,[j.MEDIA_AUDIO_TRACK_LIST]:ys},Nu=async(e,t,n)=>{if(e.isConnected||await Es(0),typeof n==`boolean`||n==null)return L(e,t,n);if(typeof n==`number`)return F(e,t,n);if(typeof n==`string`)return z(e,t,n);if(Array.isArray(n)&&!n.length)return e.removeAttribute(t);let r=Mu[t]?.call(Mu,n)??n;return e.setAttribute(t,r)},Pu=e=>!!e.closest?.call(e,`*[slot="media"]`),Fu=(e,t)=>{if(Pu(e))return;let n=(e,t)=>{Au(e)&&t(e);let{children:n=[]}=e??{},r=e?.shadowRoot?.children??[];[...n,...r].forEach(e=>Fu(e,t))},r=e?.nodeName.toLowerCase();if(r.includes(`-`)&&!Au(e)){N.customElements.whenDefined(r).then(()=>{n(e,t)});return}n(e,t)},Iu=(e,t,n)=>{e.forEach(e=>{if(t in e){e[t]=n;return}let r=Ou(e),i=t.toLowerCase();r.includes(i)&&Nu(e,i,n)})},Lu=(e,t,n)=>{Fu(e,t);let r=e=>{t(e?.composedPath()[0]??e.target)},i=e=>{n(e?.composedPath()[0]??e.target)};e.addEventListener(k.REGISTER_MEDIA_STATE_RECEIVER,r),e.addEventListener(k.UNREGISTER_MEDIA_STATE_RECEIVER,i);let a=e=>{e.forEach(e=>{let{addedNodes:r=[],removedNodes:i=[],type:a,target:o,attributeName:s}=e;a===`childList`?(Array.prototype.forEach.call(r,e=>Fu(e,t)),Array.prototype.forEach.call(i,e=>Fu(e,n))):a===`attributes`&&s===A.MEDIA_CHROME_ATTRIBUTES&&(Au(o)?t(o):n(o))})},o=[],s=e=>{let r=e.target;r.name!==`media`&&(o.forEach(e=>Fu(e,n)),o=[...r.assignedElements({flatten:!0})],o.forEach(e=>Fu(e,t)))};e.addEventListener(`slotchange`,s);let c=new MutationObserver(a);return c.observe(e,{childList:!0,attributes:!0,subtree:!0}),()=>{Fu(e,n),e.removeEventListener(`slotchange`,s),c.disconnect(),e.removeEventListener(k.REGISTER_MEDIA_STATE_RECEIVER,r),e.removeEventListener(k.UNREGISTER_MEDIA_STATE_RECEIVER,i)}};N.customElements.get(`media-controller`)||N.customElements.define(`media-controller`,Tu);var Ru=Tu,zu={PLACEMENT:`placement`,BOUNDS:`bounds`};function Bu(e){return`
    <style>
      :host {
    ...
    <slot></slot>
    <div id="arrow"></div>
  `}var Vu=class extends N.HTMLElement{constructor(){if(super(),this.updateXOffset=()=>{if(!oc(this,{checkOpacity:!1,checkVisibilityCSS:!1}))return;let e=this.placement;if(e===`left`||e===`right`){this.style.removeProperty(`--media-tooltip-offset-x`);return}let t=getComputedStyle(this),n=rc(this,`#`+this.bounds)??Zs(this);if(!n)return;let{x:r,width:i}=n.getBoundingClientRect(),{x:a,width:o}=this.getBoundingClientRect(),s=a+o,c=r+i,l=t.getPropertyValue(`--media-tooltip-offset-x`),u=l?parseFloat(l.replace(`px`,``)):0,d=t.getPropertyValue(`--media-tooltip-container-margin`),f=d?parseFloat(d.replace(`px`,``)):0,p=a-r+u-f,m=s-c+u+f;if(p<0){this.style.setProperty(`--media-tooltip-offset-x`,`${p}px`);return}if(m>0){this.style.setProperty(`--media-tooltip-offset-x`,`${m}px`);return}this.style.removeProperty(`--media-tooltip-offset-x`)},!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}if(this.arrowEl=this.shadowRoot.querySelector(`#arrow`),Object.prototype.hasOwnProperty.call(this,`placement`)){let e=this.placement;delete this.placement,this.placement=e}}static get observedAttributes(){return[zu.PLACEMENT,zu.BOUNDS]}get placement(){return R(this,zu.PLACEMENT)}set placement(e){z(this,zu.PLACEMENT,e)}get bounds(){return R(this,zu.BOUNDS)}set bounds(e){z(this,zu.BOUNDS,e)}};Vu.shadowRootOptions={mode:`open`},Vu.getTemplateHTML=Bu,N.customElements.get(`media-tooltip`)||N.customElements.define(`media-tooltip`,Vu);var Hu=Vu,Uu=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Wu=(e,t,n)=>(Uu(e,t,`read from private field`),n?n.call(e):t.get(e)),Gu=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Ku=(e,t,n,r)=>(Uu(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),qu=(e,t,n)=>(Uu(e,t,`access private method`),n),Ju,Yu,Xu,Zu,Qu,$u,ed,td={TOOLTIP_PLACEMENT:`tooltipplacement`,DISABLED:`disabled`,NO_TOOLTIP:`notooltip`};function nd(e,t={}){return`
    <style>
      :host {
        position: relative;
        font: var(--media-font,
  ...
  `}function rd(e,t){return`
    <slot></slot>
  `}function id(){return``}var ad=class extends N.HTMLElement{constructor(){if(super(),Gu(this,$u),Gu(this,Ju,void 0),this.preventClick=!1,this.tooltipEl=null,Gu(this,Yu,e=>{this.preventClick||this.handleClick(e),setTimeout(Wu(this,Xu),0)}),Gu(this,Xu,()=>{var e,t;(t=(e=this.tooltipEl)?.updateXOffset)==null||t.call(e)}),Gu(this,Zu,e=>{let{key:t}=e;if(!this.keysUsed.includes(t)){this.removeEventListener(`keyup`,Wu(this,Zu));return}this.preventClick||this.handleClick(e)}),Gu(this,Qu,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!this.keysUsed.includes(r)){this.removeEventListener(`keyup`,Wu(this,Zu));return}this.addEventListener(`keyup`,Wu(this,Zu),{once:!0})}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}this.tooltipEl=this.shadowRoot.querySelector(`media-tooltip`)}static get observedAttributes(){return[`disabled`,td.TOOLTIP_PLACEMENT,A.MEDIA_CONTROLLER,j.MEDIA_LANG]}enable(){this.addEventListener(`click`,Wu(this,Yu)),this.addEventListener(`keydown`,Wu(this,Qu)),this.tabIndex=0}disable(){this.removeEventListener(`click`,Wu(this,Yu)),this.removeEventListener(`keydown`,Wu(this,Qu)),this.removeEventListener(`keyup`,Wu(this,Zu)),this.tabIndex=-1}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER?(t&&((i=(r=Wu(this,Ju))?.unassociateElement)==null||i.call(r,this),Ku(this,Ju,null)),n&&this.isConnected&&(Ku(this,Ju,this.getRootNode()?.getElementById(n)),(o=(a=Wu(this,Ju))?.associateElement)==null||o.call(a,this))):e===`disabled`&&n!==t?n==null?this.enable():this.disable():e===td.TOOLTIP_PLACEMENT&&this.tooltipEl&&n!==t?this.tooltipEl.placement=n:e===j.MEDIA_LANG&&(this.shadowRoot.querySelector(`slot[name="tooltip-content"]`).innerHTML=this.constructor.getTooltipContentHTML()),Wu(this,Xu).call(this)}connectedCallback(){var e,t;let{style:n}=cc(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),this.hasAttribute(`disabled`)?this.disable():this.enable(),this.setAttribute(`role`,`button`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(Ku(this,Ju,this.getRootNode()?.getElementById(r)),(t=(e=Wu(this,Ju))?.associateElement)==null||t.call(e,this)),N.customElements.whenDefined(`media-tooltip`).then(()=>qu(this,$u,ed).call(this))}disconnectedCallback(){var e,t;this.disable(),(t=(e=Wu(this,Ju))?.unassociateElement)==null||t.call(e,this),Ku(this,Ju,null),this.removeEventListener(`mouseenter`,Wu(this,Xu)),this.removeEventListener(`focus`,Wu(this,Xu)),this.removeEventListener(`click`,Wu(this,Yu))}get keysUsed(){return[`Enter`,` `]}get tooltipPlacement(){return R(this,td.TOOLTIP_PLACEMENT)}set tooltipPlacement(e){z(this,td.TOOLTIP_PLACEMENT,e)}get mediaController(){return R(this,A.MEDIA_CONTROLLER)}set mediaController(e){z(this,A.MEDIA_CONTROLLER,e)}get disabled(){return I(this,td.DISABLED)}set disabled(e){L(this,td.DISABLED,e)}get noTooltip(){return I(this,td.NO_TOOLTIP)}set noTooltip(e){L(this,td.NO_TOOLTIP,e)}handleClick(e){}};Ju=new WeakMap,Yu=new WeakMap,Xu=new WeakMap,Zu=new WeakMap,Qu=new WeakMap,$u=new WeakSet,ed=function(){this.addEventListener(`mouseenter`,Wu(this,Xu)),this.addEventListener(`focus`,Wu(this,Xu)),this.addEventListener(`click`,Wu(this,Yu));let e=this.tooltipPlacement;e&&this.tooltipEl&&(this.tooltipEl.placement=e)},ad.shadowRootOptions={mode:`open`},ad.getTemplateHTML=nd,ad.getSlotTemplateHTML=rd,ad.getTooltipContentHTML=id,N.customElements.get(`media-chrome-button`)||N.customElements.define(`media-chrome-button`,ad);var od=`<svg aria-hidden="true" viewBox="0 0 26 24">
...
`;function sd(e){return`
  ...
  `}var ld=e=>{let t=e.mediaIsAirplaying?M(`stop airplay`):M(`start airplay`);e.setAttribute(`aria-label`,t)},ud=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_AIRPLAYING,j.MEDIA_AIRPLAY_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),ld(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_AIRPLAYING&&ld(this)}get mediaIsAirplaying(){return I(this,j.MEDIA_IS_AIRPLAYING)}set mediaIsAirplaying(e){L(this,j.MEDIA_IS_AIRPLAYING,e)}get mediaAirplayUnavailable(){return R(this,j.MEDIA_AIRPLAY_UNAVAILABLE)}set mediaAirplayUnavailable(e){z(this,j.MEDIA_AIRPLAY_UNAVAILABLE,e)}handleClick(){let e=new N.CustomEvent(k.MEDIA_AIRPLAY_REQUEST,{composed:!0,bubbles:!0});this.dispatchEvent(e)}};ud.getSlotTemplateHTML=sd,ud.getTooltipContentHTML=cd,N.customElements.get(`media-airplay-button`)||N.customElements.define(`media-airplay-button`,ud);var dd=`<svg aria-hidden="true" viewBox="0 0 26 24">
  ...
  <path d="M17.73 14.09a1.4 1.4 0 0 1-1 .37 1.579 1.579 0 0 1-1.27-.58A3 3 0 0 1 15 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34A2.89 2.89 0 0 0 19 9.07a3 3 0 0 0-2.14-.78 3.14 3.14 0 0 0-2.42 1 3.91 3.91 0 0 0-.93 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.17 3.17 0 0 0 1.07-1.74l-1.4-.45c-.083.43-.3.822-.62 1.12Zm-7.22 0a1.43 1.43 0 0 1-1 .37 1.58 1.58 0 0 1-1.27-.58A3 3 0 0 1 7.76 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34a2.81 2.81 0 0 0-.74-1.32 2.94 2.94 0 0 0-2.13-.78 3.18 3.18 0 0 0-2.43 1 4 4 0 0 0-.92 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.23 3.23 0 0 0 1.07-1.74l-1.4-.45a2.06 2.06 0 0 1-.6 1.07Zm12.32-8.41a2.59 2.59 0 0 0-2.3-2.51C18.72 3.05 15.86 3 13 3c-2.86 0-5.72.05-7.53.17a2.59 2.59 0 0 0-2.3 2.51c-.23 4.207-.23 8.423 0 12.63a2.57 2.57 0 0 0 2.3 2.5c1.81.13 4.67.19 7.53.19 2.86 0 5.72-.06 7.53-.19a2.57 2.57 0 0 0 2.3-2.5c.23-4.207.23-8.423 0-12.63Zm-1.49 12.53a1.11 1.11 0 0 1-.91 1.11c-1.67.11-4.45.18-7.43.18-2.98 0-5.76-.07-7.43-.18a1.11 1.11 0 0 1-.91-1.11c-.21-4.14-.21-8.29 0-12.43a1.11 1.11 0 0 1 .91-1.11C7.24 4.56 10 4.49 13 4.49s5.76.07 7.43.18a1.11 1.11 0 0 1 .91 1.11c.21 4.14.21 8.29 0 12.43Z"/>
    ...
    <slot name="icon">
      ...
      <slot name="off">${fd}</slot>
    </slot>
  `}function md(){return`
    <slot name="tooltip-enable">${M(`Enable captions`)}</slot>
    <slot name="tooltip-disable">${M(`Disable captions`)}</slot>
  `}var hd=e=>{e.setAttribute(`aria-checked`,bl(e).toString())},gd=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING]}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`button`),this.setAttribute(`aria-label`,M(`closed captions`)),hd(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_SHOWING&&hd(this)}get mediaSubtitlesList(){return _d(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){vd(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return _d(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){vd(this,j.MEDIA_SUBTITLES_SHOWING,e)}handleClick(){this.dispatchEvent(new N.CustomEvent(k.MEDIA_TOGGLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0}))}};gd.getSlotTemplateHTML=pd,gd.getTooltipContentHTML=md;var _d=(e,t)=>{let n=e.getAttribute(t);return n?fl(n):[]},vd=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=hl(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-button`)||N.customElements.define(`media-captions-button`,gd);var yd=`<svg aria-hidden="true" viewBox="0 0 24 24"><g><path class="cast_caf_icon_arch0" d="M1,18 L1,21 L4,21 C4,19.3 2.66,18 1,18 L1,18 Z"/><path class="cast_caf_icon_arch1" d="M1,14 L1,16 C3.76,16 6,18.2 6,21 L8,21 C8,17.13 4.87,14 1,14 L1,14 Z"/><path class="cast_caf_icon_arch2" d="M1,10 L1,12 C5.97,12 10,16.0 10,21 L12,21 C12,14.92 7.07,10 1,10 L1,10 Z"/><path class="cast_caf_icon_box" d="M21,3 L3,3 C1.9,3 1,3.9 1,5 L1,8 L3,8 L3,5 L21,5 L21,19 L14,19 L14,21 L21,21 C22.1,21 23,20.1 23,19 L23,5 C23,3.9 22.1,3 21,3 L21,3 Z"/></g></svg>`,bd=`<svg aria-hidden="true" viewBox="0 0 24 24"><g><path class="cast_caf_icon_arch0" d="M1,18 L1,21 L4,21 C4,19.3 2.66,18 1,18 L1,18 Z"/><path class="cast_caf_icon_arch1" d="M1,14 L1,16 C3.76,16 6,18.2 6,21 L8,21 C8,17.13 4.87,14 1,14 L1,14 Z"/><path class="cast_caf_icon_arch2" d="M1,10 L1,12 C5.97,12 10,16.0 10,21 L12,21 C12,14.92 7.07,10 1,10 L1,10 Z"/><path class="cast_caf_icon_box" d="M21,3 L3,3 C1.9,3 1,3.9 1,5 L1,8 L3,8 L3,5 L21,5 L21,19 L14,19 L14,21 L21,21 C22.1,21 23,20.1 23,19 L23,5 C23,3.9 22.1,3 21,3 L21,3 Z"/><path class="cast_caf_icon_boxfill" d="M5,7 L5,8.63 C8,8.6 13.37,14 13.37,17 L19,17 L19,7 Z"/></g></svg>`;function xd(e){return`
    <style>
  ...
  `}var Cd=e=>{let t=e.mediaIsCasting?M(`stop casting`):M(`start casting`);e.setAttribute(`aria-label`,t)},wd=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_CASTING,j.MEDIA_CAST_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),Cd(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_CASTING&&Cd(this)}get mediaIsCasting(){return I(this,j.MEDIA_IS_CASTING)}set mediaIsCasting(e){L(this,j.MEDIA_IS_CASTING,e)}get mediaCastUnavailable(){return R(this,j.MEDIA_CAST_UNAVAILABLE)}set mediaCastUnavailable(e){z(this,j.MEDIA_CAST_UNAVAILABLE,e)}handleClick(){let e=this.mediaIsCasting?k.MEDIA_EXIT_CAST_REQUEST:k.MEDIA_ENTER_CAST_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};wd.getSlotTemplateHTML=xd,wd.getTooltipContentHTML=Sd,N.customElements.get(`media-cast-button`)||N.customElements.define(`media-cast-button`,wd);var Td=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Ed=(e,t,n)=>(Td(e,t,`read from private field`),n?n.call(e):t.get(e)),Dd=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Od=(e,t,n,r)=>(Td(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),kd=(e,t,n)=>(Td(e,t,`access private method`),n),Ad,jd,Md,Nd,Pd,Fd,Id,Ld,Rd,zd,Bd,Vd,Hd,Ud,Wd;function Gd(e){return`
    <style>
      :host {
        font: var(--media-font,
  ...
  `}var qd={OPEN:`open`,ANCHOR:`anchor`},Jd=class extends N.HTMLElement{constructor(){super(),Dd(this,Nd),Dd(this,Fd),Dd(this,Ld),Dd(this,zd),Dd(this,Vd),Dd(this,Ud),Dd(this,Ad,!1),Dd(this,jd,null),Dd(this,Md,null)}static get observedAttributes(){return[qd.OPEN,qd.ANCHOR]}get open(){return I(this,qd.OPEN)}set open(e){L(this,qd.OPEN,e)}handleEvent(e){switch(e.type){case`invoke`:kd(this,zd,Bd).call(this,e);break;case`focusout`:kd(this,Vd,Hd).call(this,e);break;case`keydown`:kd(this,Ud,Wd).call(this,e);break}}connectedCallback(){kd(this,Nd,Pd).call(this),this.role||=`dialog`,this.addEventListener(`invoke`,this),this.addEventListener(`focusout`,this),this.addEventListener(`keydown`,this)}disconnectedCallback(){this.removeEventListener(`invoke`,this),this.removeEventListener(`focusout`,this),this.removeEventListener(`keydown`,this)}attributeChangedCallback(e,t,n){kd(this,Nd,Pd).call(this),e===qd.OPEN&&n!==t&&(this.open?kd(this,Fd,Id).call(this):kd(this,Ld,Rd).call(this))}focus(){Od(this,jd,ic());let e=!this.dispatchEvent(new Event(`focus`,{composed:!0,cancelable:!0})),t=!this.dispatchEvent(new Event(`focusin`,{composed:!0,bubbles:!0,cancelable:!0}));e||t||this.querySelector(`[autofocus], [tabindex]:not([tabindex="-1"]), [role="menu"]`)?.focus()}get keysUsed(){return[`Escape`,`Tab`]}};Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakSet,Pd=function(){if(!Ed(this,Ad)&&(Od(this,Ad,!0),!this.shadowRoot)){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e),queueMicrotask(()=>{let{style:e}=cc(this.shadowRoot,`:host`);e.setProperty(`transition`,`display .15s, visibility .15s, opacity .15s ease-in, transform .15s ease-in`)})}},Fd=new WeakSet,Id=function(){var e;(e=Ed(this,Md))==null||e.setAttribute(`aria-expanded`,`true`),this.dispatchEvent(new Event(`open`,{composed:!0,bubbles:!0})),this.addEventListener(`transitionend`,()=>this.focus(),{once:!0})},Ld=new WeakSet,Rd=function(){var e;(e=Ed(this,Md))==null||e.setAttribute(`aria-expanded`,`false`),this.dispatchEvent(new Event(`close`,{composed:!0,bubbles:!0}))},zd=new WeakSet,Bd=function(e){Od(this,Md,e.relatedTarget),nc(this,e.relatedTarget)||(this.open=!this.open)},Vd=new WeakSet,Hd=function(e){var t;nc(this,e.relatedTarget)||((t=Ed(this,jd))==null||t.focus(),Ed(this,Md)&&Ed(this,Md)!==e.relatedTarget&&this.open&&(this.open=!1))},Ud=new WeakSet,Wd=function(e){var t,n,r,i,a;let{key:o,ctrlKey:s,altKey:c,metaKey:l}=e;s||c||l||this.keysUsed.includes(o)&&(e.preventDefault(),e.stopPropagation(),o===`Tab`?(e.shiftKey?(n=(t=this.previousElementSibling)?.focus)==null||n.call(t):(i=(r=this.nextElementSibling)?.focus)==null||i.call(r),this.blur()):o===`Escape`&&((a=Ed(this,jd))==null||a.focus(),this.open=!1))},Jd.shadowRootOptions={mode:`open`},Jd.getTemplateHTML=Gd,Jd.getSlotTemplateHTML=Kd,N.customElements.get(`media-chrome-dialog`)||N.customElements.define(`media-chrome-dialog`,Jd);var Yd=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},W=(e,t,n)=>(Yd(e,t,`read from private field`),n?n.call(e):t.get(e)),Xd=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Zd=(e,t,n,r)=>(Yd(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Qd=(e,t,n)=>(Yd(e,t,`access private method`),n),$d,ef,tf,nf,rf,af,of,sf,cf,lf,uf,df,ff,pf,mf,hf,gf,_f,vf,yf,bf,xf,Sf,Cf,wf;function Tf(e){return`
    <style>
      :host {
    ...
    <div id="rightgap"></div>
  `}function Ef(e){return``}var Df=class extends N.HTMLElement{constructor(){if(super(),Xd(this,lf),Xd(this,df),Xd(this,pf),Xd(this,hf),Xd(this,_f),Xd(this,yf),Xd(this,xf),Xd(this,Cf),Xd(this,$d,void 0),Xd(this,ef,void 0),Xd(this,tf,void 0),Xd(this,nf,void 0),Xd(this,rf,{}),Xd(this,af,[]),Xd(this,of,()=>{if(this.range.matches(`:focus-visible`)){let{style:e}=cc(this.shadowRoot,`:host`);e.setProperty(`--_focus-visible-box-shadow`,`var(--_focus-box-shadow)`)}}),Xd(this,sf,()=>{let{style:e}=cc(this.shadowRoot,`:host`);e.removeProperty(`--_focus-visible-box-shadow`)}),Xd(this,cf,()=>{let e=this.shadowRoot.querySelector(`#segments-clipping`);e&&e.parentNode.append(e)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}this.container=this.shadowRoot.querySelector(`#container`),Zd(this,tf,this.shadowRoot.querySelector(`#startpoint`)),Zd(this,nf,this.shadowRoot.querySelector(`#endpoint`)),this.range=this.shadowRoot.querySelector(`#range`),this.appearance=this.shadowRoot.querySelector(`#appearance`)}static get observedAttributes(){return[`disabled`,`aria-disabled`,A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER?(t&&((i=(r=W(this,$d))?.unassociateElement)==null||i.call(r,this),Zd(this,$d,null)),n&&this.isConnected&&(Zd(this,$d,this.getRootNode()?.getElementById(n)),(o=(a=W(this,$d))?.associateElement)==null||o.call(a,this))):(e===`disabled`||e===`aria-disabled`&&t!==n)&&(n==null?(this.range.removeAttribute(e),Qd(this,df,ff).call(this)):(this.range.setAttribute(e,n),Qd(this,pf,mf).call(this)))}connectedCallback(){var e,t;let{style:n}=cc(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),W(this,rf).pointer=cc(this.shadowRoot,`#pointer`),W(this,rf).progress=cc(this.shadowRoot,`#progress`),W(this,rf).thumb=cc(this.shadowRoot,`#thumb, ::slotted([slot="thumb"])`),W(this,rf).activeSegment=cc(this.shadowRoot,`#segments-clipping rect:nth-child(0)`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(Zd(this,$d,this.getRootNode()?.getElementById(r)),(t=(e=W(this,$d))?.associateElement)==null||t.call(e,this)),this.updateBar(),this.shadowRoot.addEventListener(`focusin`,W(this,of)),this.shadowRoot.addEventListener(`focusout`,W(this,sf)),Qd(this,df,ff).call(this),Js(this.container,W(this,cf))}disconnectedCallback(){var e,t;Qd(this,pf,mf).call(this),(t=(e=W(this,$d))?.unassociateElement)==null||t.call(e,this),Zd(this,$d,null),this.shadowRoot.removeEventListener(`focusin`,W(this,of)),this.shadowRoot.removeEventListener(`focusout`,W(this,sf)),Ys(this.container,W(this,cf))}updatePointerBar(e){var t;(t=W(this,rf).pointer)==null||t.style.setProperty(`width`,`${this.getPointerRatio(e)*100}%`)}updateBar(){var e,t;let n=this.range.valueAsNumber*100;(e=W(this,rf).progress)==null||e.style.setProperty(`width`,`${n}%`),(t=W(this,rf).thumb)==null||t.style.setProperty(`left`,`${n}%`)}updateSegments(e){let t=this.shadowRoot.querySelector(`#segments-clipping`);if(t.textContent=``,this.container.classList.toggle(`segments`,!!e?.length),!e?.length)return;let n=[...new Set([+this.range.min,...e.flatMap(e=>[e.start,e.end]),+this.range.max])];Zd(this,af,[...n]);let r=n.pop();for(let[e,i]of n.entries()){let[a,o]=[e===0,e===n.length-1],s=a?`calc(var(--segments-gap) / -1)`:`${i*100}%`,c=`calc(${((o?r:n[e+1])-i)*100}%${a||o?``:` - var(--segments-gap)`})`,l=Ws.createElementNS(`http://www.w3.org/2000/svg`,`rect`),u=uc(this.shadowRoot,`#segments-clipping rect:nth-child(${e+1})`);u.style.setProperty(`x`,s),u.style.setProperty(`width`,c),t.append(l)}}getPointerRatio(e){return sc(e.clientX,e.clientY,W(this,tf).getBoundingClientRect(),W(this,nf).getBoundingClientRect())}get dragging(){return this.hasAttribute(`dragging`)}handleEvent(e){switch(e.type){case`pointermove`:Qd(this,Cf,wf).call(this,e);break;case`input`:this.updateBar();break;case`pointerenter`:Qd(this,_f,vf).call(this,e);break;case`pointerdown`:Qd(this,hf,gf).call(this,e);break;case`pointerup`:Qd(this,yf,bf).call(this);break;case`pointerleave`:Qd(this,xf,Sf).call(this);break}}get keysUsed(){return[`ArrowUp`,`ArrowRight`,`ArrowDown`,`ArrowLeft`]}};$d=new WeakMap,ef=new WeakMap,tf=new WeakMap,nf=new WeakMap,rf=new WeakMap,af=new WeakMap,of=new WeakMap,sf=new WeakMap,cf=new WeakMap,lf=new WeakSet,uf=function(e){let t=W(this,rf).activeSegment;if(!t)return;let n=this.getPointerRatio(e),r=`#segments-clipping rect:nth-child(${W(this,af).findIndex((e,t,r)=>{let i=r[t+1];return i!=null&&n>=e&&n<=i})+1})`;(t.selectorText!=r||!t.style.transform)&&(t.selectorText=r,t.style.setProperty(`transform`,`var(--media-range-segment-hover-transform, scaleY(2))`))},df=new WeakSet,ff=function(){this.hasAttribute(`disabled`)||!this.isConnected||(this.addEventListener(`input`,this),this.addEventListener(`pointerdown`,this),this.addEventListener(`pointerenter`,this))},pf=new WeakSet,mf=function(){var e,t;this.removeEventListener(`input`,this),this.removeEventListener(`pointerdown`,this),this.removeEventListener(`pointerenter`,this),this.removeEventListener(`pointerleave`,this),(e=N.window)==null||e.removeEventListener(`pointerup`,this),(t=N.window)==null||t.removeEventListener(`pointermove`,this)},hf=new WeakSet,gf=function(e){var t;Zd(this,ef,e.composedPath().includes(this.range)),(t=N.window)==null||t.addEventListener(`pointerup`,this,{once:!0})},_f=new WeakSet,vf=function(e){var t;e.pointerType!==`mouse`&&Qd(this,hf,gf).call(this,e),this.addEventListener(`pointerleave`,this,{once:!0}),(t=N.window)==null||t.addEventListener(`pointermove`,this)},yf=new WeakSet,bf=function(){var e;(e=N.window)==null||e.removeEventListener(`pointerup`,this),this.toggleAttribute(`dragging`,!1),this.range.disabled=this.hasAttribute(`disabled`)},xf=new WeakSet,Sf=function(){var e,t;this.removeEventListener(`pointerleave`,this),(e=N.window)==null||e.removeEventListener(`pointermove`,this),this.toggleAttribute(`dragging`,!1),this.range.disabled=this.hasAttribute(`disabled`),(t=W(this,rf).activeSegment)==null||t.style.removeProperty(`transform`)},Cf=new WeakSet,wf=function(e){e.pointerType===`pen`&&e.buttons===0||(this.toggleAttribute(`dragging`,e.buttons===1||e.pointerType!==`mouse`),this.updatePointerBar(e),Qd(this,lf,uf).call(this,e),this.dragging&&(e.pointerType!==`mouse`||!W(this,ef))&&(this.range.disabled=!0,this.range.valueAsNumber=this.getPointerRatio(e),this.range.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))))},Df.shadowRootOptions={mode:`open`},Df.getTemplateHTML=Tf,Df.getContainerTemplateHTML=Ef,N.customElements.get(`media-chrome-range`)||N.customElements.define(`media-chrome-range`,Df);var Of=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},kf=(e,t,n)=>(Of(e,t,`read from private field`),n?n.call(e):t.get(e)),Af=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},jf=(e,t,n,r)=>(Of(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Mf;function Nf(e){return`
    <style>
      :host {
    ...
    <slot></slot>
  `}var Pf=class extends N.HTMLElement{constructor(){if(super(),Af(this,Mf,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER&&(t&&((i=(r=kf(this,Mf))?.unassociateElement)==null||i.call(r,this),jf(this,Mf,null)),n&&this.isConnected&&(jf(this,Mf,this.getRootNode()?.getElementById(n)),(o=(a=kf(this,Mf))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;let n=this.getAttribute(A.MEDIA_CONTROLLER);n&&(jf(this,Mf,this.getRootNode()?.getElementById(n)),(t=(e=kf(this,Mf))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=kf(this,Mf))?.unassociateElement)==null||t.call(e,this),jf(this,Mf,null)}};Mf=new WeakMap,Pf.shadowRootOptions={mode:`open`},Pf.getTemplateHTML=Nf,N.customElements.get(`media-control-bar`)||N.customElements.define(`media-control-bar`,Pf);var Ff=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},If=(e,t,n)=>(Ff(e,t,`read from private field`),n?n.call(e):t.get(e)),Lf=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Rf=(e,t,n,r)=>(Ff(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),zf;function Bf(e,t={}){return`
    <style>
      :host {
        font: var(--media-font,
          var(--media-font-weight, normal)
  ...
  `}function Vf(e,t){return`
    <slot></slot>
  `}var Hf=class extends N.HTMLElement{constructor(){if(super(),Lf(this,zf,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER&&(t&&((i=(r=If(this,zf))?.unassociateElement)==null||i.call(r,this),Rf(this,zf,null)),n&&this.isConnected&&(Rf(this,zf,this.getRootNode()?.getElementById(n)),(o=(a=If(this,zf))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;let{style:n}=cc(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(Rf(this,zf,this.getRootNode()?.getElementById(r)),(t=(e=If(this,zf))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=If(this,zf))?.unassociateElement)==null||t.call(e,this),Rf(this,zf,null)}};zf=new WeakMap,Hf.shadowRootOptions={mode:`open`},Hf.getTemplateHTML=Bf,Hf.getSlotTemplateHTML=Vf,N.customElements.get(`media-text-display`)||N.customElements.define(`media-text-display`,Hf);var Uf=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Wf=(e,t,n)=>(Uf(e,t,`read from private field`),n?n.call(e):t.get(e)),Gf=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Kf=(e,t,n,r)=>(Uf(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),qf;function Jf(e,t){return`
    <slot>${Fs(t.mediaDuration)}</slot>
  `}var Yf=class extends Hf{constructor(){super(),Gf(this,qf,void 0),Kf(this,qf,this.shadowRoot.querySelector(`slot`)),Wf(this,qf).textContent=Fs(this.mediaDuration??0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_DURATION]}attributeChangedCallback(e,t,n){e===j.MEDIA_DURATION&&(Wf(this,qf).textContent=Fs(+n)),super.attributeChangedCallback(e,t,n)}get mediaDuration(){return P(this,j.MEDIA_DURATION)}set mediaDuration(e){F(this,j.MEDIA_DURATION,e)}};qf=new WeakMap,Yf.getSlotTemplateHTML=Jf,N.customElements.get(`media-duration-display`)||N.customElements.define(`media-duration-display`,Yf);var Xf={2:M(`Network Error`),3:M(`Decode Error`),4:M(`Source Not Supported`),5:M(`Encryption Error`)},Zf={2:M(`A network error caused the media download to fail.`),3:M(`A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.`),4:M(`An unsupported error occurred. The server or network failed, or your browser does not support this format.`),5:M(`The media is encrypted and there are no keys to decrypt it.`)},Qf=e=>e.code===1?null:{title:Xf[e.code]??`Error ${e.code}`,message:Zf[e.code]??e.message},$f=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},ep=(e,t,n)=>($f(e,t,`read from private field`),n?n.call(e):t.get(e)),tp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},np=(e,t,n,r)=>($f(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),rp;function ip(e){return`
    <style>
      :host {
  ...
  `}function ap(e){return e.code&&Qf(e)!==null}function op(e){let{title:t,message:n}=Qf(e)??{},r=``;return t&&(r+=`<slot name="error-${e.code}-title"><h3>${t}</h3></slot>`),n&&(r+=`<slot name="error-${e.code}-message"><p>${n}</p></slot>`),r}var sp=[j.MEDIA_ERROR_CODE,j.MEDIA_ERROR_MESSAGE],cp=class extends Jd{constructor(){super(...arguments),tp(this,rp,null)}static get observedAttributes(){return[...super.observedAttributes,...sp]}formatErrorMessage(e){return this.constructor.formatErrorMessage(e)}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),!sp.includes(e))return;let r=this.mediaError??{code:this.mediaErrorCode,message:this.mediaErrorMessage};if(this.open=ap(r),this.open&&(this.shadowRoot.querySelector(`slot`).name=`error-${this.mediaErrorCode}`,this.shadowRoot.querySelector(`#content`).innerHTML=this.formatErrorMessage(r),!this.hasAttribute(`aria-label`))){let{title:e}=Qf(r);e&&this.setAttribute(`aria-label`,e)}}get mediaError(){return ep(this,rp)}set mediaError(e){np(this,rp,e)}get mediaErrorCode(){return P(this,`mediaerrorcode`)}set mediaErrorCode(e){F(this,`mediaerrorcode`,e)}get mediaErrorMessage(){return R(this,`mediaerrormessage`)}set mediaErrorMessage(e){z(this,`mediaerrormessage`,e)}};rp=new WeakMap,cp.getSlotTemplateHTML=ip,cp.formatErrorMessage=op,N.customElements.get(`media-error-dialog`)||N.customElements.define(`media-error-dialog`,cp);var lp=cp,up=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},dp=(e,t,n)=>(up(e,t,`read from private field`),n?n.call(e):t.get(e)),fp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},pp,mp;function hp(e){return`
    <style>
      :host {
        position: fixed;
        top: 0;
  ...
  `}function gp(){return`
    ...
    `).join(``)}</table>
  `}var _p=class extends Jd{constructor(){super(...arguments),fp(this,pp,e=>{if(!this.open)return;let t=this.shadowRoot?.querySelector(`#content`);if(!t)return;let n=e.composedPath(),r=n[0]===this||n.includes(this),i=n.includes(t);r&&!i&&(this.open=!1)}),fp(this,mp,e=>{if(!this.open)return;let t=e.shiftKey&&(e.key===`/`||e.key===`?`);(e.key===`Escape`||t)&&!e.ctrlKey&&!e.altKey&&!e.metaKey&&(this.open=!1,e.preventDefault(),e.stopPropagation())})}connectedCallback(){super.connectedCallback(),this.open&&(this.addEventListener(`click`,dp(this,pp)),document.addEventListener(`keydown`,dp(this,mp)))}disconnectedCallback(){this.removeEventListener(`click`,dp(this,pp)),document.removeEventListener(`keydown`,dp(this,mp))}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===`open`&&(this.open?(this.addEventListener(`click`,dp(this,pp)),document.addEventListener(`keydown`,dp(this,mp))):(this.removeEventListener(`click`,dp(this,pp)),document.removeEventListener(`keydown`,dp(this,mp))))}};pp=new WeakMap,mp=new WeakMap,_p.getSlotTemplateHTML=hp,N.customElements.get(`media-keyboard-shortcuts-dialog`)||N.customElements.define(`media-keyboard-shortcuts-dialog`,_p);var vp=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},yp=(e,t,n)=>(vp(e,t,`read from private field`),n?n.call(e):t.get(e)),bp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},xp=(e,t,n,r)=>(vp(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Sp,Cp=`<svg aria-hidden="true" viewBox="0 0 26 24">
  ...
  `}var Dp=e=>{let t=e.mediaIsFullscreen?M(`exit fullscreen mode`):M(`enter fullscreen mode`);e.setAttribute(`aria-label`,t)},Op=class extends ad{constructor(){super(...arguments),bp(this,Sp,null)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_FULLSCREEN,j.MEDIA_FULLSCREEN_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),Dp(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_FULLSCREEN&&Dp(this)}get mediaFullscreenUnavailable(){return R(this,j.MEDIA_FULLSCREEN_UNAVAILABLE)}set mediaFullscreenUnavailable(e){z(this,j.MEDIA_FULLSCREEN_UNAVAILABLE,e)}get mediaIsFullscreen(){return I(this,j.MEDIA_IS_FULLSCREEN)}set mediaIsFullscreen(e){L(this,j.MEDIA_IS_FULLSCREEN,e)}handleClick(e){xp(this,Sp,e);let t=yp(this,Sp)instanceof PointerEvent,n=this.mediaIsFullscreen?new N.CustomEvent(k.MEDIA_EXIT_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0}):new N.CustomEvent(k.MEDIA_ENTER_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0,detail:t});this.dispatchEvent(n)}};Sp=new WeakMap,Op.getSlotTemplateHTML=Tp,Op.getTooltipContentHTML=Ep,N.customElements.get(`media-fullscreen-button`)||N.customElements.define(`media-fullscreen-button`,Op);var{MEDIA_TIME_IS_LIVE:kp,MEDIA_PAUSED:Ap}=j,{MEDIA_SEEK_TO_LIVE_REQUEST:jp,MEDIA_PLAY_REQUEST:Mp}=k,Np=`<svg viewBox="0 0 6 12" aria-hidden="true"><circle cx="3" cy="6" r="2"></circle></svg>`;function Pp(e){return`
    <style>
      ...
      :host([${kp}]:not([${Ap}])) slot[name=indicator] > *,
      :host([${kp}]:not([${Ap}])) ::slotted([slot=indicator]) {
    ...
    <slot name="indicator">${Np}</slot>
    
    <slot name="spacer">&nbsp;</slot><slot name="text">${M(`live`)}</slot>
  `}var Fp=e=>{let t=e.mediaPaused||!e.mediaTimeIsLive,n=M(t?`seek to live`:`playing live`);e.setAttribute(`aria-label`,n);let r=e.shadowRoot?.querySelector(`slot[name="text"]`);r&&(r.textContent=M(`live`)),t?e.removeAttribute(`aria-disabled`):e.setAttribute(`aria-disabled`,`true`)},Ip=class extends ad{static get observedAttributes(){return[...super.observedAttributes,kp,Ap]}connectedCallback(){super.connectedCallback(),Fp(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),Fp(this)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaTimeIsLive(){return I(this,j.MEDIA_TIME_IS_LIVE)}set mediaTimeIsLive(e){L(this,j.MEDIA_TIME_IS_LIVE,e)}handleClick(){!this.mediaPaused&&this.mediaTimeIsLive||(this.dispatchEvent(new N.CustomEvent(jp,{composed:!0,bubbles:!0})),this.hasAttribute(Ap)&&this.dispatchEvent(new N.CustomEvent(Mp,{composed:!0,bubbles:!0})))}};Ip.getSlotTemplateHTML=Pp,N.customElements.get(`media-live-button`)||N.customElements.define(`media-live-button`,Ip);var Lp=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Rp=(e,t,n)=>(Lp(e,t,`read from private field`),n?n.call(e):t.get(e)),zp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Bp=(e,t,n,r)=>(Lp(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Vp,Hp,Up={LOADING_DELAY:`loadingdelay`,NO_AUTOHIDE:`noautohide`},Wp=500,Gp=`
...
`;function Kp(e){return`
    <style>
      :host {
        ...
        vertical-align: middle;
        box-sizing: border-box;
        --_loading-indicator-delay: var(--media-loading-indicator-transition-delay, ${Wp}ms);
      }
  ...
  `}var qp=class extends N.HTMLElement{constructor(){if(super(),zp(this,Vp,void 0),zp(this,Hp,Wp),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER,j.MEDIA_PAUSED,j.MEDIA_LOADING,Up.LOADING_DELAY]}attributeChangedCallback(e,t,n){var r,i,a,o;e===Up.LOADING_DELAY&&t!==n?this.loadingDelay=Number(n):e===A.MEDIA_CONTROLLER&&(t&&((i=(r=Rp(this,Vp))?.unassociateElement)==null||i.call(r,this),Bp(this,Vp,null)),n&&this.isConnected&&(Bp(this,Vp,this.getRootNode()?.getElementById(n)),(o=(a=Rp(this,Vp))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;let n=this.getAttribute(A.MEDIA_CONTROLLER);n&&(Bp(this,Vp,this.getRootNode()?.getElementById(n)),(t=(e=Rp(this,Vp))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=Rp(this,Vp))?.unassociateElement)==null||t.call(e,this),Bp(this,Vp,null)}get loadingDelay(){return Rp(this,Hp)}set loadingDelay(e){Bp(this,Hp,e);let{style:t}=cc(this.shadowRoot,`:host`);t.setProperty(`--_loading-indicator-delay`,`var(--media-loading-indicator-transition-delay, ${e}ms)`)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaLoading(){return I(this,j.MEDIA_LOADING)}set mediaLoading(e){L(this,j.MEDIA_LOADING,e)}get mediaController(){return R(this,A.MEDIA_CONTROLLER)}set mediaController(e){z(this,A.MEDIA_CONTROLLER,e)}get noAutohide(){return I(this,Up.NO_AUTOHIDE)}set noAutohide(e){L(this,Up.NO_AUTOHIDE,e)}};Vp=new WeakMap,Hp=new WeakMap,qp.shadowRootOptions={mode:`open`},qp.getTemplateHTML=Kp,N.customElements.get(`media-loading-indicator`)||N.customElements.define(`media-loading-indicator`,qp);var Jp=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}var $p=e=>{let t=e.mediaVolumeLevel===`off`?M(`unmute`):M(`mute`);e.setAttribute(`aria-label`,t)},em=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_VOLUME_LEVEL]}connectedCallback(){super.connectedCallback(),$p(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_VOLUME_LEVEL&&$p(this)}get mediaVolumeLevel(){return R(this,j.MEDIA_VOLUME_LEVEL)}set mediaVolumeLevel(e){z(this,j.MEDIA_VOLUME_LEVEL,e)}handleClick(){let e=this.mediaVolumeLevel===`off`?k.MEDIA_UNMUTE_REQUEST:k.MEDIA_MUTE_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};em.getSlotTemplateHTML=Zp,em.getTooltipContentHTML=Qp,N.customElements.get(`media-mute-button`)||N.customElements.define(`media-mute-button`,em);var tm=`<svg aria-hidden="true" viewBox="0 0 28 24">
  <path d="M24 3H4a1 1 0 0 0-1 1v16a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1Zm-1 16H5V5h18v14Zm-3-8h-7v5h7v-5Z"/>
</svg>`;function nm(e){return`
    <style>
  ...
  `}var im=e=>{let t=e.mediaIsPip?M(`exit picture in picture mode`):M(`enter picture in picture mode`);e.setAttribute(`aria-label`,t)},am=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_PIP,j.MEDIA_PIP_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),im(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_PIP&&im(this)}get mediaPipUnavailable(){return R(this,j.MEDIA_PIP_UNAVAILABLE)}set mediaPipUnavailable(e){z(this,j.MEDIA_PIP_UNAVAILABLE,e)}get mediaIsPip(){return I(this,j.MEDIA_IS_PIP)}set mediaIsPip(e){L(this,j.MEDIA_IS_PIP,e)}handleClick(){let e=this.mediaIsPip?k.MEDIA_EXIT_PIP_REQUEST:k.MEDIA_ENTER_PIP_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};am.getSlotTemplateHTML=nm,am.getTooltipContentHTML=rm,N.customElements.get(`media-pip-button`)||N.customElements.define(`media-pip-button`,am);var om=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},sm=(e,t,n)=>(om(e,t,`read from private field`),n?n.call(e):t.get(e)),cm=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},lm,um={RATES:`rates`},dm=[1,1.2,1.5,1.7,2];function fm(e){return Math.round(e*100)/100}function pm(e){return`
    <style>
      :host {
        min-width: 5ch;
    ...
    <slot name="icon">${e.mediaplaybackrate?fm(+e.mediaplaybackrate):1}x</slot>
  `}function mm(){return M(`Playback rate`)}var hm=class extends ad{constructor(){super(),cm(this,lm,new ll(this,um.RATES,{defaultValue:dm})),this.container=this.shadowRoot.querySelector(`slot[name="icon"]`),this.container.innerHTML=`${fm(this.mediaPlaybackRate??1)}x`}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE,um.RATES]}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===um.RATES&&(sm(this,lm).value=n),e===j.MEDIA_PLAYBACK_RATE){let e=n?+n:NaN,t=fm(Number.isNaN(e)?1:e);this.container.innerHTML=`${t}x`,this.setAttribute(`aria-label`,M(`Playback rate {playbackRate}`,{playbackRate:t}))}}get rates(){return sm(this,lm)}set rates(e){e?Array.isArray(e)?sm(this,lm).value=e.join(` `):typeof e==`string`&&(sm(this,lm).value=e):sm(this,lm).value=``}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}handleClick(){let e=Array.from(sm(this,lm).values(),e=>+e).sort((e,t)=>e-t),t=e.find(e=>e>this.mediaPlaybackRate)??e[0]??1,n=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:t});this.dispatchEvent(n)}};lm=new WeakMap,hm.getSlotTemplateHTML=pm,hm.getTooltipContentHTML=mm,N.customElements.get(`media-playback-rate-button`)||N.customElements.define(`media-playback-rate-button`,hm);var gm=`<svg aria-hidden="true" viewBox="0 0 24 24">
  <path d="m6 21 15-9L6 3v18Z"/>
</svg>`,_m=`<svg aria-hidden="true" viewBox="0 0 24 24">
  <path d="M6 20h4V4H6v16Zm8-16v16h4V4h-4Z"/>
</svg>`;function vm(e){return`
    <style>
    ...
    <slot name="icon">
      ...
      <slot name="pause">${_m}</slot>
    </slot>
  `}function ym(){return`
    <slot name="tooltip-play">${M(`Play`)}</slot>
    <slot name="tooltip-pause">${M(`Pause`)}</slot>
  `}var bm=e=>{let t=e.mediaPaused?M(`play`):M(`pause`);e.setAttribute(`aria-label`,t)},xm=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PAUSED,j.MEDIA_ENDED]}connectedCallback(){super.connectedCallback(),bm(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),(e===j.MEDIA_PAUSED||e===j.MEDIA_LANG)&&bm(this)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}handleClick(){let e=this.mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};xm.getSlotTemplateHTML=vm,xm.getTooltipContentHTML=ym,N.customElements.get(`media-play-button`)||N.customElements.define(`media-play-button`,xm);var Sm={PLACEHOLDER_SRC:`placeholdersrc`,SRC:`src`};function Cm(e){return`
    <style>
      :host {
        pointer-events: none;
  ...
  `}var wm=e=>{e.style.removeProperty(`background-image`)},Tm=(e,t)=>{e.style[`background-image`]=`url('${t}')`},Em=class extends N.HTMLElement{static get observedAttributes(){return[Sm.PLACEHOLDER_SRC,Sm.SRC]}constructor(){if(super(),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.image=this.shadowRoot.querySelector(`#image`)}attributeChangedCallback(e,t,n){e===Sm.SRC&&(n==null?this.image.removeAttribute(Sm.SRC):this.image.setAttribute(Sm.SRC,n)),e===Sm.PLACEHOLDER_SRC&&(n==null?wm(this.image):Tm(this.image,n))}get placeholderSrc(){return R(this,Sm.PLACEHOLDER_SRC)}set placeholderSrc(e){z(this,Sm.SRC,e)}get src(){return R(this,Sm.SRC)}set src(e){z(this,Sm.SRC,e)}};Em.shadowRootOptions={mode:`open`},Em.getTemplateHTML=Cm,N.customElements.get(`media-poster-image`)||N.customElements.define(`media-poster-image`,Em);var Dm=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Om=(e,t,n)=>(Dm(e,t,`read from private field`),n?n.call(e):t.get(e)),km=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Am=(e,t,n,r)=>(Dm(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),jm,Mm=class extends Hf{constructor(){super(),km(this,jm,void 0),Am(this,jm,this.shadowRoot.querySelector(`slot`))}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PREVIEW_CHAPTER,j.MEDIA_LANG]}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),(e===j.MEDIA_PREVIEW_CHAPTER||e===j.MEDIA_LANG)&&n!==t&&n!=null)if(Om(this,jm).textContent=n,n!==``){let e=M(`chapter: {chapterName}`,{chapterName:n});this.setAttribute(`aria-valuetext`,e)}else this.removeAttribute(`aria-valuetext`)}get mediaPreviewChapter(){return R(this,j.MEDIA_PREVIEW_CHAPTER)}set mediaPreviewChapter(e){z(this,j.MEDIA_PREVIEW_CHAPTER,e)}};jm=new WeakMap,N.customElements.get(`media-preview-chapter-display`)||N.customElements.define(`media-preview-chapter-display`,Mm);var Nm=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Pm=(e,t,n)=>(Nm(e,t,`read from private field`),n?n.call(e):t.get(e)),Fm=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Im=(e,t,n,r)=>(Nm(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Lm;function Rm(e){return`
    <style>
      :host {
        box-sizing: border-box;
  ...
  `}var zm=class extends N.HTMLElement{constructor(){if(super(),Fm(this,Lm,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER,j.MEDIA_PREVIEW_IMAGE,j.MEDIA_PREVIEW_COORDS]}connectedCallback(){var e,t;let n=this.getAttribute(A.MEDIA_CONTROLLER);n&&(Im(this,Lm,this.getRootNode()?.getElementById(n)),(t=(e=Pm(this,Lm))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=Pm(this,Lm))?.unassociateElement)==null||t.call(e,this),Im(this,Lm,null)}attributeChangedCallback(e,t,n){var r,i,a,o;[j.MEDIA_PREVIEW_IMAGE,j.MEDIA_PREVIEW_COORDS].includes(e)&&this.update(),e===A.MEDIA_CONTROLLER&&(t&&((i=(r=Pm(this,Lm))?.unassociateElement)==null||i.call(r,this),Im(this,Lm,null)),n&&this.isConnected&&(Im(this,Lm,this.getRootNode()?.getElementById(n)),(o=(a=Pm(this,Lm))?.associateElement)==null||o.call(a,this)))}get mediaPreviewImage(){return R(this,j.MEDIA_PREVIEW_IMAGE)}set mediaPreviewImage(e){z(this,j.MEDIA_PREVIEW_IMAGE,e)}get mediaPreviewCoords(){let e=this.getAttribute(j.MEDIA_PREVIEW_COORDS);if(e)return e.split(/\s+/).map(e=>+e)}set mediaPreviewCoords(e){if(!e){this.removeAttribute(j.MEDIA_PREVIEW_COORDS);return}this.setAttribute(j.MEDIA_PREVIEW_COORDS,e.join(` `))}update(){let e=this.mediaPreviewCoords,t=this.mediaPreviewImage;if(!(e&&t))return;let[n,r,i,a]=e,o=t.split(`#`)[0],s=getComputedStyle(this),{maxWidth:c,maxHeight:l,minWidth:u,minHeight:d}=s,f=s.getPropertyValue(`--media-preview-thumbnail-object-fit`).trim()||`contain`,p,m;if(f===`fill`){let e=parseInt(c)/i,t=parseInt(l)/a,n=parseInt(u)/i,r=parseInt(d)/a;p=e<1?e:Math.max(e,n),m=t<1?t:Math.max(t,r)}else{let e=Math.min(parseInt(c)/i,parseInt(l)/a),t=Math.max(parseInt(u)/i,parseInt(d)/a),n=e<1?e:t>1?t:1;p=n,m=n}let{style:h}=cc(this.shadowRoot,`:host`),g=cc(this.shadowRoot,`img`).style,_=this.shadowRoot.querySelector(`img`),ee=Math.min(p,m)<1?`min`:`max`;h.setProperty(`${ee}-width`,`initial`,`important`),h.setProperty(`${ee}-height`,`initial`,`important`),h.width=`${i*p}px`,h.height=`${a*m}px`;let te=()=>{g.width=`${this.imgWidth*p}px`,g.height=`${this.imgHeight*m}px`,g.display=`block`};_.src!==o&&(_.onload=()=>{this.imgWidth=_.naturalWidth,this.imgHeight=_.naturalHeight,te(),_.onload=null},_.src=o,te()),te(),g.transform=`translate(-${n*p}px, -${r*m}px)`}};Lm=new WeakMap,zm.shadowRootOptions={mode:`open`},zm.getTemplateHTML=Rm,N.customElements.get(`media-preview-thumbnail`)||N.customElements.define(`media-preview-thumbnail`,zm);var Bm=zm,Vm=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Hm=(e,t,n)=>(Vm(e,t,`read from private field`),n?n.call(e):t.get(e)),Um=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Wm=(e,t,n,r)=>(Vm(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Gm,Km=class extends Hf{constructor(){super(),Um(this,Gm,void 0),Wm(this,Gm,this.shadowRoot.querySelector(`slot`)),Hm(this,Gm).textContent=Fs(0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PREVIEW_TIME]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_PREVIEW_TIME&&n!=null&&(Hm(this,Gm).textContent=Fs(parseFloat(n)))}get mediaPreviewTime(){return P(this,j.MEDIA_PREVIEW_TIME)}set mediaPreviewTime(e){F(this,j.MEDIA_PREVIEW_TIME,e)}};Gm=new WeakMap,N.customElements.get(`media-preview-time-display`)||N.customElements.define(`media-preview-time-display`,Km);var qm={SEEK_OFFSET:`seekoffset`},Jm=30,Ym=e=>`
  ...
  `}var Zm=(e,t)=>{e.setAttribute(`aria-label`,M(`seek back {seekOffset} seconds`,{seekOffset:t}))};function Qm(){return M(`Seek backward`)}var $m=0,eh=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_CURRENT_TIME,qm.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=P(this,qm.SEEK_OFFSET,Jm)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),Zm(this,this.seekOffset),e===qm.SEEK_OFFSET&&(this.seekOffset=P(this,qm.SEEK_OFFSET,Jm))}get seekOffset(){return P(this,qm.SEEK_OFFSET,Jm)}set seekOffset(e){F(this,qm.SEEK_OFFSET,e),this.setAttribute(`aria-label`,M(`seek back {seekOffset} seconds`,{seekOffset:this.seekOffset})),$s(tc(this,`icon`),this.seekOffset)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME,$m)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}handleClick(){let e=Math.max(this.mediaCurrentTime-this.seekOffset,0),t=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};eh.getSlotTemplateHTML=Xm,eh.getTooltipContentHTML=Qm,N.customElements.get(`media-seek-backward-button`)||N.customElements.define(`media-seek-backward-button`,eh);var th={SEEK_OFFSET:`seekoffset`},nh=30,rh=e=>`
  <svg aria-hidden="true" viewBox="0 0 20 24">
    <defs>
      <style>.text{font-size:8px;font-family:Arial-BoldMT, Arial;font-weight:700;}</style>
    </defs>
  ...
  </svg>`;function ih(e,t){return`
    <slot name="icon">${rh(t.seekOffset)}</slot>
  `}var ah=(e,t)=>{e.setAttribute(`aria-label`,M(`seek forward {seekOffset} seconds`,{seekOffset:t}))};function oh(){return M(`Seek forward`)}var sh=0,ch=class extends ad{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_CURRENT_TIME,th.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=P(this,th.SEEK_OFFSET,nh)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),ah(this,this.seekOffset),e===th.SEEK_OFFSET&&(this.seekOffset=P(this,th.SEEK_OFFSET,nh))}get seekOffset(){return P(this,th.SEEK_OFFSET,nh)}set seekOffset(e){F(this,th.SEEK_OFFSET,e),this.setAttribute(`aria-label`,M(`seek forward {seekOffset} seconds`,{seekOffset:this.seekOffset})),$s(tc(this,`icon`),this.seekOffset)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME,sh)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}handleClick(){let e=this.mediaCurrentTime+this.seekOffset,t=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};ch.getSlotTemplateHTML=ih,ch.getTooltipContentHTML=oh,N.customElements.get(`media-seek-forward-button`)||N.customElements.define(`media-seek-forward-button`,ch);var lh=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},uh=(e,t,n)=>(lh(e,t,`read from private field`),n?n.call(e):t.get(e)),dh=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},fh=(e,t,n,r)=>(lh(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),ph=(e,t,n)=>(lh(e,t,`access private method`),n),mh,hh,gh,_h,vh,yh,bh,xh,Sh,Ch,wh,Th={REMAINING:`remaining`,SHOW_DURATION:`showduration`,NO_TOGGLE:`notoggle`},Eh=[...Object.values(Th),j.MEDIA_CURRENT_TIME,j.MEDIA_DURATION,j.MEDIA_SEEKABLE],Dh=[`Enter`,` `],Oh=`&nbsp;/&nbsp;`,kh=(e,{timesSep:t=Oh}={})=>{let n=e.mediaCurrentTime??0,[,r]=e.mediaSeekable??[],i=0;Number.isFinite(e.mediaDuration)?i=e.mediaDuration:Number.isFinite(r)&&(i=r);let a=e.remaining?Fs(0-(i-n)):Fs(n);return e.showDuration?`${a}${t}${Fs(i)}`:a},Ah=e=>{let t=e.mediaCurrentTime,[,n]=e.mediaSeekable??[],r=null;if(Number.isFinite(e.mediaDuration)?r=e.mediaDuration:Number.isFinite(n)&&(r=n),t==null||r===null){e.setAttribute(`aria-description`,M(`video not loaded, unknown time.`));return}let i=e.remaining?Ps(0-(r-t)):Ps(t);if(!e.showDuration){e.setAttribute(`aria-description`,i);return}let a=M(`{currentTime} of {totalTime}`,{currentTime:i,totalTime:Ps(r)});e.setAttribute(`aria-description`,a)};function jh(e,t){return`
    <slot>${kh(t)}</slot>
  `}var Mh=e=>{e.setAttribute(`aria-label`,M(`playback time`))},Nh=class extends Hf{constructor(){super(),dh(this,_h),dh(this,yh),dh(this,xh),dh(this,Ch),dh(this,mh,void 0),dh(this,hh,null),dh(this,gh,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!Dh.includes(r)){this.removeEventListener(`keyup`,uh(this,hh));return}this.addEventListener(`keyup`,uh(this,hh))}),fh(this,mh,this.shadowRoot.querySelector(`slot`)),uh(this,mh).innerHTML=`${kh(this)}`}static get observedAttributes(){return[...super.observedAttributes,...Eh,`disabled`]}connectedCallback(){let{style:e}=cc(this.shadowRoot,`:host(:hover:not([notoggle]))`);e.setProperty(`cursor`,`var(--media-cursor, pointer)`),e.setProperty(`background`,`var(--media-control-hover-background, rgba(50 50 70 / .7))`),this.setAttribute(`aria-label`,M(`playback time`)),ph(this,xh,Sh).call(this),super.connectedCallback()}toggleTimeDisplay(){this.noToggle||(this.hasAttribute(`remaining`)?this.removeAttribute(`remaining`):this.setAttribute(`remaining`,``))}disconnectedCallback(){this.disable(),ph(this,yh,bh).call(this),super.disconnectedCallback()}attributeChangedCallback(e,t,n){Mh(this),Eh.includes(e)?this.update():e===`disabled`&&n!==t?n==null?ph(this,xh,Sh).call(this):ph(this,Ch,wh).call(this):e===Th.NO_TOGGLE&&n!==t&&(this.noToggle?ph(this,Ch,wh).call(this):ph(this,xh,Sh).call(this)),super.attributeChangedCallback(e,t,n)}enable(){this.noToggle||(this.tabIndex=0)}disable(){this.tabIndex=-1}get remaining(){return I(this,Th.REMAINING)}set remaining(e){L(this,Th.REMAINING,e)}get showDuration(){return I(this,Th.SHOW_DURATION)}set showDuration(e){L(this,Th.SHOW_DURATION,e)}get noToggle(){return I(this,Th.NO_TOGGLE)}set noToggle(e){L(this,Th.NO_TOGGLE,e)}get mediaDuration(){return P(this,j.MEDIA_DURATION)}set mediaDuration(e){F(this,j.MEDIA_DURATION,e)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}get mediaSeekable(){let e=this.getAttribute(j.MEDIA_SEEKABLE);if(e)return e.split(`:`).map(e=>+e)}set mediaSeekable(e){if(e==null){this.removeAttribute(j.MEDIA_SEEKABLE);return}this.setAttribute(j.MEDIA_SEEKABLE,e.join(`:`))}update(){let e=kh(this);Ah(this),e!==uh(this,mh).innerHTML&&(uh(this,mh).innerHTML=e)}};mh=new WeakMap,hh=new WeakMap,gh=new WeakMap,_h=new WeakSet,vh=function(){uh(this,hh)||(fh(this,hh,e=>{let{key:t}=e;if(!Dh.includes(t)){this.removeEventListener(`keyup`,uh(this,hh));return}this.toggleTimeDisplay()}),this.addEventListener(`keydown`,uh(this,gh)),this.addEventListener(`click`,this.toggleTimeDisplay))},yh=new WeakSet,bh=function(){uh(this,hh)&&(this.removeEventListener(`keyup`,uh(this,hh)),this.removeEventListener(`keydown`,uh(this,gh)),this.removeEventListener(`click`,this.toggleTimeDisplay),fh(this,hh,null))},xh=new WeakSet,Sh=function(){!this.noToggle&&!this.hasAttribute(`disabled`)&&(this.setAttribute(`role`,`button`),this.enable(),ph(this,_h,vh).call(this))},Ch=new WeakSet,wh=function(){this.removeAttribute(`role`),this.disable(),ph(this,yh,bh).call(this)},Nh.getSlotTemplateHTML=jh,N.customElements.get(`media-time-display`)||N.customElements.define(`media-time-display`,Nh);var Ph=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Fh=(e,t,n)=>(Ph(e,t,`read from private field`),n?n.call(e):t.get(e)),Ih=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Lh=(e,t,n,r)=>(Ph(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Rh=(e,t,n,r)=>({set _(r){Lh(e,t,r,n)},get _(){return Fh(e,t,r)}}),zh,Bh,Vh,Hh,Uh,Wh,Gh,Kh,qh,Jh,Yh=class{constructor(e,t,n){Ih(this,zh,void 0),Ih(this,Bh,void 0),Ih(this,Vh,void 0),Ih(this,Hh,void 0),Ih(this,Uh,void 0),Ih(this,Wh,void 0),Ih(this,Gh,void 0),Ih(this,Kh,void 0),Ih(this,qh,0),Ih(this,Jh,(e=performance.now())=>{Lh(this,qh,requestAnimationFrame(Fh(this,Jh))),Lh(this,Hh,performance.now()-Fh(this,Vh));let t=1e3/this.fps;if(Fh(this,Hh)>t){Lh(this,Vh,e-Fh(this,Hh)%t);let n=1e3/((e-Fh(this,Bh))/++Rh(this,Uh)._),r=(e-Fh(this,Wh))/1e3/this.duration,i=Fh(this,Gh)+r*this.playbackRate;i-Fh(this,zh).valueAsNumber>0?Lh(this,Kh,this.playbackRate/this.duration/n):(Lh(this,Kh,.995*Fh(this,Kh)),i=Fh(this,zh).valueAsNumber+Fh(this,Kh)),this.callback(i)}}),Lh(this,zh,e),this.callback=t,this.fps=n}start(){Fh(this,qh)===0&&(Lh(this,Vh,performance.now()),Lh(this,Bh,Fh(this,Vh)),Lh(this,Uh,0),Fh(this,Jh).call(this))}stop(){Fh(this,qh)!==0&&(cancelAnimationFrame(Fh(this,qh)),Lh(this,qh,0))}update({start:e,duration:t,playbackRate:n}){let r=e-Fh(this,zh).valueAsNumber,i=Math.abs(t-this.duration);(r>0||r<-.03||i>=.5)&&this.callback(e),Lh(this,Gh,e),Lh(this,Wh,performance.now()),this.duration=t,this.playbackRate=n}};zh=new WeakMap,Bh=new WeakMap,Vh=new WeakMap,Hh=new WeakMap,Uh=new WeakMap,Wh=new WeakMap,Gh=new WeakMap,Kh=new WeakMap,qh=new WeakMap,Jh=new WeakMap;var Xh=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},G=(e,t,n)=>(Xh(e,t,`read from private field`),n?n.call(e):t.get(e)),Zh=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Qh=(e,t,n,r)=>(Xh(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),$h=(e,t,n)=>(Xh(e,t,`access private method`),n),eg,tg,ng,rg,ig,ag,og,sg,cg,lg,ug,dg,fg,pg,mg,hg,gg,_g,vg,yg,bg,xg,Sg,Cg,wg,Tg,Eg=e=>{let t=e.range,n=Ps(+kg(e)),r=Ps(+e.mediaSeekableEnd),i=n&&r?M(`{currentTime} of {totalTime}`,{currentTime:n,totalTime:r}):M(`video not loaded, unknown time.`);t.setAttribute(`aria-valuetext`,i)};function Dg(e){return`
    <style>
      :host {
    ...
    <div id="preview-rail">
      <slot name="preview" part="box preview-box">
        <media-preview-thumbnail>
          <template shadowrootmode="${Bm.shadowRootOptions.mode}">
            ${Bm.getTemplateHTML({})}
          </template>
        </media-preview-thumbnail>
  ...
  `}var Og=(e,t=e.mediaCurrentTime)=>{let n=Number.isFinite(e.mediaSeekableStart)?e.mediaSeekableStart:0,r=Number.isFinite(e.mediaDuration)?e.mediaDuration:e.mediaSeekableEnd;if(Number.isNaN(r))return 0;let i=(t-n)/(r-n);return Math.max(0,Math.min(i,1))},kg=(e,t=e.range.valueAsNumber)=>{let n=Number.isFinite(e.mediaSeekableStart)?e.mediaSeekableStart:0,r=Number.isFinite(e.mediaDuration)?e.mediaDuration:e.mediaSeekableEnd;return Number.isNaN(r)?0:t*(r-n)+n},Ag=class extends Df{constructor(){super(),Zh(this,dg),Zh(this,mg),Zh(this,gg),Zh(this,vg),Zh(this,bg),Zh(this,Sg),Zh(this,wg),Zh(this,eg,null),Zh(this,tg,void 0),Zh(this,ng,void 0),Zh(this,rg,void 0),Zh(this,ig,void 0),Zh(this,ag,void 0),Zh(this,og,void 0),Zh(this,sg,void 0),Zh(this,cg,void 0),Zh(this,lg,void 0),Zh(this,ug,()=>{$h(this,dg,fg).call(this)?G(this,tg).start():G(this,tg).stop()}),Zh(this,pg,e=>{this.dragging||(ws(e)&&(this.range.valueAsNumber=e),G(this,lg)||this.updateBar())}),this.shadowRoot.querySelector(`#track`).insertAdjacentHTML(`afterbegin`,`<div id="buffered" part="buffered"></div>`),Qh(this,ng,this.shadowRoot.querySelectorAll(`[part~="box"]`)),Qh(this,ig,this.shadowRoot.querySelector(`[part~="preview-box"]`)),Qh(this,ag,this.shadowRoot.querySelector(`[part~="current-box"]`));let e=getComputedStyle(this);Qh(this,og,parseInt(e.getPropertyValue(`--media-box-padding-left`))),Qh(this,sg,parseInt(e.getPropertyValue(`--media-box-padding-right`))),Qh(this,tg,new Yh(this.range,G(this,pg),60))}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PAUSED,j.MEDIA_DURATION,j.MEDIA_SEEKABLE,j.MEDIA_CURRENT_TIME,j.MEDIA_PREVIEW_IMAGE,j.MEDIA_PREVIEW_TIME,j.MEDIA_PREVIEW_CHAPTER,j.MEDIA_BUFFERED,j.MEDIA_PLAYBACK_RATE,j.MEDIA_LOADING,j.MEDIA_ENDED]}connectedCallback(){var e;super.connectedCallback(),this.range.setAttribute(`aria-label`,M(`seek`)),G(this,ug).call(this),Qh(this,eg,this.getRootNode()),(e=G(this,eg))==null||e.addEventListener(`transitionstart`,this)}disconnectedCallback(){var e;super.disconnectedCallback(),G(this,tg).stop(),(e=G(this,eg))==null||e.removeEventListener(`transitionstart`,this),Qh(this,eg,null)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),t!=n&&(e===j.MEDIA_CURRENT_TIME||e===j.MEDIA_PAUSED||e===j.MEDIA_ENDED||e===j.MEDIA_LOADING||e===j.MEDIA_DURATION||e===j.MEDIA_SEEKABLE?(G(this,tg).update({start:Og(this),duration:this.mediaSeekableEnd-this.mediaSeekableStart,playbackRate:this.mediaPlaybackRate}),G(this,ug).call(this),Eg(this)):e===j.MEDIA_BUFFERED&&this.updateBufferedBar(),(e===j.MEDIA_DURATION||e===j.MEDIA_SEEKABLE)&&(this.mediaChaptersCues=G(this,cg),this.updateBar()))}get mediaChaptersCues(){return G(this,cg)}set mediaChaptersCues(e){Qh(this,cg,e),this.updateSegments(G(this,cg)?.map(e=>({start:Og(this,e.startTime),end:Og(this,e.endTime)})))}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaLoading(){return I(this,j.MEDIA_LOADING)}set mediaLoading(e){L(this,j.MEDIA_LOADING,e)}get mediaDuration(){return P(this,j.MEDIA_DURATION)}set mediaDuration(e){F(this,j.MEDIA_DURATION,e)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}get mediaBuffered(){let e=this.getAttribute(j.MEDIA_BUFFERED);return e?e.split(` `).map(e=>e.split(`:`).map(e=>+e)):[]}set mediaBuffered(e){if(!e){this.removeAttribute(j.MEDIA_BUFFERED);return}let t=e.map(e=>e.join(`:`)).join(` `);this.setAttribute(j.MEDIA_BUFFERED,t)}get mediaSeekable(){let e=this.getAttribute(j.MEDIA_SEEKABLE);if(e)return e.split(`:`).map(e=>+e)}set mediaSeekable(e){if(e==null){this.removeAttribute(j.MEDIA_SEEKABLE);return}this.setAttribute(j.MEDIA_SEEKABLE,e.join(`:`))}get mediaSeekableEnd(){let[,e=this.mediaDuration]=this.mediaSeekable??[];return e}get mediaSeekableStart(){let[e=0]=this.mediaSeekable??[];return e}get mediaPreviewImage(){return R(this,j.MEDIA_PREVIEW_IMAGE)}set mediaPreviewImage(e){z(this,j.MEDIA_PREVIEW_IMAGE,e)}get mediaPreviewTime(){return P(this,j.MEDIA_PREVIEW_TIME)}set mediaPreviewTime(e){F(this,j.MEDIA_PREVIEW_TIME,e)}get mediaEnded(){return I(this,j.MEDIA_ENDED)}set mediaEnded(e){L(this,j.MEDIA_ENDED,e)}updateBar(){super.updateBar(),this.updateBufferedBar(),this.updateCurrentBox()}updateBufferedBar(){let e=this.mediaBuffered;if(!e.length)return;let t;if(this.mediaEnded)t=1;else{let n=this.mediaCurrentTime,[,r=this.mediaSeekableStart]=e.find(([e,t])=>e<=n&&n<=t)??[];t=Og(this,r)}let{style:n}=cc(this.shadowRoot,`#buffered`);n.setProperty(`width`,`${t*100}%`)}updateCurrentBox(){if(!this.shadowRoot.querySelector(`slot[name="current"]`).assignedElements().length)return;let e=cc(this.shadowRoot,`#current-rail`),t=cc(this.shadowRoot,`[part~="current-box"]`),n=$h(this,mg,hg).call(this,G(this,ag)),r=$h(this,gg,_g).call(this,n,this.range.valueAsNumber),i=$h(this,vg,yg).call(this,n,this.range.valueAsNumber);e.style.transform=`translateX(${r})`,e.style.setProperty(`--_range-width`,`${n.range.width}`),t.style.setProperty(`--_box-shift`,`${i}`),t.style.setProperty(`--_box-width`,`${n.box.width}px`),t.style.setProperty(`visibility`,`initial`)}handleEvent(e){switch(super.handleEvent(e),e.type){case`input`:$h(this,wg,Tg).call(this);break;case`pointermove`:$h(this,bg,xg).call(this,e);break;case`pointerup`:G(this,lg)&&Qh(this,lg,!1);break;case`pointerdown`:Qh(this,lg,!0);break;case`pointerleave`:$h(this,Sg,Cg).call(this,null);break;case`transitionstart`:nc(e.target,this)&&setTimeout(()=>G(this,ug).call(this),0);break}}};eg=new WeakMap,tg=new WeakMap,ng=new WeakMap,rg=new WeakMap,ig=new WeakMap,ag=new WeakMap,og=new WeakMap,sg=new WeakMap,cg=new WeakMap,lg=new WeakMap,ug=new WeakMap,dg=new WeakSet,fg=function(){return this.isConnected&&!this.mediaPaused&&!this.mediaLoading&&!this.mediaEnded&&this.mediaSeekableEnd>0&&oc(this)},pg=new WeakMap,mg=new WeakSet,hg=function(e){let t=((this.getAttribute(`bounds`)?rc(this,`#${this.getAttribute(`bounds`)}`):this.parentElement)??this).getBoundingClientRect(),n=this.range.getBoundingClientRect(),r=e.offsetWidth;return{box:{width:r,min:-(n.left-t.left-r/2),max:t.right-n.left-r/2},bounds:t,range:n}},gg=new WeakSet,_g=function(e,t){let n=`${t*100}%`,{width:r,min:i,max:a}=e.box;if(!r)return n;if(Number.isNaN(i)||(n=`max(${`calc(1 / var(--_range-width) * 100 * ${i}% + var(--media-box-padding-left))`}, ${n})`),!Number.isNaN(a)){let e=`calc(1 / var(--_range-width) * 100 * ${a}% - var(--media-box-padding-right))`;n=`min(${n}, ${e})`}return n},vg=new WeakSet,yg=function(e,t){let{width:n,min:r,max:i}=e.box,a=t*e.range.width;if(a<r+G(this,og)){let t=e.range.left-e.bounds.left-G(this,og);return`${a-n/2+t}px`}if(a>i-G(this,sg)){let t=e.bounds.right-e.range.right-G(this,sg);return`${a+n/2-t-e.range.width}px`}return 0},bg=new WeakSet,xg=function(e){let t=[...G(this,ng)].some(t=>e.composedPath().includes(t));if(!this.dragging&&(t||!e.composedPath().includes(this))){$h(this,Sg,Cg).call(this,null);return}let n=this.mediaSeekableEnd;if(!n)return;let r=cc(this.shadowRoot,`#preview-rail`),i=cc(this.shadowRoot,`[part~="preview-box"]`),a=$h(this,mg,hg).call(this,G(this,ig)),o=(e.clientX-a.range.left)/a.range.width;o=Math.max(0,Math.min(1,o));let s=$h(this,gg,_g).call(this,a,o),c=$h(this,vg,yg).call(this,a,o);r.style.transform=`translateX(${s})`,r.style.setProperty(`--_range-width`,`${a.range.width}`),i.style.setProperty(`--_box-shift`,`${c}`),i.style.setProperty(`--_box-width`,`${a.box.width}px`);let l=Math.round(G(this,rg))-Math.round(o*n);Math.abs(l)<1&&o>.01&&o<.99||(Qh(this,rg,o*n),$h(this,Sg,Cg).call(this,G(this,rg)))},Sg=new WeakSet,Cg=function(e){this.dispatchEvent(new N.CustomEvent(k.MEDIA_PREVIEW_REQUEST,{composed:!0,bubbles:!0,detail:e}))},wg=new WeakSet,Tg=function(){G(this,tg).stop();let e=kg(this);this.dispatchEvent(new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e}))},Ag.shadowRootOptions={mode:`open`},Ag.getContainerTemplateHTML=Dg,N.customElements.get(`media-time-range`)||N.customElements.define(`media-time-range`,Ag);var jg=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Mg=(e,t,n)=>(jg(e,t,`read from private field`),n?n.call(e):t.get(e)),Ng=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Pg,Fg=1,Ig=e=>e.mediaMuted?0:e.mediaVolume,Lg=e=>`${Math.round(e*100)}%`,Rg=class extends Df{constructor(){super(...arguments),Ng(this,Pg,()=>{let e=this.range.value,t=new N.CustomEvent(k.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)})}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_VOLUME,j.MEDIA_MUTED,j.MEDIA_VOLUME_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),this.range.setAttribute(`aria-label`,M(`volume`)),this.range.addEventListener(`input`,Mg(this,Pg))}disconnectedCallback(){this.range.removeEventListener(`input`,Mg(this,Pg)),super.disconnectedCallback()}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),(e===j.MEDIA_VOLUME||e===j.MEDIA_MUTED)&&(this.range.valueAsNumber=Ig(this),this.range.setAttribute(`aria-valuetext`,Lg(this.range.valueAsNumber)),this.updateBar())}get mediaVolume(){return P(this,j.MEDIA_VOLUME,Fg)}set mediaVolume(e){F(this,j.MEDIA_VOLUME,e)}get mediaMuted(){return I(this,j.MEDIA_MUTED)}set mediaMuted(e){L(this,j.MEDIA_MUTED,e)}get mediaVolumeUnavailable(){return R(this,j.MEDIA_VOLUME_UNAVAILABLE)}set mediaVolumeUnavailable(e){z(this,j.MEDIA_VOLUME_UNAVAILABLE,e)}};Pg=new WeakMap,N.customElements.get(`media-volume-range`)||N.customElements.define(`media-volume-range`,Rg);function zg(e){return`
      <style>
        :host {
          min-width: 4ch;
          padding: var(--media-button-padding, var(--media-control-padding, 10px 5px));
    ...
    `}function Bg(){return M(`Loop`)}var Vg=class extends ad{constructor(){super(...arguments),this.container=null}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_LOOP]}connectedCallback(){super.connectedCallback(),this.container=this.shadowRoot?.querySelector(`#icon`)||null,this.container&&(this.container.textContent=M(`Loop`))}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_LOOP&&this.container&&this.setAttribute(`aria-checked`,this.mediaLoop?`true`:`false`)}get mediaLoop(){return I(this,j.MEDIA_LOOP)}set mediaLoop(e){L(this,j.MEDIA_LOOP,e)}handleClick(){let e=!this.mediaLoop,t=new N.CustomEvent(k.MEDIA_LOOP_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};Vg.getSlotTemplateHTML=zg,Vg.getTooltipContentHTML=Bg,N.customElements.get(`media-loop-button`)||N.customElements.define(`media-loop-button`,Vg);var Hg=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},K=(e,t,n)=>(Hg(e,t,`read from private field`),n?n.call(e):t.get(e)),Ug=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Wg=(e,t,n,r)=>(Hg(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Gg,Kg,qg,Jg,Yg,Xg,Zg,Qg,$g,e_,t_,n_=1,r_=0,i_=1,a_={processCallback(e,t,n){if(n){for(let[e,r]of t)if(e in n){let t=n[e];typeof t==`boolean`&&r instanceof m_&&typeof r.element[r.attributeName]==`boolean`?r.booleanValue=t:typeof t==`function`&&r instanceof m_?r.element[r.attributeName]=t:r.value=t}}}},o_=class extends N.DocumentFragment{constructor(e,t,n=a_){var r;super(),Ug(this,Gg,void 0),Ug(this,Kg,void 0),this.append(e.content.cloneNode(!0)),Wg(this,Gg,s_(this)),Wg(this,Kg,n),(r=n.createCallback)==null||r.call(n,this,K(this,Gg),t),n.processCallback(this,K(this,Gg),t)}update(e){K(this,Kg).processCallback(this,K(this,Gg),e)}};Gg=new WeakMap,Kg=new WeakMap;var s_=(e,t=[])=>{let n,r;for(let i of e.attributes||[])if(i.value.includes(`{{`)){let a=new p_;for([n,r]of l_(i.value))if(!n)a.append(r);else{let n=new m_(e,i.name,i.namespaceURI);a.append(n),t.push([r,n])}i.value=a.toString()}for(let i of e.childNodes)if(i.nodeType===n_&&!(i instanceof HTMLTemplateElement))s_(i,t);else{let a=i.data;if(i.nodeType===n_||a.includes(`{{`)){let o=[];if(a)for([n,r]of l_(a))if(!n)o.push(new Text(r));else{let n=new h_(e);o.push(n),t.push([r,n])}else if(i instanceof HTMLTemplateElement){let n=new g_(e,i);o.push(n),t.push([n.expression,n])}i.replaceWith(...o.flatMap(e=>e.replacementNodes||[e]))}}return t},c_={},l_=e=>{let t=``,n=0,r=c_[e],i=0,a;if(r)return r;for(r=[];a=e[i];i++)a===`{`&&e[i+1]===`{`&&e[i-1]!==`\\`&&e[i+2]&&++n==1?(t&&r.push([r_,t]),t=``,i++):a===`}`&&e[i+1]===`}`&&e[i-1]!==`\\`&&!--n?(r.push([i_,t.trim()]),t=``,i++):t+=a||``;return t&&r.push([r_,(n>0?`{{`:``)+t]),c_[e]=r},u_=11,d_=class{get value(){return``}set value(e){}toString(){return this.value}},f_=new WeakMap,p_=class{constructor(){Ug(this,qg,[])}[Symbol.iterator](){return K(this,qg).values()}get length(){return K(this,qg).length}item(e){return K(this,qg)[e]}append(...e){for(let t of e)t instanceof m_&&f_.set(t,this),K(this,qg).push(t)}toString(){return K(this,qg).join(``)}};qg=new WeakMap;var m_=class extends d_{constructor(e,t,n){super(),Ug(this,Qg),Ug(this,Jg,``),Ug(this,Yg,void 0),Ug(this,Xg,void 0),Ug(this,Zg,void 0),Wg(this,Yg,e),Wg(this,Xg,t),Wg(this,Zg,n)}get attributeName(){return K(this,Xg)}get attributeNamespace(){return K(this,Zg)}get element(){return K(this,Yg)}get value(){return K(this,Jg)}set value(e){K(this,Jg)!==e&&(Wg(this,Jg,e),!K(this,Qg,$g)||K(this,Qg,$g).length===1?e==null?K(this,Yg).removeAttributeNS(K(this,Zg),K(this,Xg)):K(this,Yg).setAttributeNS(K(this,Zg),K(this,Xg),e):K(this,Yg).setAttributeNS(K(this,Zg),K(this,Xg),K(this,Qg,$g).toString()))}get booleanValue(){return K(this,Yg).hasAttributeNS(K(this,Zg),K(this,Xg))}set booleanValue(e){if(!K(this,Qg,$g)||K(this,Qg,$g).length===1)this.value=e?``:null;else throw new DOMException(`Value is not fully templatized`)}};Jg=new WeakMap,Yg=new WeakMap,Xg=new WeakMap,Zg=new WeakMap,Qg=new WeakSet,$g=function(){return f_.get(this)};var h_=class extends d_{constructor(e,t){super(),Ug(this,e_,void 0),Ug(this,t_,void 0),Wg(this,e_,e),Wg(this,t_,t?[...t]:[new Text])}get replacementNodes(){return K(this,t_)}get parentNode(){return K(this,e_)}get nextSibling(){return K(this,t_)[K(this,t_).length-1].nextSibling}get previousSibling(){return K(this,t_)[0].previousSibling}get value(){return K(this,t_).map(e=>e.textContent).join(``)}set value(e){this.replace(e)}replace(...e){let t=e.flat().flatMap(e=>e==null?[new Text]:e.forEach?[...e]:e.nodeType===u_?[...e.childNodes]:e.nodeType?[e]:[new Text(e)]);t.length||t.push(new Text),Wg(this,t_,__(K(this,t_)[0].parentNode,K(this,t_),t,this.nextSibling))}};e_=new WeakMap,t_=new WeakMap;var g_=class extends h_{constructor(e,t){let n=t.getAttribute(`directive`)||t.getAttribute(`type`),r=t.getAttribute(`expression`)||t.getAttribute(n)||``;r.startsWith(`{{`)&&(r=r.trim().slice(2,-2).trim()),super(e),this.expression=r,this.template=t,this.directive=n}};function __(e,t,n,r=null){let i=0,a,o,s,c=n.length,l=t.length;for(;i<c&&i<l&&t[i]==n[i];)i++;for(;i<c&&i<l&&n[c-1]==t[l-1];)r=n[--l,--c];if(i==l)for(;i<c;)e.insertBefore(n[i++],r);if(i==c)for(;i<l;)e.removeChild(t[i++]);else{for(a=t[i];i<c;)s=n[i++],o=a?a.nextSibling:r,a==s?a=o:i<c&&n[i]==o?(e.replaceChild(s,a),a=o):e.insertBefore(s,a);for(;a!=r;)o=a.nextSibling,e.removeChild(a),a=o}return n}var v_={string:e=>String(e)},y_=class{constructor(e){this.template=e,this.state=void 0}},b_=new WeakMap,x_=new WeakMap,S_={partial:(e,t)=>{t[e.expression]=new y_(e.template)},if:(e,t)=>{var n;if(D_(e.expression,t))if(b_.get(e)!==e.template){b_.set(e,e.template);let n=new o_(e.template,t,w_);e.replace(n),x_.set(e,n)}else(n=x_.get(e))==null||n.update(t);else e.replace(``),b_.delete(e),x_.delete(e)}},C_=Object.keys(S_),w_={processCallback(e,t,n){var r,i;if(n)for(let[e,a]of t){if(a instanceof g_){if(!a.directive){let e=C_.find(e=>a.template.hasAttribute(e));e&&(a.directive=e,a.expression=a.template.getAttribute(e))}(r=S_[a.directive])==null||r.call(S_,a,n);continue}let t=D_(e,n);if(t instanceof y_){b_.get(a)===t.template?(i=x_.get(a))==null||i.update(t.state):(b_.set(a,t.template),t=new o_(t.template,t.state,w_),a.value=t,x_.set(a,t));continue}t?(a instanceof m_&&a.attributeName.startsWith(`aria-`)&&(t=String(t)),a instanceof m_?typeof t==`boolean`?a.booleanValue=t:typeof t==`function`?a.element[a.attributeName]=t:a.value=t:(a.value=t,b_.delete(a),x_.delete(a))):a instanceof m_?a.value=void 0:(a.value=void 0,b_.delete(a),x_.delete(a))}}},T_={"!":e=>!e,"!!":e=>!!e,"==":(e,t)=>e==t,"!=":(e,t)=>e!=t,">":(e,t)=>e>t,">=":(e,t)=>e>=t,"<":(e,t)=>e<t,"<=":(e,t)=>e<=t,"??":(e,t)=>e??t,"|":(e,t)=>v_[t]?.call(v_,e)};function E_(e){return j_(e,{boolean:/true|false/,number:/-?\d+\.?\d*/,string:/(["'])((?:\\.|[^\\])*?)\1/,operator:/[!=><][=!]?|\?\?|\|/,ws:/\s+/,param:/[$a-z_][$\w]*/i}).filter(({type:e})=>e!==`ws`)}function D_(e,t={}){let n=E_(e);if(n.length===0||n.some(({type:e})=>!e))return O_(e);if(n[0]?.token===`>`){let r=t[n[1]?.token];if(!r)return O_(e);let i={...t};r.state=i;let a=n.slice(2);for(let e=0;e<a.length;e+=3){let n=a[e]?.token,r=a[e+1]?.token,o=a[e+2]?.token;n&&r===`=`&&(i[n]=A_(o,t))}return r}if(n.length===1)return k_(n[0])?A_(n[0].token,t):O_(e);if(n.length===2){let r=T_[n[0]?.token];return!r||!k_(n[1])?O_(e):r(A_(n[1].token,t))}if(n.length===3){let r=n[1]?.token,i=T_[r];if(!i||!k_(n[0])||!k_(n[2]))return O_(e);let a=A_(n[0].token,t);return r===`|`?i(a,n[2].token):i(a,A_(n[2].token,t))}}function O_(e){return console.warn(`Warning: invalid expression \`${e}\``),!1}function k_({type:e}){return[`number`,`boolean`,`string`,`param`].includes(e)}function A_(e,t){let n=e[0],r=e.slice(-1);return e===`true`||e===`false`?e===`true`:n===r&&[`'`,`"`].includes(n)?e.slice(1,-1):Ts(e)?parseFloat(e):t[e]}function j_(e,t){let n,r,i,a=[];for(;e;){i=null,n=e.length;for(let a in t)r=t[a].exec(e),r&&r.index<n&&(i={token:r[0],type:a,matches:r.slice(1)},n=r.index);n&&a.push({token:e.substr(0,n),type:void 0}),i&&a.push(i),e=e.substr(n+(i?i.token.length:0))}return a}var M_=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},N_=(e,t,n)=>(M_(e,t,`read from private field`),n?n.call(e):t.get(e)),P_=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},F_=(e,t,n,r)=>(M_(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),I_=(e,t,n)=>(M_(e,t,`access private method`),n),L_,R_,z_,B_,V_,H_,U_,W_,G_,K_={mediatargetlivewindow:`targetlivewindow`,mediastreamtype:`streamtype`},q_=Ws.createElement(`template`);q_.innerHTML=`
  <style>
    :host {
      display: inline-block;
      line-height: 0;
...
`;var J_=class extends N.HTMLElement{constructor(){super(),P_(this,V_),P_(this,U_),P_(this,L_,void 0),P_(this,R_,void 0),P_(this,z_,void 0),P_(this,B_,void 0),P_(this,G_,void 0),this.shadowRoot?this.renderRoot=this.shadowRoot:(this.renderRoot=this.attachShadow({mode:`open`}),this.createRenderer()),F_(this,B_,new MutationObserver(e=>{this.mediaController&&!this.mediaController?.breakpointsComputed||e.some(e=>{let t=e.target;return t===this?!0:t.localName===`media-controller`?!!(K_[e.attributeName]||e.attributeName.startsWith(`breakpoint`)):!1})&&this.render()})),F_(this,G_,this.render.bind(this)),I_(this,V_,H_).call(this,`template`)}get mediaController(){return this.renderRoot.querySelector(`media-controller`)}get template(){return N_(this,L_)??this.constructor.template}set template(e){if(e===null){this.removeAttribute(`template`);return}typeof e==`string`?this.setAttribute(`template`,e):e instanceof HTMLTemplateElement&&(F_(this,L_,e),F_(this,z_,null),this.createRenderer())}get props(){let e=[...Array.from(this.mediaController?.attributes??[]).filter(({name:e})=>K_[e]||e.startsWith(`breakpoint`)),...Array.from(this.attributes)],t={};for(let n of e){let e=K_[n.name]??Cs(n.name),{value:r}=n;r==null?t[e]=!1:(Ts(r)&&(r=parseFloat(r)),t[e]=r===``?!0:r)}return t}attributeChangedCallback(e,t,n){e===`template`&&t!=n&&I_(this,U_,W_).call(this)}connectedCallback(){this.addEventListener(ss.BREAKPOINTS_COMPUTED,N_(this,G_)),N_(this,B_).observe(this,{attributes:!0}),N_(this,B_).observe(this.renderRoot,{attributes:!0,subtree:!0}),I_(this,U_,W_).call(this)}disconnectedCallback(){this.removeEventListener(ss.BREAKPOINTS_COMPUTED,N_(this,G_)),N_(this,B_).disconnect()}createRenderer(){this.template instanceof HTMLTemplateElement&&this.template!==N_(this,R_)&&(F_(this,R_,this.template),this.renderer=new o_(this.template,this.props,this.constructor.processor),this.renderRoot.textContent=``,this.renderRoot.append(q_.content.cloneNode(!0),this.renderer))}render(){var e;(e=this.renderer)==null||e.update(this.props)}};L_=new WeakMap,R_=new WeakMap,z_=new WeakMap,B_=new WeakMap,V_=new WeakSet,H_=function(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}},U_=new WeakSet,W_=function(){let e=this.getAttribute(`template`);if(!e||e===N_(this,z_))return;let t=this.getRootNode(),n=(t?.getElementById)?.call(t,e);if(n){F_(this,z_,e),F_(this,L_,n),this.createRenderer();return}Y_(e)&&(F_(this,z_,e),X_(e).then(e=>{let t=Ws.createElement(`template`);t.innerHTML=e,F_(this,L_,t),this.createRenderer()}).catch(console.error))},G_=new WeakMap,J_.observedAttributes=[`template`],J_.processor=w_;function Y_(e){if(!/^(\/|\.\/|https?:\/\/)/.test(e))return!1;let t=/^https?:\/\//.test(e)?void 0:location.origin;try{new URL(e,t)}catch{return!1}return!0}async function X_(e){let t=await fetch(e);if(t.status!==200)throw Error(`Failed to load resource: the server responded with a status of ${t.status}`);return t.text()}N.customElements.get(`media-theme`)||N.customElements.define(`media-theme`,J_);function Z_({anchor:e,floating:t,placement:n}){let{x:r,y:i}=ev(Q_({anchor:e,floating:t}),n);return{x:r,y:i}}function Q_({anchor:e,floating:t}){return{anchor:$_(e,t.offsetParent),floating:{x:0,y:0,width:t.offsetWidth,height:t.offsetHeight}}}function $_(e,t){let n=e.getBoundingClientRect(),r=t?.getBoundingClientRect()??{x:0,y:0};return{x:n.x-r.x,y:n.y-r.y,width:n.width,height:n.height}}function ev({anchor:e,floating:t},n){let r=nv(n)===`x`?`y`:`x`,i=r===`y`?`height`:`width`,a=tv(n),o=e.x+e.width/2-t.width/2,s=e.y+e.height/2-t.height/2,c=e[i]/2-t[i]/2,l;switch(a){case`top`:l={x:o,y:e.y-t.height};break;case`bottom`:l={x:o,y:e.y+e.height};break;case`right`:l={x:e.x+e.width,y:s};break;case`left`:l={x:e.x-t.width,y:s};break;default:l={x:e.x,y:e.y}}switch(n.split(`-`)[1]){case`start`:l[r]-=c;break;case`end`:l[r]+=c;break}return l}function tv(e){return e.split(`-`)[0]}function nv(e){return[`top`,`bottom`].includes(tv(e))?`y`:`x`}var rv=class extends Event{constructor({action:e=`auto`,relatedTarget:t,...n}){super(`invoke`,n),this.action=e,this.relatedTarget=t}},iv=class extends Event{constructor({newState:e,oldState:t,...n}){super(`toggle`,n),this.newState=e,this.oldState=t}},av=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},q=(e,t,n)=>(av(e,t,`read from private field`),n?n.call(e):t.get(e)),J=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},ov=(e,t,n,r)=>(av(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Y=(e,t,n)=>(av(e,t,`access private method`),n),sv,cv,lv,uv,dv,fv,pv,mv,hv,gv,_v,vv,yv,bv,xv,Sv,Cv,wv,Tv,Ev,Dv,Ov,kv,Av,jv,Mv,Nv,Pv,Fv,Iv,Lv,Rv,zv,Bv,Vv,Hv,Uv,Wv,Gv,Kv,qv,Jv,Yv,Xv,Zv,Qv;function $v({type:e,text:t,value:n,checked:r}){let i=Ws.createElement(`media-chrome-menu-item`);i.type=e??``,i.part.add(`menu-item`),e&&i.part.add(e),i.value=n,i.checked=r;let a=Ws.createElement(`span`);return a.textContent=t,i.append(a),i}function ey(e,t){let n=e.querySelector(`:scope > [slot="${t}"]`);if(n?.nodeName==`SLOT`&&(n=n.assignedElements({flatten:!0})[0]),n)return n=n.cloneNode(!0),n;let r=e.shadowRoot.querySelector(`[name="${t}"] > svg`);return r?r.cloneNode(!0):``}function ty(e){return`
    <style>
      :host {
        font: var(--media-font,
          var(--media-font-weight, normal)
  ...
  `}var ny={STYLE:`style`,HIDDEN:`hidden`,DISABLED:`disabled`,ANCHOR:`anchor`},ry=class extends N.HTMLElement{constructor(){if(super(),J(this,mv),J(this,gv),J(this,yv),J(this,xv),J(this,Cv),J(this,Tv),J(this,kv),J(this,jv),J(this,Nv),J(this,Fv),J(this,Lv),J(this,zv),J(this,Vv),J(this,Uv),J(this,Gv),J(this,qv),J(this,Yv),J(this,Zv),J(this,sv,null),J(this,cv,null),J(this,lv,null),J(this,uv,new Set),J(this,dv,void 0),J(this,fv,!1),J(this,pv,null),J(this,vv,()=>{let e=q(this,uv),t=new Set(this.items);for(let n of e)t.has(n)||this.dispatchEvent(new CustomEvent(`removemenuitem`,{detail:n}));for(let n of t)e.has(n)||this.dispatchEvent(new CustomEvent(`addmenuitem`,{detail:n}));ov(this,uv,t)}),J(this,Dv,()=>{Y(this,kv,Av).call(this),Y(this,jv,Mv).call(this,!1)}),J(this,Ov,()=>{Y(this,kv,Av).call(this)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.container=this.shadowRoot.querySelector(`#container`),this.defaultSlot=this.shadowRoot.querySelector(`slot:not([name])`),ov(this,dv,new MutationObserver(q(this,vv)))}static get observedAttributes(){return[ny.DISABLED,ny.HIDDEN,ny.STYLE,ny.ANCHOR,A.MEDIA_CONTROLLER]}static formatMenuItemText(e,t){return e}enable(){this.addEventListener(`click`,this),this.addEventListener(`focusout`,this),this.addEventListener(`keydown`,this),this.addEventListener(`invoke`,this),this.addEventListener(`toggle`,this)}disable(){this.removeEventListener(`click`,this),this.removeEventListener(`focusout`,this),this.removeEventListener(`keyup`,this),this.removeEventListener(`invoke`,this),this.removeEventListener(`toggle`,this)}handleEvent(e){switch(e.type){case`slotchange`:Y(this,mv,hv).call(this,e);break;case`invoke`:Y(this,xv,Sv).call(this,e);break;case`click`:Y(this,Nv,Pv).call(this,e);break;case`toggle`:Y(this,Lv,Rv).call(this,e);break;case`focusout`:Y(this,Vv,Hv).call(this,e);break;case`keydown`:Y(this,Uv,Wv).call(this,e);break}}connectedCallback(){var e,t;q(this,dv).observe(this.defaultSlot,{childList:!0}),ov(this,pv,uc(this.shadowRoot,`:host`)),Y(this,yv,bv).call(this),this.hasAttribute(`disabled`)||this.enable(),this.role||=`menu`,ov(this,sv,Qs(this)),(t=(e=q(this,sv))?.associateElement)==null||t.call(e,this),this.hidden||(Js(ay(this),q(this,Dv)),Js(this,q(this,Ov))),Y(this,gv,_v).call(this),this.shadowRoot.addEventListener(`slotchange`,this)}disconnectedCallback(){var e,t;q(this,dv).disconnect(),Ys(ay(this),q(this,Dv)),Ys(this,q(this,Ov)),this.disable(),(t=(e=q(this,sv))?.unassociateElement)==null||t.call(e,this),ov(this,sv,null),ov(this,cv,null),ov(this,lv,null),this.shadowRoot.removeEventListener(`slotchange`,this)}attributeChangedCallback(e,t,n){var r,i,a,o;e===ny.HIDDEN&&n!==t?(q(this,fv)||ov(this,fv,!0),this.hidden?Y(this,Tv,Ev).call(this):Y(this,Cv,wv).call(this),this.dispatchEvent(new iv({oldState:this.hidden?`open`:`closed`,newState:this.hidden?`closed`:`open`,bubbles:!0}))):e===A.MEDIA_CONTROLLER?(t&&((i=(r=q(this,sv))?.unassociateElement)==null||i.call(r,this),ov(this,sv,null)),n&&this.isConnected&&(ov(this,sv,Qs(this)),(o=(a=q(this,sv))?.associateElement)==null||o.call(a,this))):e===ny.DISABLED&&n!==t?n==null?this.enable():this.disable():e===ny.STYLE&&n!==t&&Y(this,yv,bv).call(this)}formatMenuItemText(e,t){return this.constructor.formatMenuItemText(e,t)}get anchor(){return this.getAttribute(`anchor`)}set anchor(e){this.setAttribute(`anchor`,`${e}`)}get anchorElement(){return this.anchor?ac(this)?.querySelector(`#${this.anchor}`):null}get items(){return this.defaultSlot.assignedElements({flatten:!0}).filter(iy)}get radioGroupItems(){return this.items.filter(e=>e.role===`menuitemradio`)}get checkedItems(){return this.items.filter(e=>e.checked)}get value(){return this.checkedItems[0]?.value??``}set value(e){let t=this.items.find(t=>t.value===e);t&&Y(this,Zv,Qv).call(this,t)}focus(){if(ov(this,cv,ic()),this.items.length){Y(this,Yv,Xv).call(this,this.items[0]),this.items[0].focus();return}this.querySelector(`[autofocus], [tabindex]:not([tabindex="-1"]), [role="menu"]`)?.focus()}handleSelect(e){var t;let n=Y(this,Gv,Kv).call(this,e);n&&(Y(this,Zv,Qv).call(this,n,n.type===`checkbox`),q(this,lv)&&!this.hidden&&((t=q(this,cv))==null||t.focus(),this.hidden=!0))}get keysUsed(){return[`Enter`,`Escape`,`Tab`,` `,`ArrowDown`,`ArrowUp`,`Home`,`End`]}handleMove(e){let{key:t}=e,n=this.items,r=Y(this,Gv,Kv).call(this,e)??Y(this,qv,Jv).call(this)??n[0],i=n.indexOf(r),a=Math.max(0,i);t===`ArrowDown`?a++:t===`ArrowUp`?a--:e.key===`Home`?a=0:e.key===`End`&&(a=n.length-1),a<0&&(a=n.length-1),a>n.length-1&&(a=0),Y(this,Yv,Xv).call(this,n[a]),n[a].focus()}};sv=new WeakMap,cv=new WeakMap,lv=new WeakMap,uv=new WeakMap,dv=new WeakMap,fv=new WeakMap,pv=new WeakMap,mv=new WeakSet,hv=function(e){let t=e.target;for(let e of t.assignedNodes({flatten:!0}))e.nodeType===3&&e.textContent.trim()===``&&e.remove();[`header`,`title`].includes(t.name)&&Y(this,gv,_v).call(this),t.name||q(this,vv).call(this)},gv=new WeakSet,_v=function(){let e=this.shadowRoot.querySelector(`slot[name="header"]`);e.hidden=this.shadowRoot.querySelector(`slot[name="title"]`).assignedNodes().length===0&&e.assignedNodes().length===0},vv=new WeakMap,yv=new WeakSet,bv=function(){let e=this.shadowRoot.querySelector(`#layout-row`),t=getComputedStyle(this).getPropertyValue(`--media-menu-layout`)?.trim();e.setAttribute(`media`,t===`row`?``:`width:0`)},xv=new WeakSet,Sv=function(e){ov(this,lv,e.relatedTarget),nc(this,e.relatedTarget)||(this.hidden=!this.hidden)},Cv=new WeakSet,wv=function(){var e;(e=q(this,lv))==null||e.setAttribute(`aria-expanded`,`true`),this.addEventListener(`transitionend`,()=>this.focus(),{once:!0}),Js(ay(this),q(this,Dv)),Js(this,q(this,Ov))},Tv=new WeakSet,Ev=function(){var e;(e=q(this,lv))==null||e.setAttribute(`aria-expanded`,`false`),Ys(ay(this),q(this,Dv)),Ys(this,q(this,Ov))},Dv=new WeakMap,Ov=new WeakMap,kv=new WeakSet,Av=function(e){if(this.hasAttribute(`mediacontroller`)&&!this.anchor||this.hidden||!this.anchorElement)return;let{x:t,y:n}=Z_({anchor:this.anchorElement,floating:this,placement:`top-start`});e??=this.offsetWidth;let r=ay(this).getBoundingClientRect(),i=r.width-t-e,a=r.height-n-this.offsetHeight,{style:o}=q(this,pv);o.setProperty(`position`,`absolute`),o.setProperty(`right`,`${Math.max(0,i)}px`),o.setProperty(`--_menu-bottom`,`${a}px`);let s=getComputedStyle(this),c=o.getPropertyValue(`--_menu-bottom`)===s.bottom?a:parseFloat(s.bottom),l=r.height-c-parseFloat(s.marginBottom);this.style.setProperty(`--_menu-max-height`,`${l}px`)},jv=new WeakSet,Mv=function(e){let t=this.querySelector(`[role="menuitem"][aria-haspopup][aria-expanded="true"]`),n=t?.querySelector(`[role="menu"]`),{style:r}=q(this,pv);if(e||r.setProperty(`--media-menu-transition-in`,`none`),n){let e=n.offsetHeight,r=Math.max(n.offsetWidth,t.offsetWidth);this.style.setProperty(`min-width`,`${r}px`),this.style.setProperty(`min-height`,`${e}px`),Y(this,kv,Av).call(this,r)}else this.style.removeProperty(`min-width`),this.style.removeProperty(`min-height`),Y(this,kv,Av).call(this);r.removeProperty(`--media-menu-transition-in`)},Nv=new WeakSet,Pv=function(e){var t;if(e.stopPropagation(),e.composedPath().includes(q(this,Fv,Iv))){(t=q(this,cv))==null||t.focus(),this.hidden=!0;return}let n=Y(this,Gv,Kv).call(this,e);!n||n.hasAttribute(`disabled`)||(Y(this,Yv,Xv).call(this,n),this.handleSelect(e))},Fv=new WeakSet,Iv=function(){return this.shadowRoot.querySelector(`slot[name="header"]`).assignedElements({flatten:!0})?.find(e=>e.matches(`button[part~="back"]`))},Lv=new WeakSet,Rv=function(e){if(e.target===this)return;Y(this,zv,Bv).call(this);let t=Array.from(this.querySelectorAll(`[role="menuitem"][aria-haspopup]`));for(let n of t)n.invokeTargetElement!=e.target&&e.newState==`open`&&n.getAttribute(`aria-expanded`)==`true`&&!n.invokeTargetElement.hidden&&n.invokeTargetElement.dispatchEvent(new rv({relatedTarget:n}));for(let e of t)e.setAttribute(`aria-expanded`,`${!e.submenuElement.hidden}`);Y(this,jv,Mv).call(this,!0)},zv=new WeakSet,Bv=function(){let e=this.querySelector(`[role="menuitem"] > [role="menu"]:not([hidden])`);this.container.classList.toggle(`has-expanded`,!!e)},Vv=new WeakSet,Hv=function(e){var t;nc(this,e.relatedTarget)||(q(this,fv)&&((t=q(this,cv))==null||t.focus()),q(this,lv)&&q(this,lv)!==e.relatedTarget&&!this.hidden&&(this.hidden=!0))},Uv=new WeakSet,Wv=function(e){var t,n,r,i,a;let{key:o,ctrlKey:s,altKey:c,metaKey:l}=e;if(!(s||c||l)&&this.keysUsed.includes(o))if(e.preventDefault(),e.stopPropagation(),o===`Tab`){if(q(this,fv)){this.hidden=!0;return}e.shiftKey?(n=(t=this.previousElementSibling)?.focus)==null||n.call(t):(i=(r=this.nextElementSibling)?.focus)==null||i.call(r),this.blur()}else o===`Escape`?((a=q(this,cv))==null||a.focus(),q(this,fv)&&(this.hidden=!0)):o===`Enter`||o===` `?this.handleSelect(e):this.handleMove(e)},Gv=new WeakSet,Kv=function(e){return e.composedPath().find(e=>[`menuitemradio`,`menuitemcheckbox`].includes(e.role))},qv=new WeakSet,Jv=function(){return this.items.find(e=>e.tabIndex===0)},Yv=new WeakSet,Xv=function(e){for(let t of this.items)t.tabIndex=t===e?0:-1},Zv=new WeakSet,Qv=function(e,t){let n=[...this.checkedItems];e.type===`radio`&&this.radioGroupItems.forEach(e=>e.checked=!1),t?e.checked=!e.checked:e.checked=!0,this.checkedItems.some((e,t)=>e!=n[t])&&this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))},ry.shadowRootOptions={mode:`open`},ry.getTemplateHTML=ty;function iy(e){return[`menuitem`,`menuitemradio`,`menuitemcheckbox`].includes(e?.role)}function ay(e){return(e.getAttribute(`bounds`)?rc(e,`#${e.getAttribute(`bounds`)}`):Zs(e)||e.parentElement)??e}N.customElements.get(`media-chrome-menu`)||N.customElements.define(`media-chrome-menu`,ry);var oy=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},sy=(e,t,n)=>(oy(e,t,`read from private field`),n?n.call(e):t.get(e)),cy=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},ly=(e,t,n,r)=>(oy(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),uy=(e,t,n)=>(oy(e,t,`access private method`),n),dy,fy,py,my,hy,gy,_y,vy,yy,by,xy,Sy,Cy;function wy(e){return`
    <style>
      :host {
  ...
  `}function Ty(e){return``}var Ey={TYPE:`type`,VALUE:`value`,CHECKED:`checked`,DISABLED:`disabled`},Dy=class extends N.HTMLElement{constructor(){if(super(),cy(this,py),cy(this,hy),cy(this,_y),cy(this,Sy),cy(this,dy,!1),cy(this,fy,void 0),cy(this,yy,()=>{this.submenuElement.items&&this.setAttribute(`submenusize`,`${this.submenuElement.items.length}`);let e=this.shadowRoot.querySelector(`slot[name="description"]`),t=this.submenuElement.checkedItems?.[0],n=t?.dataset.description??t?.text,r=Ws.createElement(`span`);r.textContent=n??``,e.replaceChildren(r)}),cy(this,by,e=>{let{key:t}=e;if(!this.keysUsed.includes(t)){this.removeEventListener(`keyup`,sy(this,by));return}this.handleClick(e)}),cy(this,xy,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!this.keysUsed.includes(r)){this.removeEventListener(`keyup`,sy(this,by));return}this.addEventListener(`keyup`,sy(this,by),{once:!0})}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Xs(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[Ey.TYPE,Ey.DISABLED,Ey.CHECKED,Ey.VALUE]}enable(){this.hasAttribute(`tabindex`)||this.setAttribute(`tabindex`,`-1`),Oy(this)&&!this.hasAttribute(`aria-checked`)&&this.setAttribute(`aria-checked`,`false`),this.addEventListener(`click`,this),this.addEventListener(`keydown`,this)}disable(){this.removeAttribute(`tabindex`),this.removeEventListener(`click`,this),this.removeEventListener(`keydown`,this),this.removeEventListener(`keyup`,this)}handleEvent(e){switch(e.type){case`slotchange`:uy(this,py,my).call(this,e);break;case`click`:this.handleClick(e);break;case`keydown`:sy(this,xy).call(this,e);break;case`keyup`:sy(this,by).call(this,e);break}}attributeChangedCallback(e,t,n){e===Ey.CHECKED&&Oy(this)&&!sy(this,dy)?this.setAttribute(`aria-checked`,n==null?`false`:`true`):e===Ey.TYPE&&n!==t?this.role=`menuitem`+n:e===Ey.DISABLED&&n!==t&&(n==null?this.enable():this.disable())}connectedCallback(){this.hasAttribute(Ey.DISABLED)||this.enable(),this.role=`menuitem`+this.type,ly(this,fy,ky(this,this.parentNode)),uy(this,Sy,Cy).call(this),this.submenuElement&&uy(this,hy,gy).call(this),this.shadowRoot.addEventListener(`slotchange`,this)}disconnectedCallback(){this.disable(),uy(this,Sy,Cy).call(this),ly(this,fy,null),this.shadowRoot.removeEventListener(`slotchange`,this)}get invokeTarget(){return this.getAttribute(`invoketarget`)}set invokeTarget(e){this.setAttribute(`invoketarget`,`${e}`)}get invokeTargetElement(){return this.invokeTarget?ac(this)?.querySelector(`#${this.invokeTarget}`):this.submenuElement}get submenuElement(){return this.shadowRoot.querySelector(`slot[name="submenu"]`).assignedElements({flatten:!0})[0]}get type(){return this.getAttribute(Ey.TYPE)??``}set type(e){this.setAttribute(Ey.TYPE,`${e}`)}get value(){return this.getAttribute(Ey.VALUE)??this.text}set value(e){this.setAttribute(Ey.VALUE,e)}get text(){return(this.textContent??``).trim()}get checked(){if(Oy(this))return this.getAttribute(`aria-checked`)===`true`}set checked(e){Oy(this)&&(ly(this,dy,!0),this.setAttribute(`aria-checked`,e?`true`:`false`),e?this.part.add(`checked`):this.part.remove(`checked`))}handleClick(e){Oy(this)||this.invokeTargetElement&&nc(this,e.target)&&this.invokeTargetElement.dispatchEvent(new rv({relatedTarget:this}))}get keysUsed(){return[`Enter`,` `]}};dy=new WeakMap,fy=new WeakMap,py=new WeakSet,my=function(e){let t=e.target;if(!t?.name)for(let e of t.assignedNodes({flatten:!0}))e instanceof Text&&e.textContent.trim()===``&&e.remove();t.name===`submenu`&&(this.submenuElement?uy(this,hy,gy).call(this):uy(this,_y,vy).call(this))},hy=new WeakSet,gy=async function(){this.setAttribute(`aria-haspopup`,`menu`),this.setAttribute(`aria-expanded`,`${!this.submenuElement.hidden}`),this.submenuElement.addEventListener(`change`,sy(this,yy)),this.submenuElement.addEventListener(`addmenuitem`,sy(this,yy)),this.submenuElement.addEventListener(`removemenuitem`,sy(this,yy)),sy(this,yy).call(this)},_y=new WeakSet,vy=function(){this.removeAttribute(`aria-haspopup`),this.removeAttribute(`aria-expanded`),this.submenuElement.removeEventListener(`change`,sy(this,yy)),this.submenuElement.removeEventListener(`addmenuitem`,sy(this,yy)),this.submenuElement.removeEventListener(`removemenuitem`,sy(this,yy)),sy(this,yy).call(this)},yy=new WeakMap,by=new WeakMap,xy=new WeakMap,Sy=new WeakSet,Cy=function(){let e=sy(this,fy)?.radioGroupItems;if(!e)return;let t=e.filter(e=>e.getAttribute(`aria-checked`)===`true`).pop();t||=e[0];for(let t of e)t.setAttribute(`aria-checked`,`false`);t?.setAttribute(`aria-checked`,`true`)},Dy.shadowRootOptions={mode:`open`},Dy.getTemplateHTML=wy,Dy.getSuffixSlotInnerHTML=Ty;function Oy(e){return e.type===`radio`||e.type===`checkbox`}function ky(e,t){if(!e)return null;let{host:n}=e.getRootNode();return!t&&n?ky(e,n):t?.items?t:ky(t,t?.parentNode)}N.customElements.get(`media-chrome-menu-item`)||N.customElements.define(`media-chrome-menu-item`,Dy);function Ay(e){return`
    ${ry.getTemplateHTML(e)}
    <style>
      :host {
        --_menu-bg: rgb(20 20 30 / .8);
  ...
  `}var jy=class extends ry{get anchorElement(){return this.anchor===`auto`?Zs(this).querySelector(`media-settings-menu-button`):super.anchorElement}};jy.getTemplateHTML=Ay,N.customElements.get(`media-settings-menu`)||N.customElements.define(`media-settings-menu`,jy);function My(e){return`
  ...
  `}var Py=class extends Dy{};Py.shadowRootOptions={mode:`open`},Py.getTemplateHTML=My,Py.getSuffixSlotInnerHTML=Ny,N.customElements.get(`media-settings-menu-item`)||N.customElements.define(`media-settings-menu-item`,Py);var Fy=class extends ad{connectedCallback(){super.connectedCallback(),this.invokeTargetElement&&this.setAttribute(`aria-haspopup`,`menu`)}get invokeTarget(){return this.getAttribute(`invoketarget`)}set invokeTarget(e){this.setAttribute(`invoketarget`,`${e}`)}get invokeTargetElement(){return this.invokeTarget?ac(this)?.querySelector(`#${this.invokeTarget}`):null}handleClick(){var e;(e=this.invokeTargetElement)==null||e.dispatchEvent(new rv({relatedTarget:this}))}};N.customElements.get(`media-chrome-menu-button`)||N.customElements.define(`media-chrome-menu-button`,Fy);function Iy(){return`
    <style>
  ...
  `}function Ly(){return M(`Settings`)}var Ry=class extends Fy{static get observedAttributes(){return[...super.observedAttributes,`target`]}connectedCallback(){super.connectedCallback(),this.setAttribute(`aria-label`,M(`settings`))}get invokeTargetElement(){return this.invokeTarget==null?Zs(this).querySelector(`media-settings-menu`):super.invokeTargetElement}};Ry.getSlotTemplateHTML=Iy,Ry.getTooltipContentHTML=Ly,N.customElements.get(`media-settings-menu-button`)||N.customElements.define(`media-settings-menu-button`,Ry);var zy=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},By=(e,t,n)=>(zy(e,t,`read from private field`),n?n.call(e):t.get(e)),Vy=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Hy=(e,t,n,r)=>(zy(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Uy=(e,t,n)=>(zy(e,t,`access private method`),n),Wy,Gy,Ky,qy,Jy,Yy,Xy=class extends ry{constructor(){super(...arguments),Vy(this,Ky),Vy(this,Jy),Vy(this,Wy,[]),Vy(this,Gy,void 0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_AUDIO_TRACK_LIST,j.MEDIA_AUDIO_TRACK_ENABLED,j.MEDIA_AUDIO_TRACK_UNAVAILABLE]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_AUDIO_TRACK_ENABLED&&t!==n?this.value=n:e===j.MEDIA_AUDIO_TRACK_LIST&&t!==n&&(Hy(this,Wy,bs(n??``)),Uy(this,Ky,qy).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,Uy(this,Jy,Yy))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,Uy(this,Jy,Yy))}get anchorElement(){return this.anchor===`auto`?Zs(this)?.querySelector(`media-audio-track-menu-button`):super.anchorElement}get mediaAudioTrackList(){return By(this,Wy)}set mediaAudioTrackList(e){Hy(this,Wy,e),Uy(this,Ky,qy).call(this)}get mediaAudioTrackEnabled(){return R(this,j.MEDIA_AUDIO_TRACK_ENABLED)??``}set mediaAudioTrackEnabled(e){z(this,j.MEDIA_AUDIO_TRACK_ENABLED,e)}};Wy=new WeakMap,Gy=new WeakMap,Ky=new WeakSet,qy=function(){if(By(this,Gy)===JSON.stringify(this.mediaAudioTrackList))return;Hy(this,Gy,JSON.stringify(this.mediaAudioTrackList));let e=this.mediaAudioTrackList;this.defaultSlot.textContent=``,e.sort((e,t)=>e.id.localeCompare(t.id,void 0,{numeric:!0}));for(let t of e){let e=$v({type:`radio`,text:this.formatMenuItemText(t.label,t),value:`${t.id}`,checked:t.enabled});e.prepend(ey(this,`checked-indicator`)),this.defaultSlot.append(e)}},Jy=new WeakSet,Yy=function(){if(this.value==null)return;let e=new N.CustomEvent(k.MEDIA_AUDIO_TRACK_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-audio-track-menu`)||N.customElements.define(`media-audio-track-menu`,Xy);var Zy=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  <path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10Zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0Z"/>
    ...
    <slot name="icon">${Zy}</slot>
  `}function $y(){return M(`Audio`)}var eb=e=>{let t=M(`Audio`);e.setAttribute(`aria-label`,t)},tb=class extends Fy{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_AUDIO_TRACK_ENABLED,j.MEDIA_AUDIO_TRACK_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),eb(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_LANG&&eb(this)}get invokeTargetElement(){return this.invokeTarget==null?Zs(this)?.querySelector(`media-audio-track-menu`):super.invokeTargetElement}get mediaAudioTrackEnabled(){return R(this,j.MEDIA_AUDIO_TRACK_ENABLED)??``}set mediaAudioTrackEnabled(e){z(this,j.MEDIA_AUDIO_TRACK_ENABLED,e)}};tb.getSlotTemplateHTML=Qy,tb.getTooltipContentHTML=$y,N.customElements.get(`media-audio-track-menu-button`)||N.customElements.define(`media-audio-track-menu-button`,tb);var nb=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},rb=(e,t,n)=>(nb(e,t,`read from private field`),n?n.call(e):t.get(e)),ib=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},ab=(e,t,n,r)=>(nb(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),ob=(e,t,n)=>(nb(e,t,`access private method`),n),sb,cb,lb,ub,db,fb=`
  <svg aria-hidden="true" viewBox="0 0 26 24" part="captions-indicator indicator">
    <path d="M22.83 5.68a2.58 2.58 0 0 0-2.3-2.5c-3.62-.24-11.44-.24-15.06 0a2.58 2.58 0 0 0-2.3 2.5c-.23 4.21-.23 8.43 0 12.64a2.58 2.58 0 0 0 2.3 2.5c3.62.24 11.44.24 15.06 0a2.58 2.58 0 0 0 2.3-2.5c.23-4.21.23-8.43 0-12.64Zm-11.39 9.45a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.92 3.92 0 0 1 .92-2.77 3.18 3.18 0 0 1 2.43-1 2.94 2.94 0 0 1 2.13.78c.364.359.62.813.74 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.17 1.61 1.61 0 0 0-1.29.58 2.79 2.79 0 0 0-.5 1.89 3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.48 1.48 0 0 0 1-.37 2.1 2.1 0 0 0 .59-1.14l1.4.44a3.23 3.23 0 0 1-1.07 1.69Zm7.22 0a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.88 3.88 0 0 1 .93-2.77 3.14 3.14 0 0 1 2.42-1 3 3 0 0 1 2.16.82 2.8 2.8 0 0 1 .73 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.21 1.61 1.61 0 0 0-1.29.58A2.79 2.79 0 0 0 15 12a3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.44 1.44 0 0 0 1-.37 2.1 2.1 0 0 0 .6-1.15l1.4.44a3.17 3.17 0 0 1-1.1 1.7Z"/>
  </svg>`;function pb(e){return`
    ${ry.getTemplateHTML(e)}
    <slot name="captions-indicator" hidden>${fb}</slot>
  `}var mb=class extends ry{constructor(){super(...arguments),ib(this,cb),ib(this,ub),ib(this,sb,void 0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_LIST&&t!==n?ob(this,cb,lb).call(this):e===j.MEDIA_SUBTITLES_SHOWING&&t!==n&&(this.value=n||``,ob(this,cb,lb).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,ob(this,ub,db))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,ob(this,ub,db))}get anchorElement(){return this.anchor===`auto`?Zs(this).querySelector(`media-captions-menu-button`):super.anchorElement}get mediaSubtitlesList(){return hb(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){gb(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return hb(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){gb(this,j.MEDIA_SUBTITLES_SHOWING,e)}};sb=new WeakMap,cb=new WeakSet,lb=function(){let e=rb(this,sb)!==JSON.stringify(this.mediaSubtitlesList),t=this.value!==this.getAttribute(j.MEDIA_SUBTITLES_SHOWING);if(!e&&!t)return;ab(this,sb,JSON.stringify(this.mediaSubtitlesList)),this.defaultSlot.textContent=``;let n=!this.value,r=$v({type:`radio`,text:this.formatMenuItemText(M(`Off`)),value:`off`,checked:n});r.prepend(ey(this,`checked-indicator`)),this.defaultSlot.append(r);let i=this.mediaSubtitlesList;for(let e of i){let t=$v({type:`radio`,text:this.formatMenuItemText(e.label,e),value:ml(e),checked:this.value==ml(e)});t.prepend(ey(this,`checked-indicator`)),(e.kind??`subs`)===`captions`&&t.append(ey(this,`captions-indicator`)),this.defaultSlot.append(t)}},ub=new WeakSet,db=function(){let e=this.mediaSubtitlesShowing,t=this.getAttribute(j.MEDIA_SUBTITLES_SHOWING),n=this.value!==t;if(e?.length&&n&&this.dispatchEvent(new N.CustomEvent(k.MEDIA_DISABLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:e})),!this.value||!n)return;let r=new N.CustomEvent(k.MEDIA_SHOW_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(r)},mb.getTemplateHTML=pb;var hb=(e,t)=>{let n=e.getAttribute(t);return n?fl(n):[]},gb=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=hl(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-menu`)||N.customElements.define(`media-captions-menu`,mb);var _b=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M22.83 5.68a2.58 2.58 0 0 0-2.3-2.5c-3.62-.24-11.44-.24-15.06 0a2.58 2.58 0 0 0-2.3 2.5c-.23 4.21-.23 8.43 0 12.64a2.58 2.58 0 0 0 2.3 2.5c3.62.24 11.44.24 15.06 0a2.58 2.58 0 0 0 2.3-2.5c.23-4.21.23-8.43 0-12.64Zm-11.39 9.45a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.92 3.92 0 0 1 .92-2.77 3.18 3.18 0 0 1 2.43-1 2.94 2.94 0 0 1 2.13.78c.364.359.62.813.74 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.17 1.61 1.61 0 0 0-1.29.58 2.79 2.79 0 0 0-.5 1.89 3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.48 1.48 0 0 0 1-.37 2.1 2.1 0 0 0 .59-1.14l1.4.44a3.23 3.23 0 0 1-1.07 1.69Zm7.22 0a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.88 3.88 0 0 1 .93-2.77 3.14 3.14 0 0 1 2.42-1 3 3 0 0 1 2.16.82 2.8 2.8 0 0 1 .73 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.21 1.61 1.61 0 0 0-1.29.58A2.79 2.79 0 0 0 15 12a3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.44 1.44 0 0 0 1-.37 2.1 2.1 0 0 0 .6-1.15l1.4.44a3.17 3.17 0 0 1-1.1 1.7Z"/>
</svg>`,vb=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M17.73 14.09a1.4 1.4 0 0 1-1 .37 1.579 1.579 0 0 1-1.27-.58A3 3 0 0 1 15 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34A2.89 2.89 0 0 0 19 9.07a3 3 0 0 0-2.14-.78 3.14 3.14 0 0 0-2.42 1 3.91 3.91 0 0 0-.93 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.17 3.17 0 0 0 1.07-1.74l-1.4-.45c-.083.43-.3.822-.62 1.12Zm-7.22 0a1.43 1.43 0 0 1-1 .37 1.58 1.58 0 0 1-1.27-.58A3 3 0 0 1 7.76 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34a2.81 2.81 0 0 0-.74-1.32 2.94 2.94 0 0 0-2.13-.78 3.18 3.18 0 0 0-2.43 1 4 4 0 0 0-.92 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.23 3.23 0 0 0 1.07-1.74l-1.4-.45a2.06 2.06 0 0 1-.6 1.07Zm12.32-8.41a2.59 2.59 0 0 0-2.3-2.51C18.72 3.05 15.86 3 13 3c-2.86 0-5.72.05-7.53.17a2.59 2.59 0 0 0-2.3 2.51c-.23 4.207-.23 8.423 0 12.63a2.57 2.57 0 0 0 2.3 2.5c1.81.13 4.67.19 7.53.19 2.86 0 5.72-.06 7.53-.19a2.57 2.57 0 0 0 2.3-2.5c.23-4.207.23-8.423 0-12.63Zm-1.49 12.53a1.11 1.11 0 0 1-.91 1.11c-1.67.11-4.45.18-7.43.18-2.98 0-5.76-.07-7.43-.18a1.11 1.11 0 0 1-.91-1.11c-.21-4.14-.21-8.29 0-12.43a1.11 1.11 0 0 1 .91-1.11C7.24 4.56 10 4.49 13 4.49s5.76.07 7.43.18a1.11 1.11 0 0 1 .91 1.11c.21 4.14.21 8.29 0 12.43Z"/>
</svg>`;function yb(){return`
    <style>
    ...
    <slot name="icon">
      <slot name="on">${_b}</slot>
      <slot name="off">${vb}</slot>
    </slot>
  `}function bb(){return M(`Captions`)}var xb=e=>{e.setAttribute(`data-captions-enabled`,bl(e).toString())},Sb=e=>{e.setAttribute(`aria-label`,M(`closed captions`))},Cb=class extends Fy{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING,j.MEDIA_LANG]}connectedCallback(){super.connectedCallback(),Sb(this),xb(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_SHOWING?xb(this):e===j.MEDIA_LANG&&Sb(this)}get invokeTargetElement(){return this.invokeTarget==null?Zs(this)?.querySelector(`media-captions-menu`):super.invokeTargetElement}get mediaSubtitlesList(){return wb(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){Tb(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return wb(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){Tb(this,j.MEDIA_SUBTITLES_SHOWING,e)}};Cb.getSlotTemplateHTML=yb,Cb.getTooltipContentHTML=bb;var wb=(e,t)=>{let n=e.getAttribute(t);return n?fl(n):[]},Tb=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=hl(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-menu-button`)||N.customElements.define(`media-captions-menu-button`,Cb);var Eb=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Db=(e,t,n)=>(Eb(e,t,`read from private field`),n?n.call(e):t.get(e)),Ob=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},kb=(e,t,n)=>(Eb(e,t,`access private method`),n),Ab,jb,Mb,Nb,Pb,Fb={RATES:`rates`},Ib=class extends ry{constructor(){super(),Ob(this,jb),Ob(this,Nb),Ob(this,Ab,new ll(this,Fb.RATES,{defaultValue:dm})),kb(this,jb,Mb).call(this)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE,Fb.RATES]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_PLAYBACK_RATE&&t!=n?(this.value=n,kb(this,jb,Mb).call(this)):e===Fb.RATES&&t!=n&&(Db(this,Ab).value=n,kb(this,jb,Mb).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,kb(this,Nb,Pb))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,kb(this,Nb,Pb))}get anchorElement(){return this.anchor===`auto`?Zs(this).querySelector(`media-playback-rate-menu-button`):super.anchorElement}get rates(){return Db(this,Ab)}set rates(e){e?Array.isArray(e)?Db(this,Ab).value=e.join(` `):typeof e==`string`&&(Db(this,Ab).value=e):Db(this,Ab).value=``,kb(this,jb,Mb).call(this)}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}};Ab=new WeakMap,jb=new WeakSet,Mb=function(){this.defaultSlot.textContent=``;let e=fm(this.mediaPlaybackRate),t=new Set(Array.from(Db(this,Ab)).map(e=>fm(Number(e))));e>0&&!t.has(e)&&t.add(e);let n=Array.from(t).sort((e,t)=>e-t);for(let t of n){let n=$v({type:`radio`,text:this.formatMenuItemText(`${t}x`,t),value:t.toString(),checked:e===t});n.prepend(ey(this,`checked-indicator`)),this.defaultSlot.append(n)}},Nb=new WeakSet,Pb=function(){if(!this.value)return;let e=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-playback-rate-menu`)||N.customElements.define(`media-playback-rate-menu`,Ib);function Lb(e){return`
    <style>
      :host {
        min-width: 5ch;
        padding: var(--media-button-padding, var(--media-control-padding, 10px 5px));
    ...
    <slot name="icon">${e.mediaplaybackrate?fm(+e.mediaplaybackrate):1}x</slot>
  `}function Rb(){return M(`Playback rate`)}var zb=class extends Fy{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE]}constructor(){super(),this.container=this.shadowRoot.querySelector(`slot[name="icon"]`),this.container.innerHTML=`${fm(this.mediaPlaybackRate??1)}x`}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===j.MEDIA_PLAYBACK_RATE){let e=n?+n:NaN,t=fm(Number.isNaN(e)?1:e);this.container.innerHTML=`${t}x`,this.setAttribute(`aria-label`,M(`Playback rate {playbackRate}`,{playbackRate:t}))}}get invokeTargetElement(){return this.invokeTarget==null?Zs(this).querySelector(`media-playback-rate-menu`):super.invokeTargetElement}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}};zb.getSlotTemplateHTML=Lb,zb.getTooltipContentHTML=Rb,N.customElements.get(`media-playback-rate-menu-button`)||N.customElements.define(`media-playback-rate-menu-button`,zb);var Bb=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Vb=(e,t,n)=>(Bb(e,t,`read from private field`),n?n.call(e):t.get(e)),Hb=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Ub=(e,t,n,r)=>(Bb(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Wb=(e,t,n)=>(Bb(e,t,`access private method`),n),Gb,Kb,qb,Jb,Yb,Xb,Zb=class extends ry{constructor(){super(...arguments),Hb(this,qb),Hb(this,Yb),Hb(this,Gb,[]),Hb(this,Kb,{})}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_RENDITION_LIST,j.MEDIA_RENDITION_SELECTED,j.MEDIA_RENDITION_UNAVAILABLE,j.MEDIA_HEIGHT,j.MEDIA_WIDTH]}static formatMenuItemText(e,t){return super.formatMenuItemText(e,t)}static formatRendition(e,{showBitrate:t=!1}={}){let n=`${Math.min(e.width,e.height)}p`;if(t&&e.bitrate){let t=e.bitrate/1e6;return`${n} (${`${t.toFixed(+(t<1))} Mbps`})`}return this.formatMenuItemText(n,e)}static compareRendition(e,t){return t.height===e.height?(t.bitrate??0)-(e.bitrate??0):t.height-e.height}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),t!==n)switch(e){case j.MEDIA_RENDITION_SELECTED:this.value=n??`auto`,Wb(this,qb,Jb).call(this);break;case j.MEDIA_RENDITION_LIST:Ub(this,Gb,gs(n)),Wb(this,qb,Jb).call(this);break;case j.MEDIA_HEIGHT:case j.MEDIA_WIDTH:Wb(this,qb,Jb).call(this);break}}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,Wb(this,Yb,Xb))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,Wb(this,Yb,Xb))}get anchorElement(){return this.anchor===`auto`?Zs(this).querySelector(`media-rendition-menu-button`):super.anchorElement}get mediaRenditionList(){return Vb(this,Gb)}set mediaRenditionList(e){Ub(this,Gb,e),Wb(this,qb,Jb).call(this)}get mediaRenditionSelected(){return R(this,j.MEDIA_RENDITION_SELECTED)}set mediaRenditionSelected(e){z(this,j.MEDIA_RENDITION_SELECTED,e)}get mediaHeight(){return P(this,j.MEDIA_HEIGHT)}set mediaHeight(e){F(this,j.MEDIA_HEIGHT,e)}get mediaWidth(){return P(this,j.MEDIA_WIDTH)}set mediaWidth(e){F(this,j.MEDIA_WIDTH,e)}compareRendition(e,t){return this.constructor.compareRendition(e,t)}formatMenuItemText(e,t){return this.constructor.formatMenuItemText(e,t)}formatRendition(e,t){return this.constructor.formatRendition(e,t)}showRenditionBitrate(e){return this.mediaRenditionList.some(t=>t!==e&&t.height===e.height&&t.bitrate!==e.bitrate)}};Gb=new WeakMap,Kb=new WeakMap,qb=new WeakSet,Jb=function(){let e=!this.mediaRenditionSelected;if(Vb(this,Kb).mediaRenditionList===JSON.stringify(this.mediaRenditionList)&&Vb(this,Kb).mediaHeight===this.mediaHeight&&Vb(this,Kb).mediaWidth===this.mediaWidth&&Vb(this,Kb).isAuto===e)return;Vb(this,Kb).mediaRenditionList=JSON.stringify(this.mediaRenditionList),Vb(this,Kb).mediaHeight=this.mediaHeight,Vb(this,Kb).mediaWidth=this.mediaWidth,Vb(this,Kb).isAuto=e;let t=this.mediaRenditionList.sort(this.compareRendition.bind(this)),n=t.find(e=>e.id===this.mediaRenditionSelected);for(let e of t)e.selected=e===n;this.defaultSlot.textContent=``;for(let n of t){let t=$v({type:`radio`,text:this.formatRendition(n,{showBitrate:this.showRenditionBitrate(n)}),value:`${n.id}`,checked:n.selected&&!e});t.prepend(ey(this,`checked-indicator`)),this.defaultSlot.append(t)}let r=n&&this.showRenditionBitrate(n),i;e&&(n?i=this.formatMenuItemText(`${M(`Auto`)} \u2022 ${this.formatRendition(n,{showBitrate:r})}`,n):this.mediaHeight>0&&this.mediaWidth>0&&(i=this.formatMenuItemText(`${M(`Auto`)} (${Math.min(this.mediaWidth,this.mediaHeight)}p)`))),i||=this.formatMenuItemText(M(`Auto`));let a=$v({type:`radio`,text:i,value:`auto`,checked:e});a.dataset.description=i,a.prepend(ey(this,`checked-indicator`)),this.defaultSlot.append(a)},Yb=new WeakSet,Xb=function(){if(this.value==null)return;let e=new N.CustomEvent(k.MEDIA_RENDITION_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-rendition-menu`)||N.customElements.define(`media-rendition-menu`,Zb);var Qb=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}function ex(){return M(`Quality`)}var tx=class extends Fy{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_RENDITION_SELECTED,j.MEDIA_RENDITION_UNAVAILABLE,j.MEDIA_HEIGHT]}connectedCallback(){super.connectedCallback(),this.setAttribute(`aria-label`,M(`quality`))}get invokeTargetElement(){return this.invokeTarget==null?Zs(this).querySelector(`media-rendition-menu`):super.invokeTargetElement}get mediaRenditionSelected(){return R(this,j.MEDIA_RENDITION_SELECTED)}set mediaRenditionSelected(e){z(this,j.MEDIA_RENDITION_SELECTED,e)}get mediaHeight(){return P(this,j.MEDIA_HEIGHT)}set mediaHeight(e){F(this,j.MEDIA_HEIGHT,e)}};tx.getSlotTemplateHTML=$b,tx.getTooltipContentHTML=ex,N.customElements.get(`media-rendition-menu-button`)||N.customElements.define(`media-rendition-menu-button`,tx);var nx=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},rx=(e,t,n)=>(nx(e,t,`read from private field`),n?n.call(e):t.get(e)),ix=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},ax=(e,t,n,r)=>(nx(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),ox=(e,t,n)=>(nx(e,t,`access private method`),n),sx,cx,lx,ux,dx,fx,px,mx,hx,gx,_x,vx,yx,bx,xx;function Sx(e){return`
      ${ry.getTemplateHTML(e)}
      <style>
        :host {
          --_menu-bg: rgb(20 20 30 / .8);
    ...
    `}var Cx=class extends ry{constructor(){super(),ix(this,cx),ix(this,ux),ix(this,fx),ix(this,mx),ix(this,_x),ix(this,sx,!1),ix(this,gx,e=>{let t=e.target,n=t?.nodeName===`VIDEO`,r=ox(this,mx,hx).call(this,t);(n||r)&&(rx(this,sx)?ox(this,ux,dx).call(this):ox(this,_x,vx).call(this,e))}),ix(this,yx,e=>{let t=e.target,n=this.contains(t),r=e.button===2,i=t?.nodeName===`VIDEO`,a=ox(this,mx,hx).call(this,t);n||r&&(i||a)||ox(this,ux,dx).call(this)}),ix(this,bx,e=>{e.key===`Escape`&&ox(this,ux,dx).call(this)}),ix(this,xx,e=>{let t=e.target;if(t.matches?.call(t,`button[invoke="copy"]`)){let e=t.closest(`media-context-menu-item`)?.querySelector(`input[slot="copy"]`);e&&navigator.clipboard.writeText(e.value)}ox(this,ux,dx).call(this)}),this.setAttribute(`noautohide`,``),ox(this,cx,lx).call(this)}connectedCallback(){super.connectedCallback(),Zs(this).addEventListener(`contextmenu`,rx(this,gx)),this.addEventListener(`click`,rx(this,xx))}disconnectedCallback(){super.disconnectedCallback(),Zs(this).removeEventListener(`contextmenu`,rx(this,gx)),this.removeEventListener(`click`,rx(this,xx)),document.removeEventListener(`mousedown`,rx(this,yx)),document.removeEventListener(`keydown`,rx(this,bx))}};sx=new WeakMap,cx=new WeakSet,lx=function(){this.hidden=!rx(this,sx)},ux=new WeakSet,dx=function(){ax(this,sx,!1),ox(this,cx,lx).call(this)},fx=new WeakSet,px=function(){document.querySelectorAll(`media-context-menu`).forEach(e=>{var t;e!==this&&ox(t=e,ux,dx).call(t)})},mx=new WeakSet,hx=function(e){return e?e.hasAttribute(`slot`)&&e.getAttribute(`slot`)===`media`?!0:e.nodeName.includes(`-`)&&e.tagName.includes(`-`)?e.hasAttribute(`src`)||e.hasAttribute(`poster`)||e.hasAttribute(`preload`)||e.hasAttribute(`playsinline`):!1:!1},gx=new WeakMap,_x=new WeakSet,vx=function(e){e.preventDefault(),ox(this,fx,px).call(this),ax(this,sx,!0),this.style.position=`fixed`,this.style.left=`${e.clientX}px`,this.style.top=`${e.clientY}px`,ox(this,cx,lx).call(this),document.addEventListener(`mousedown`,rx(this,yx),{once:!0}),document.addEventListener(`keydown`,rx(this,bx),{once:!0})},yx=new WeakMap,bx=new WeakMap,xx=new WeakMap,Cx.getTemplateHTML=Sx,N.customElements.get(`media-context-menu`)||N.customElements.define(`media-context-menu`,Cx);function wx(e){return`
    ${Dy.getTemplateHTML.call(this,e)}
    <style>
        ::slotted(*) {
  ...
  `}var Tx=class extends Dy{};Tx.shadowRootOptions={mode:`open`},Tx.getTemplateHTML=wx,N.customElements.get(`media-context-menu-item`)||N.customElements.define(`media-context-menu-item`,Tx);var Ex=e=>{throw TypeError(e)},Dx=(e,t,n)=>t.has(e)||Ex(`Cannot `+n),X=(e,t,n)=>(Dx(e,t,`read from private field`),n?n.call(e):t.get(e)),Ox=(e,t,n)=>t.has(e)?Ex(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),kx=(e,t,n,r)=>(Dx(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Ax=(e,t,n)=>(Dx(e,t,`access private method`),n),jx=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends jx{}globalThis.DocumentFragment=e}var Mx=class extends jx{},Nx=class extends jx{},Px={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(Mx)}},Fx,Ix=class{constructor(e,t={}){Ox(this,Fx),kx(this,Fx,t?.detail)}get detail(){return X(this,Fx)}initCustomEvent(){}};Fx=new WeakMap;function Lx(e,t){return new Mx}var Rx={document:{createElement:Lx},DocumentFragment,customElements:Px,CustomEvent:Ix,EventTarget:jx,HTMLElement:Mx,HTMLVideoElement:Nx},zx=typeof window>`u`||globalThis.customElements===void 0,Bx=zx?Rx:globalThis,Vx=zx?Rx.document:globalThis.document;function Hx(e){let t=``;return Object.entries(e).forEach(([e,n])=>{n!=null&&(t+=`${Ux(e)}: ${n}; `)}),t?t.trim():void 0}function Ux(e){return e.replace(/([a-z])([A-Z])/g,`$1-$2`).toLowerCase()}function Wx(e){return e.replace(/[-_]([a-z])/g,(e,t)=>t.toUpperCase())}function Gx(e){if(e==null)return;let t=+e;return Number.isNaN(t)?void 0:t}function Kx(e){let t=qx(e).toString();return t?`?`+t:``}function qx(e){let t={};for(let n in e)e[n]!=null&&(t[n]=e[n]);return new URLSearchParams(t)}var Jx=(e,t)=>!e||!t?!1:e.contains(t)?!0:Jx(e,t.getRootNode().host),Yx=`mux.com`,Xx=(()=>{try{return`3.13.0`}catch{}return`UNKNOWN`})(),Zx=()=>Xx,Qx=(e,{token:t,customDomain:n=Yx,thumbnailTime:r,programTime:i}={})=>{let a=t==null?r:void 0,{aud:o}=Lr(t)??{};if(!(t&&o!==`t`))return`https://image.${n}/${e}/thumbnail.webp${Kx({token:t,time:a,program_time:i})}`},$x=(e,{token:t,customDomain:n=Yx,programStartTime:r,programEndTime:i}={})=>{let{aud:a}=Lr(t)??{};if(!(t&&a!==`s`))return`https://image.${n}/${e}/storyboard.vtt${Kx({token:t,format:`webp`,program_start_time:r,program_end_time:i})}`},eS=e=>{if(e){if([T.LIVE,T.ON_DEMAND].includes(e))return e;if(e!=null&&e.includes(`live`))return T.LIVE}},tS={crossorigin:`crossOrigin`,playsinline:`playsInline`};function nS(e){return tS[e]??Wx(e)}var rS,iS,aS,oS=class{constructor(e,t){Ox(this,rS),Ox(this,iS),Ox(this,aS,[]),kx(this,rS,e),kx(this,iS,t)}[Symbol.iterator](){return X(this,aS).values()}get length(){return X(this,aS).length}get value(){return X(this,aS).join(` `)??``}set value(e){e!==this.value&&(kx(this,aS,[]),this.add(...e?.split(` `)??[]))}toString(){return this.value}item(e){return X(this,aS)[e]}values(){return X(this,aS).values()}keys(){return X(this,aS).keys()}forEach(e){X(this,aS).forEach(e)}add(...e){var t,n;e.forEach(e=>{this.contains(e)||X(this,aS).push(e)}),!(this.value===``&&!((t=X(this,rS))!=null&&t.hasAttribute(`${X(this,iS)}`)))&&((n=X(this,rS))==null||n.setAttribute(`${X(this,iS)}`,`${this.value}`))}remove(...e){var t;e.forEach(e=>{X(this,aS).splice(X(this,aS).indexOf(e),1)}),(t=X(this,rS))==null||t.setAttribute(`${X(this,iS)}`,`${this.value}`)}contains(e){return X(this,aS).includes(e)}toggle(e,t){return t===void 0?this.contains(e)?(this.remove(e),!1):(this.add(e),!0):t?(this.add(e),!0):(this.remove(e),!1)}replace(e,t){this.remove(e),this.add(t)}};rS=new WeakMap,iS=new WeakMap,aS=new WeakMap;var sS=`[mux-player ${Zx()}]`;function cS(...e){console.warn(sS,...e)}function lS(...e){console.error(sS,...e)}function uS(e){let t=e.message??``;e.context&&(t+=` ${e.context}`),e.file&&(t+=` ${E(`Read more: `)}
https://github.com/muxinc/elements/blob/main/errors/${e.file}`),cS(t)}var dS={AUTOPLAY:`autoplay`,CROSSORIGIN:`crossorigin`,LOOP:`loop`,MUTED:`muted`,PLAYSINLINE:`playsinline`,PRELOAD:`preload`},fS={VOLUME:`volume`,PLAYBACKRATE:`playbackrate`,MUTED:`muted`};({...dS,...fS});var pS=Object.freeze({length:0,start(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'start' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0},end(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'end' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0}}),mS=Object.values(dS).filter(e=>dS.PLAYSINLINE!==e),hS=Object.values(fS),gS=[...mS,...hS],_S=class extends Bx.HTMLElement{static get observedAttributes(){return gS}constructor(){super()}attributeChangedCallback(e,t,n){switch(e){case fS.MUTED:this.media&&(this.media.muted=n!=null,this.media.defaultMuted=n!=null);return;case fS.VOLUME:{let e=Gx(n)??1;this.media&&(this.media.volume=e);return}case fS.PLAYBACKRATE:{let e=Gx(n)??1;this.media&&(this.media.playbackRate=e,this.media.defaultPlaybackRate=e);return}}}play(){return this.media?.play()??Promise.reject()}pause(){var e;(e=this.media)==null||e.pause()}load(){var e;(e=this.media)==null||e.load()}get media(){return this.shadowRoot?.querySelector(`mux-video`)}get audioTracks(){return this.media.audioTracks}get videoTracks(){return this.media.videoTracks}get audioRenditions(){return this.media.audioRenditions}get videoRenditions(){return this.media.videoRenditions}get paused(){return this.media?.paused??!0}get duration(){return this.media?.duration??NaN}get ended(){return this.media?.ended??!1}get buffered(){return this.media?.buffered??pS}get seekable(){return this.media?.seekable??pS}get readyState(){return this.media?.readyState??0}get videoWidth(){return this.media?.videoWidth??0}get videoHeight(){return this.media?.videoHeight??0}get currentSrc(){return this.media?.currentSrc??``}get currentTime(){return this.media?.currentTime??0}set currentTime(e){this.media&&(this.media.currentTime=Number(e))}get volume(){return this.media?.volume??1}set volume(e){this.media&&(this.media.volume=Number(e))}get playbackRate(){return this.media?.playbackRate??1}set playbackRate(e){this.media&&(this.media.playbackRate=Number(e))}get defaultPlaybackRate(){return Gx(this.getAttribute(fS.PLAYBACKRATE))??1}set defaultPlaybackRate(e){e==null?this.removeAttribute(fS.PLAYBACKRATE):this.setAttribute(fS.PLAYBACKRATE,`${e}`)}get crossOrigin(){return vS(this,dS.CROSSORIGIN)}set crossOrigin(e){this.setAttribute(dS.CROSSORIGIN,`${e}`)}get autoplay(){return vS(this,dS.AUTOPLAY)!=null}set autoplay(e){e?this.setAttribute(dS.AUTOPLAY,typeof e==`string`?e:``):this.removeAttribute(dS.AUTOPLAY)}get loop(){return vS(this,dS.LOOP)!=null}set loop(e){e?this.setAttribute(dS.LOOP,``):this.removeAttribute(dS.LOOP)}get muted(){return this.media?.muted??!1}set muted(e){this.media&&(this.media.muted=!!e)}get defaultMuted(){return vS(this,dS.MUTED)!=null}set defaultMuted(e){e?this.setAttribute(dS.MUTED,``):this.removeAttribute(dS.MUTED)}get playsInline(){return vS(this,dS.PLAYSINLINE)!=null}set playsInline(e){lS(`playsInline is set to true by default and is not currently supported as a setter.`)}get preload(){return this.media?this.media.preload:this.getAttribute(`preload`)}set preload(e){[``,`none`,`metadata`,`auto`].includes(e)?this.setAttribute(dS.PRELOAD,e):this.removeAttribute(dS.PRELOAD)}};function vS(e,t){return e.media?e.media.getAttribute(t):e.getAttribute(t)}var yS=_S,bS=`:host {
...
`,xS=new WeakMap,SS=class e{constructor(e,t){this.element=e,this.type=t,this.element.addEventListener(this.type,this);let n=xS.get(this.element);n&&n.set(this.type,this)}set(e){if(typeof e==`function`)this.handleEvent=e.bind(this.element);else if(typeof e==`object`&&typeof e.handleEvent==`function`)this.handleEvent=e.handleEvent.bind(e);else{this.element.removeEventListener(this.type,this);let e=xS.get(this.element);e&&e.delete(this.type)}}static for(t){xS.has(t.element)||xS.set(t.element,new Map);let n=t.attributeName.slice(2),r=xS.get(t.element);return r&&r.has(n)?r.get(n):new e(t.element,n)}};function CS(e,t){return e instanceof m_&&e.attributeName.startsWith(`on`)?(SS.for(e).set(t),e.element.removeAttributeNS(e.attributeNamespace,e.attributeName),!0):!1}function wS(e,t){return t instanceof PS&&e instanceof h_?(t.renderInto(e),!0):!1}function TS(e,t){return t instanceof DocumentFragment&&e instanceof h_?(t.childNodes.length&&e.replace(...t.childNodes),!0):!1}function ES(e,t){if(e instanceof m_){let n=e.attributeNamespace,r=e.element.getAttributeNS(n,e.attributeName);return String(t)!==r&&(e.value=String(t)),!0}return e.value=String(t),!0}function DS(e,t){if(e instanceof m_&&t instanceof Element){let n=e.element;return n[e.attributeName]!==t&&(e.element.removeAttributeNS(e.attributeNamespace,e.attributeName),n[e.attributeName]=t),!0}return!1}function OS(e,t){if(typeof t==`boolean`&&e instanceof m_){let n=e.attributeNamespace;return t!==e.element.hasAttributeNS(n,e.attributeName)&&(e.booleanValue=t),!0}return!1}function kS(e,t){return t===!1&&e instanceof h_?(e.replace(``),!0):!1}function AS(e,t){DS(e,t)||OS(e,t)||CS(e,t)||kS(e,t)||wS(e,t)||TS(e,t)||ES(e,t)}var jS=new Map,MS=new WeakMap,NS=new WeakMap,PS=class{constructor(e,t,n){this.strings=e,this.values=t,this.processor=n,this.stringsKey=this.strings.join(``)}get template(){if(jS.has(this.stringsKey))return jS.get(this.stringsKey);{let e=Vx.createElement(`template`),t=this.strings.length-1;return e.innerHTML=this.strings.reduce((e,n,r)=>e+n+(r<t?`{{ ${r} }}`:``),``),jS.set(this.stringsKey,e),e}}renderInto(e){var t;let n=this.template;if(MS.get(e)!==n){MS.set(e,n);let t=new o_(n,this.values,this.processor);NS.set(e,t),e instanceof h_?e.replace(...t.children):e.appendChild(t);return}let r=NS.get(e);(t=r?.update)==null||t.call(r,this.values)}},FS={processCallback(e,t,n){if(n)for(let[e,r]of t)e in n&&AS(r,n[e]??``)}};function IS(e,...t){return new PS(e,t,FS)}function LS(e,t){e.renderInto(t)}var RS=e=>{let{tokens:t}=e;return t.drm?`:host(:not([cast-receiver])) { --_cast-button-drm-display: none; }`:``},zS=e=>IS`
  <style>
    ${RS(e)}
    ${bS}
  </style>
  ${HS(e)}
`,BS=e=>{let t=e.hotKeys?`${e.hotKeys}`:``;return eS(e.streamType)===`live`&&(t+=` noarrowleft noarrowright`),t},VS=Object.values({TOP:`top`,CENTER:`center`,BOTTOM:`bottom`,LAYER:`layer`,MEDIA_LAYER:`media-layer`,POSTER_LAYER:`poster-layer`,VERTICAL_LAYER:`vertical-layer`,CENTERED_LAYER:`centered-layer`,GESTURE_LAYER:`gesture-layer`,CONTROLLER_LAYER:`controller`,BUTTON:`button`,RANGE:`range`,THUMB:`thumb`,DISPLAY:`display`,CONTROL_BAR:`control-bar`,MENU_BUTTON:`menu-button`,MENU:`menu`,MENU_ITEM:`menu-item`,OPTION:`option`,POSTER:`poster`,LIVE:`live`,PLAY:`play`,PRE_PLAY:`pre-play`,SEEK_BACKWARD:`seek-backward`,SEEK_FORWARD:`seek-forward`,MUTE:`mute`,CAPTIONS:`captions`,AIRPLAY:`airplay`,PIP:`pip`,FULLSCREEN:`fullscreen`,CAST:`cast`,PLAYBACK_RATE:`playback-rate`,VOLUME:`volume`,TIME:`time`,TITLE:`title`,AUDIO_TRACK:`audio-track`,RENDITION:`rendition`}).join(`, `),HS=e=>{var t;return IS`
  <media-theme
    ...
    audio="${e.audio??!1}"
    style="${Hx({"--media-primary-color":e.primaryColor,"--media-secondary-color":e.secondaryColor,"--media-accent-color":e.accentColor})??!1}"
  ...
  >
    ...
    >
      ${e.storyboard?IS`<track label="thumbnails" default kind="metadata" src="${e.storyboard}" />`:IS``}
      <slot></slot>
    </mux-video>
...
`,XS=Vx.createElement(`template`);`innerHTML`in XS&&(XS.innerHTML=YS);var ZS=class extends J_{};ZS.template=XS.content?.children?.[0],Bx.customElements.get(`media-theme-gerwig`)||Bx.customElements.define(`media-theme-gerwig`,ZS);var QS=`gerwig`,$S={SRC:`src`,POSTER:`poster`},Z={STYLE:`style`,DEFAULT_HIDDEN_CAPTIONS:`default-hidden-captions`,PRIMARY_COLOR:`primary-color`,SECONDARY_COLOR:`secondary-color`,ACCENT_COLOR:`accent-color`,FORWARD_SEEK_OFFSET:`forward-seek-offset`,BACKWARD_SEEK_OFFSET:`backward-seek-offset`,PLAYBACK_TOKEN:`playback-token`,THUMBNAIL_TOKEN:`thumbnail-token`,STORYBOARD_TOKEN:`storyboard-token`,FULLSCREEN_ELEMENT:`fullscreen-element`,DRM_TOKEN:`drm-token`,STORYBOARD_SRC:`storyboard-src`,THUMBNAIL_TIME:`thumbnail-time`,AUDIO:`audio`,NOHOTKEYS:`nohotkeys`,HOTKEYS:`hotkeys`,PLAYBACK_RATES:`playbackrates`,DEFAULT_SHOW_REMAINING_TIME:`default-show-remaining-time`,DEFAULT_DURATION:`default-duration`,TITLE:`title`,VIDEO_TITLE:`video-title`,PLACEHOLDER:`placeholder`,THEME:`theme`,DEFAULT_STREAM_TYPE:`default-stream-type`,TARGET_LIVE_WINDOW:`target-live-window`,EXTRA_SOURCE_PARAMS:`extra-source-params`,NO_VOLUME_PREF:`no-volume-pref`,NO_MUTED_PREF:`no-muted-pref`,CAST_RECEIVER:`cast-receiver`,NO_TOOLTIPS:`no-tooltips`,PROUDLY_DISPLAY_MUX_BADGE:`proudly-display-mux-badge`,DISABLE_PSEUDO_ENDED:`disable-pseudo-ended`},eC=[`audio`,`backwardseekoffset`,`defaultduration`,`defaultshowremainingtime`,`defaultsubtitles`,`noautoseektolive`,`disabled`,`exportparts`,`forwardseekoffset`,`hideduration`,`hotkeys`,`nohotkeys`,`playbackrates`,`defaultstreamtype`,`streamtype`,`style`,`targetlivewindow`,`template`,`title`,`videotitle`,`novolumepref`,`nomutedpref`,`proudlydisplaymuxbadge`];function tC(e,t){return{src:!e.playbackId&&e.src,playbackId:e.playbackId,hasSrc:!!e.playbackId||!!e.src||!!e.currentSrc,poster:e.poster,storyboard:e.media?.currentSrc&&e.storyboard,storyboardSrc:e.getAttribute(Z.STORYBOARD_SRC),fullscreenElement:e.getAttribute(Z.FULLSCREEN_ELEMENT),placeholder:e.getAttribute(`placeholder`),themeTemplate:rC(e),thumbnailTime:!e.tokens.thumbnail&&e.thumbnailTime,autoplay:e.autoplay,crossOrigin:e.crossOrigin,loop:e.loop,noHotKeys:e.hasAttribute(Z.NOHOTKEYS),hotKeys:e.getAttribute(Z.HOTKEYS),muted:e.muted,paused:e.paused,preload:e.preload,envKey:e.envKey,preferCmcd:e.preferCmcd,debug:e.debug,disableTracking:e.disableTracking,disableCookies:e.disableCookies,tokens:e.tokens,beaconCollectionDomain:e.beaconCollectionDomain,maxResolution:e.maxResolution,minResolution:e.minResolution,maxAutoResolution:e.maxAutoResolution,programStartTime:e.programStartTime,programEndTime:e.programEndTime,assetStartTime:e.assetStartTime,assetEndTime:e.assetEndTime,renditionOrder:e.renditionOrder,metadata:e.metadata,playerInitTime:e.playerInitTime,playerSoftwareName:e.playerSoftwareName,playerSoftwareVersion:e.playerSoftwareVersion,startTime:e.startTime,initialBandwidthEstimateKbps:e.initialBandwidthEstimateKbps,initialEstimateSegments:e.initialEstimateSegments,minPreloadSegments:e.minPreloadSegments,preferPlayback:e.preferPlayback,audio:e.audio,defaultStreamType:e.defaultStreamType,targetLiveWindow:e.getAttribute(O.TARGET_LIVE_WINDOW),streamType:eS(e.getAttribute(O.STREAM_TYPE)),primaryColor:e.getAttribute(Z.PRIMARY_COLOR),secondaryColor:e.getAttribute(Z.SECONDARY_COLOR),accentColor:e.getAttribute(Z.ACCENT_COLOR),forwardSeekOffset:e.forwardSeekOffset,backwardSeekOffset:e.backwardSeekOffset,defaultHiddenCaptions:e.defaultHiddenCaptions,defaultDuration:e.defaultDuration,defaultShowRemainingTime:e.defaultShowRemainingTime,hideDuration:iC(e),playbackRates:e.getAttribute(Z.PLAYBACK_RATES),customDomain:e.getAttribute(O.CUSTOM_DOMAIN)??void 0,title:e.getAttribute(Z.TITLE),videoTitle:e.getAttribute(Z.VIDEO_TITLE)??e.getAttribute(Z.TITLE),novolumepref:e.hasAttribute(Z.NO_VOLUME_PREF),nomutedpref:e.hasAttribute(Z.NO_MUTED_PREF),proudlyDisplayMuxBadge:e.hasAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE),castReceiver:e.castReceiver,disablePseudoEnded:e.hasAttribute(Z.DISABLE_PSEUDO_ENDED),capRenditionToPlayerSize:e.capRenditionToPlayerSize,...t,extraSourceParams:e.extraSourceParams}}var nC=lp.formatErrorMessage;lp.formatErrorMessage=e=>{if(e instanceof w){let t=KS(e,!1);return`
    ...
    `}return nC(e)};function rC(e){var t;let n=e.theme;if(n){let r=((t=e.getRootNode())?.getElementById)?.call(t,n);if(r&&r instanceof HTMLTemplateElement)return r;n.startsWith(`media-theme-`)||(n=`media-theme-${n}`);let i=Bx.customElements.get(n);if(i!=null&&i.template)return i.template}}function iC(e){let t=e.mediaController?.querySelector(`media-time-display`);return t&&getComputedStyle(t).getPropertyValue(`--media-duration-display-display`).trim()===`none`}function aC(e){let t=e.videoTitle?{video_title:e.videoTitle}:{};return e.getAttributeNames().filter(e=>e.startsWith(`metadata-`)).reduce((t,n)=>{let r=e.getAttribute(n);return r!==null&&(t[n.replace(/^metadata-/,``).replace(/-/g,`_`)]=r),t},t)}var oC=Object.values(O),sC=Object.values($S),cC=Object.values(Z),lC=Zx(),uC=`mux-player`,dC={isDialogOpen:!1},fC={redundant_streams:!0},pC,mC,hC,gC,_C,vC,yC,bC,xC,SC,CC,wC,Q,TC,EC,DC,OC,kC,AC,jC,MC,NC=class extends yS{constructor(){super(),Ox(this,Q),Ox(this,pC),Ox(this,mC,!1),Ox(this,hC,{}),Ox(this,gC,!0),Ox(this,_C,new oS(this,`hotkeys`)),Ox(this,vC),Ox(this,yC,()=>Ax(this,Q,OC).call(this)),Ox(this,bC,()=>Ax(this,Q,OC).call(this)),Ox(this,xC,()=>Ax(this,Q,OC).call(this)),Ox(this,SC),Ox(this,CC,{...dC,onCloseErrorDialog:e=>{e.composedPath()[0]?.localName===`media-error-dialog`&&Ax(this,Q,DC).call(this,{isDialogOpen:!1})},onFocusInErrorDialog:e=>{e.composedPath()[0]?.localName===`media-error-dialog`&&(Jx(this,Vx.activeElement)||e.preventDefault())}}),Ox(this,wC,e=>{let t=this.media?.error;if(!(t instanceof w)){let{message:e,code:n}=t??{};t=new w(e,n)}if(!(t!=null&&t.fatal)){cS(t),t.data&&cS(`${t.name} data:`,t.data);return}let n=JS(t,!1);n.message&&uS(n),lS(t),t.data&&lS(`${t.name} data:`,t.data),Ax(this,Q,DC).call(this,{isDialogOpen:!0})}),kx(this,pC,na()),this.attachShadow({mode:`open`}),Ax(this,Q,EC).call(this),this.isConnected&&Ax(this,Q,TC).call(this)}static get NAME(){return uC}static get VERSION(){return lC}static get observedAttributes(){return[...yS.observedAttributes??[],...sC,...oC,...cC]}get mediaTheme(){return this.shadowRoot?.querySelector(`media-theme`)}get mediaController(){return(this.mediaTheme?.shadowRoot)?.querySelector(`media-controller`)}connectedCallback(){Ax(this,Q,TC).call(this);let e=this.media;e&&(e.metadata=aC(this))}disconnectedCallback(){var e,t,n,r,i,a;(e=X(this,vC))==null||e.disconnect(),(t=this.media)==null||t.removeEventListener(`streamtypechange`,X(this,yC)),(n=this.media)==null||n.removeEventListener(`loadstart`,X(this,bC)),this.removeEventListener(`error`,X(this,wC)),this.media&&(this.media.errorTranslator=void 0),(r=this.media?.textTracks)==null||r.removeEventListener(`addtrack`,X(this,xC)),(i=this.media?.textTracks)==null||i.removeEventListener(`removetrack`,X(this,xC)),(a=X(this,SC))==null||a.call(this),kx(this,SC,void 0),kx(this,mC,!1)}attributeChangedCallback(e,t,n){switch(Ax(this,Q,TC).call(this),super.attributeChangedCallback(e,t,n),e){case Z.HOTKEYS:X(this,_C).value=n;break;case Z.THUMBNAIL_TIME:n!=null&&this.tokens.thumbnail&&cS(E(`Use of thumbnail-time with thumbnail-token is currently unsupported. Ignore thumbnail-time.`).toString());break;case Z.THUMBNAIL_TOKEN:if(n){let e=Lr(n);if(e){let{aud:t}=e,n=bi.THUMBNAIL;t!==n&&cS(E(`The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.`).format({aud:t,expectedAud:n,tokenNamePrefix:`thumbnail`}))}}break;case Z.STORYBOARD_TOKEN:if(n){let e=Lr(n);if(e){let{aud:t}=e,n=bi.STORYBOARD;t!==n&&cS(E(`The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.`).format({aud:t,expectedAud:n,tokenNamePrefix:`storyboard`}))}}break;case Z.DRM_TOKEN:if(n){let e=Lr(n);if(e){let{aud:t}=e,n=bi.DRM;t!==n&&cS(E(`The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.`).format({aud:t,expectedAud:n,tokenNamePrefix:`drm`}))}}break;case O.PLAYBACK_ID:n!=null&&n.includes(`?token`)&&lS(E(`The specificed playback ID {playbackId} contains a token which must be provided via the playback-token attribute.`).format({playbackId:n}));break;case O.STREAM_TYPE:n&&![T.LIVE,T.ON_DEMAND,T.UNKNOWN].includes(n)?[`ll-live`,`live:dvr`,`ll-live:dvr`].includes(this.streamType)?this.targetLiveWindow=n.includes(`dvr`)?1/0:0:uS({file:`invalid-stream-type.md`,message:E("Invalid stream-type value supplied: `{streamType}`. Please provide stream-type as either: `on-demand` or `live`").format({streamType:this.streamType})}):n===T.LIVE?this.getAttribute(Z.TARGET_LIVE_WINDOW)??(this.targetLiveWindow=0):this.targetLiveWindow=NaN;break;case Z.FULLSCREEN_ELEMENT:if(n!=null||n!==t){let e=Vx.getElementById(n),t=e?.querySelector(`mux-player`);this.mediaController&&e&&t&&(this.mediaController.fullscreenElement=e)}break;case O.CAP_RENDITION_TO_PLAYER_SIZE:(n==null||n!==t)&&(this.capRenditionToPlayerSize=n==null?void 0:!0);break}[O.PLAYBACK_ID,$S.SRC,Z.PLAYBACK_TOKEN].includes(e)&&t!==n&&kx(this,CC,{...X(this,CC),...dC}),Ax(this,Q,OC).call(this,{[nS(e)]:n})}async requestFullscreen(e){var t;if(!(!this.mediaController||this.mediaController.hasAttribute(j.MEDIA_IS_FULLSCREEN)))return(t=this.mediaController)==null||t.dispatchEvent(new Bx.CustomEvent(k.MEDIA_ENTER_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0})),new Promise((e,t)=>{var n;(n=this.mediaController)==null||n.addEventListener(ss.MEDIA_IS_FULLSCREEN,()=>e(),{once:!0})})}async exitFullscreen(){var e;if(!(!this.mediaController||!this.mediaController.hasAttribute(j.MEDIA_IS_FULLSCREEN)))return(e=this.mediaController)==null||e.dispatchEvent(new Bx.CustomEvent(k.MEDIA_EXIT_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0})),new Promise((e,t)=>{var n;(n=this.mediaController)==null||n.addEventListener(ss.MEDIA_IS_FULLSCREEN,()=>e(),{once:!0})})}get preferCmcd(){return this.getAttribute(O.PREFER_CMCD)??void 0}set preferCmcd(e){e!==this.preferCmcd&&(e?vr.includes(e)?this.setAttribute(O.PREFER_CMCD,e):cS(`Invalid value for preferCmcd. Must be one of ${vr.join()}`):this.removeAttribute(O.PREFER_CMCD))}get hasPlayed(){return this.mediaController?.hasAttribute(j.MEDIA_HAS_PLAYED)??!1}get inLiveWindow(){return this.mediaController?.hasAttribute(j.MEDIA_TIME_IS_LIVE)}get _hls(){return this.media?._hls}get mux(){return this.media?.mux}get theme(){return this.getAttribute(Z.THEME)??QS}set theme(e){this.setAttribute(Z.THEME,`${e}`)}get themeProps(){let e=this.mediaTheme;if(!e)return;let t={};for(let n of e.getAttributeNames()){if(eC.includes(n))continue;let r=e.getAttribute(n);t[Wx(n)]=r===``?!0:r}return t}set themeProps(e){var t,n;Ax(this,Q,TC).call(this);let r={...this.themeProps,...e};for(let i in r){if(eC.includes(i))continue;let r=e?.[i];typeof r==`boolean`||r==null?(t=this.mediaTheme)==null||t.toggleAttribute(Ux(i),!!r):(n=this.mediaTheme)==null||n.setAttribute(Ux(i),r)}}get playbackId(){return this.getAttribute(O.PLAYBACK_ID)??void 0}set playbackId(e){e?this.setAttribute(O.PLAYBACK_ID,e):this.removeAttribute(O.PLAYBACK_ID)}get src(){return this.playbackId?PC(this,$S.SRC)??void 0:this.getAttribute($S.SRC)??void 0}set src(e){e?this.setAttribute($S.SRC,e):this.removeAttribute($S.SRC)}get poster(){let e=this.getAttribute($S.POSTER);if(e!=null)return e;let{tokens:t}=this;if(t.playback&&!t.thumbnail){cS(`Missing expected thumbnail token. No poster image will be shown`);return}if(this.playbackId&&!this.audio)return Qx(this.playbackId,{customDomain:this.customDomain,thumbnailTime:this.thumbnailTime??this.startTime,programTime:this.programStartTime,token:t.thumbnail})}set poster(e){e||e===``?this.setAttribute($S.POSTER,e):this.removeAttribute($S.POSTER)}get storyboardSrc(){return this.getAttribute(Z.STORYBOARD_SRC)??void 0}set storyboardSrc(e){e?this.setAttribute(Z.STORYBOARD_SRC,e):this.removeAttribute(Z.STORYBOARD_SRC)}get storyboard(){let{tokens:e}=this;if(this.storyboardSrc&&!e.storyboard)return this.storyboardSrc;if(!(this.audio||!this.playbackId||!this.streamType||[T.LIVE,T.UNKNOWN].includes(this.streamType)||e.playback&&!e.storyboard))return $x(this.playbackId,{customDomain:this.customDomain,token:e.storyboard,programStartTime:this.programStartTime,programEndTime:this.programEndTime})}get audio(){return this.hasAttribute(Z.AUDIO)}set audio(e){if(!e){this.removeAttribute(Z.AUDIO);return}this.setAttribute(Z.AUDIO,``)}get hotkeys(){return X(this,_C)}get nohotkeys(){return this.hasAttribute(Z.NOHOTKEYS)}set nohotkeys(e){if(!e){this.removeAttribute(Z.NOHOTKEYS);return}this.setAttribute(Z.NOHOTKEYS,``)}get thumbnailTime(){return Gx(this.getAttribute(Z.THUMBNAIL_TIME))}set thumbnailTime(e){this.setAttribute(Z.THUMBNAIL_TIME,`${e}`)}get videoTitle(){return this.getAttribute(Z.VIDEO_TITLE)??this.getAttribute(Z.TITLE)??``}set videoTitle(e){e!==this.videoTitle&&(e?this.setAttribute(Z.VIDEO_TITLE,e):this.removeAttribute(Z.VIDEO_TITLE))}get placeholder(){return PC(this,Z.PLACEHOLDER)??``}set placeholder(e){this.setAttribute(Z.PLACEHOLDER,`${e}`)}get primaryColor(){let e=this.getAttribute(Z.PRIMARY_COLOR);if(e!=null||this.mediaTheme&&(e=(Bx.getComputedStyle(this.mediaTheme)?.getPropertyValue(`--_primary-color`))?.trim(),e))return e}set primaryColor(e){this.setAttribute(Z.PRIMARY_COLOR,`${e}`)}get secondaryColor(){let e=this.getAttribute(Z.SECONDARY_COLOR);if(e!=null||this.mediaTheme&&(e=(Bx.getComputedStyle(this.mediaTheme)?.getPropertyValue(`--_secondary-color`))?.trim(),e))return e}set secondaryColor(e){this.setAttribute(Z.SECONDARY_COLOR,`${e}`)}get accentColor(){let e=this.getAttribute(Z.ACCENT_COLOR);if(e!=null||this.mediaTheme&&(e=(Bx.getComputedStyle(this.mediaTheme)?.getPropertyValue(`--_accent-color`))?.trim(),e))return e}set accentColor(e){this.setAttribute(Z.ACCENT_COLOR,`${e}`)}get defaultShowRemainingTime(){return this.hasAttribute(Z.DEFAULT_SHOW_REMAINING_TIME)}set defaultShowRemainingTime(e){e?this.setAttribute(Z.DEFAULT_SHOW_REMAINING_TIME,``):this.removeAttribute(Z.DEFAULT_SHOW_REMAINING_TIME)}get playbackRates(){if(this.hasAttribute(Z.PLAYBACK_RATES))return this.getAttribute(Z.PLAYBACK_RATES).trim().split(/\s*,?\s+/).map(e=>Number(e)).filter(e=>!Number.isNaN(e)).sort((e,t)=>e-t)}set playbackRates(e){if(!e){this.removeAttribute(Z.PLAYBACK_RATES);return}this.setAttribute(Z.PLAYBACK_RATES,e.join(` `))}get forwardSeekOffset(){return Gx(this.getAttribute(Z.FORWARD_SEEK_OFFSET))??10}set forwardSeekOffset(e){this.setAttribute(Z.FORWARD_SEEK_OFFSET,`${e}`)}get backwardSeekOffset(){return Gx(this.getAttribute(Z.BACKWARD_SEEK_OFFSET))??10}set backwardSeekOffset(e){this.setAttribute(Z.BACKWARD_SEEK_OFFSET,`${e}`)}get defaultHiddenCaptions(){return this.hasAttribute(Z.DEFAULT_HIDDEN_CAPTIONS)}set defaultHiddenCaptions(e){e?this.setAttribute(Z.DEFAULT_HIDDEN_CAPTIONS,``):this.removeAttribute(Z.DEFAULT_HIDDEN_CAPTIONS)}get defaultDuration(){return Gx(this.getAttribute(Z.DEFAULT_DURATION))}set defaultDuration(e){e==null?this.removeAttribute(Z.DEFAULT_DURATION):this.setAttribute(Z.DEFAULT_DURATION,`${e}`)}get playerInitTime(){return this.hasAttribute(O.PLAYER_INIT_TIME)?Gx(this.getAttribute(O.PLAYER_INIT_TIME)):X(this,pC)}set playerInitTime(e){e!=this.playerInitTime&&(e==null?this.removeAttribute(O.PLAYER_INIT_TIME):this.setAttribute(O.PLAYER_INIT_TIME,`${+e}`))}get playerSoftwareName(){return this.getAttribute(O.PLAYER_SOFTWARE_NAME)??uC}get playerSoftwareVersion(){return this.getAttribute(O.PLAYER_SOFTWARE_VERSION)??lC}get beaconCollectionDomain(){return this.getAttribute(O.BEACON_COLLECTION_DOMAIN)??void 0}set beaconCollectionDomain(e){e!==this.beaconCollectionDomain&&(e?this.setAttribute(O.BEACON_COLLECTION_DOMAIN,e):this.removeAttribute(O.BEACON_COLLECTION_DOMAIN))}get maxResolution(){return this.getAttribute(O.MAX_RESOLUTION)??void 0}set maxResolution(e){e!==this.maxResolution&&(e?this.setAttribute(O.MAX_RESOLUTION,e):this.removeAttribute(O.MAX_RESOLUTION))}get minResolution(){return this.getAttribute(O.MIN_RESOLUTION)??void 0}set minResolution(e){e!==this.minResolution&&(e?this.setAttribute(O.MIN_RESOLUTION,e):this.removeAttribute(O.MIN_RESOLUTION))}get maxAutoResolution(){return this.getAttribute(O.MAX_AUTO_RESOLUTION)??void 0}set maxAutoResolution(e){e==null?this.removeAttribute(O.MAX_AUTO_RESOLUTION):this.setAttribute(O.MAX_AUTO_RESOLUTION,e)}get renditionOrder(){return this.getAttribute(O.RENDITION_ORDER)??void 0}set renditionOrder(e){e!==this.renditionOrder&&(e?this.setAttribute(O.RENDITION_ORDER,e):this.removeAttribute(O.RENDITION_ORDER))}get programStartTime(){return Gx(this.getAttribute(O.PROGRAM_START_TIME))}set programStartTime(e){e==null?this.removeAttribute(O.PROGRAM_START_TIME):this.setAttribute(O.PROGRAM_START_TIME,`${e}`)}get programEndTime(){return Gx(this.getAttribute(O.PROGRAM_END_TIME))}set programEndTime(e){e==null?this.removeAttribute(O.PROGRAM_END_TIME):this.setAttribute(O.PROGRAM_END_TIME,`${e}`)}get assetStartTime(){return Gx(this.getAttribute(O.ASSET_START_TIME))}set assetStartTime(e){e==null?this.removeAttribute(O.ASSET_START_TIME):this.setAttribute(O.ASSET_START_TIME,`${e}`)}get assetEndTime(){return Gx(this.getAttribute(O.ASSET_END_TIME))}set assetEndTime(e){e==null?this.removeAttribute(O.ASSET_END_TIME):this.setAttribute(O.ASSET_END_TIME,`${e}`)}get extraSourceParams(){return this.hasAttribute(Z.EXTRA_SOURCE_PARAMS)?[...new URLSearchParams(this.getAttribute(Z.EXTRA_SOURCE_PARAMS)).entries()].reduce((e,[t,n])=>(e[t]=n,e),{}):fC}set extraSourceParams(e){e==null?this.removeAttribute(Z.EXTRA_SOURCE_PARAMS):this.setAttribute(Z.EXTRA_SOURCE_PARAMS,new URLSearchParams(e).toString())}get customDomain(){return this.getAttribute(O.CUSTOM_DOMAIN)??void 0}set customDomain(e){e!==this.customDomain&&(e?this.setAttribute(O.CUSTOM_DOMAIN,e):this.removeAttribute(O.CUSTOM_DOMAIN))}get envKey(){return PC(this,O.ENV_KEY)??void 0}set envKey(e){this.setAttribute(O.ENV_KEY,`${e}`)}get noVolumePref(){return this.hasAttribute(Z.NO_VOLUME_PREF)}set noVolumePref(e){e?this.setAttribute(Z.NO_VOLUME_PREF,``):this.removeAttribute(Z.NO_VOLUME_PREF)}get noMutedPref(){return this.hasAttribute(Z.NO_MUTED_PREF)}set noMutedPref(e){e?this.setAttribute(Z.NO_MUTED_PREF,``):this.removeAttribute(Z.NO_MUTED_PREF)}get debug(){return PC(this,O.DEBUG)!=null}set debug(e){e?this.setAttribute(O.DEBUG,``):this.removeAttribute(O.DEBUG)}get disableTracking(){return PC(this,O.DISABLE_TRACKING)!=null}set disableTracking(e){this.toggleAttribute(O.DISABLE_TRACKING,!!e)}get disableCookies(){return PC(this,O.DISABLE_COOKIES)!=null}set disableCookies(e){e?this.setAttribute(O.DISABLE_COOKIES,``):this.removeAttribute(O.DISABLE_COOKIES)}get streamType(){return this.getAttribute(O.STREAM_TYPE)??this.media?.streamType??T.UNKNOWN}set streamType(e){this.setAttribute(O.STREAM_TYPE,`${e}`)}get defaultStreamType(){return this.getAttribute(Z.DEFAULT_STREAM_TYPE)??this.mediaController?.getAttribute(Z.DEFAULT_STREAM_TYPE)??T.ON_DEMAND}set defaultStreamType(e){e?this.setAttribute(Z.DEFAULT_STREAM_TYPE,e):this.removeAttribute(Z.DEFAULT_STREAM_TYPE)}get targetLiveWindow(){return this.hasAttribute(Z.TARGET_LIVE_WINDOW)?+this.getAttribute(Z.TARGET_LIVE_WINDOW):this.media?.targetLiveWindow??NaN}set targetLiveWindow(e){e==this.targetLiveWindow||Number.isNaN(e)&&Number.isNaN(this.targetLiveWindow)||(e==null?this.removeAttribute(Z.TARGET_LIVE_WINDOW):this.setAttribute(Z.TARGET_LIVE_WINDOW,`${+e}`))}get liveEdgeStart(){return this.media?.liveEdgeStart}get startTime(){return Gx(PC(this,O.START_TIME))}set startTime(e){this.setAttribute(O.START_TIME,`${e}`)}get initialBandwidthEstimateKbps(){return Gx(PC(this,O.INITIAL_BANDWIDTH_ESTIMATE_KBPS))}set initialBandwidthEstimateKbps(e){e==null?this.removeAttribute(O.INITIAL_BANDWIDTH_ESTIMATE_KBPS):this.setAttribute(O.INITIAL_BANDWIDTH_ESTIMATE_KBPS,`${e}`)}get initialEstimateSegments(){return Gx(PC(this,O.INITIAL_ESTIMATE_SEGMENTS))}set initialEstimateSegments(e){e==null?this.removeAttribute(O.INITIAL_ESTIMATE_SEGMENTS):this.setAttribute(O.INITIAL_ESTIMATE_SEGMENTS,`${e}`)}get minPreloadSegments(){return Gx(PC(this,O.MIN_PRELOAD_SEGMENTS))}set minPreloadSegments(e){e==null?this.removeAttribute(O.MIN_PRELOAD_SEGMENTS):this.setAttribute(O.MIN_PRELOAD_SEGMENTS,`${e}`)}get preferPlayback(){let e=this.getAttribute(O.PREFER_PLAYBACK);if(e===gr.MSE||e===gr.NATIVE)return e}set preferPlayback(e){e!==this.preferPlayback&&(e===gr.MSE||e===gr.NATIVE?this.setAttribute(O.PREFER_PLAYBACK,e):this.removeAttribute(O.PREFER_PLAYBACK))}get metadata(){return this.media?.metadata}set metadata(e){if(Ax(this,Q,TC).call(this),!this.media){lS(`underlying media element missing when trying to set metadata. metadata will not be set.`);return}this.media.metadata={...aC(this),...e}}get _hlsConfig(){return this.media?._hlsConfig}set _hlsConfig(e){if(Ax(this,Q,TC).call(this),!this.media){lS(`underlying media element missing when trying to set _hlsConfig. _hlsConfig will not be set.`);return}this.media._hlsConfig=e}async addCuePoints(e){if(Ax(this,Q,TC).call(this),!this.media){lS(`underlying media element missing when trying to addCuePoints. cuePoints will not be added.`);return}return this.media?.addCuePoints(e)}get activeCuePoint(){return this.media?.activeCuePoint}get cuePoints(){return this.media?.cuePoints??[]}addChapters(e){if(Ax(this,Q,TC).call(this),!this.media){lS(`underlying media element missing when trying to addChapters. chapters will not be added.`);return}return this.media?.addChapters(e)}get activeChapter(){return this.media?.activeChapter}get chapters(){return this.media?.chapters??[]}getStartDate(){return this.media?.getStartDate()}get currentPdt(){return this.media?.currentPdt}get tokens(){let e=this.getAttribute(Z.PLAYBACK_TOKEN),t=this.getAttribute(Z.DRM_TOKEN),n=this.getAttribute(Z.THUMBNAIL_TOKEN),r=this.getAttribute(Z.STORYBOARD_TOKEN);return{...X(this,hC),...e==null?{}:{playback:e},...t==null?{}:{drm:t},...n==null?{}:{thumbnail:n},...r==null?{}:{storyboard:r}}}set tokens(e){kx(this,hC,e??{})}get playbackToken(){return this.getAttribute(Z.PLAYBACK_TOKEN)??void 0}set playbackToken(e){this.setAttribute(Z.PLAYBACK_TOKEN,`${e}`)}get drmToken(){return this.getAttribute(Z.DRM_TOKEN)??void 0}set drmToken(e){this.setAttribute(Z.DRM_TOKEN,`${e}`)}get thumbnailToken(){return this.getAttribute(Z.THUMBNAIL_TOKEN)??void 0}set thumbnailToken(e){this.setAttribute(Z.THUMBNAIL_TOKEN,`${e}`)}get storyboardToken(){return this.getAttribute(Z.STORYBOARD_TOKEN)??void 0}set storyboardToken(e){this.setAttribute(Z.STORYBOARD_TOKEN,`${e}`)}addTextTrack(e,t,n,r){let i=this.media?.nativeEl;if(i)return ei(i,e,t,n,r)}removeTextTrack(e){let t=this.media?.nativeEl;if(t)return ti(t,e)}get textTracks(){return this.media?.textTracks}get castReceiver(){return this.getAttribute(Z.CAST_RECEIVER)??void 0}set castReceiver(e){e!==this.castReceiver&&(e?this.setAttribute(Z.CAST_RECEIVER,e):this.removeAttribute(Z.CAST_RECEIVER))}get castCustomData(){return this.media?.castCustomData}set castCustomData(e){if(!this.media){lS(`underlying media element missing when trying to set castCustomData. castCustomData will not be set.`);return}this.media.castCustomData=e}get noTooltips(){return this.hasAttribute(Z.NO_TOOLTIPS)}set noTooltips(e){if(!e){this.removeAttribute(Z.NO_TOOLTIPS);return}this.setAttribute(Z.NO_TOOLTIPS,``)}get proudlyDisplayMuxBadge(){return this.hasAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE)}set proudlyDisplayMuxBadge(e){e?this.setAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE,``):this.removeAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE)}get capRenditionToPlayerSize(){return this.media?.capRenditionToPlayerSize}set capRenditionToPlayerSize(e){if(!this.media){lS(`underlying media element missing when trying to set capRenditionToPlayerSize`);return}this.media.capRenditionToPlayerSize=e}};pC=new WeakMap,mC=new WeakMap,hC=new WeakMap,gC=new WeakMap,_C=new WeakMap,vC=new WeakMap,yC=new WeakMap,bC=new WeakMap,xC=new WeakMap,SC=new WeakMap,CC=new WeakMap,wC=new WeakMap,Q=new WeakSet,TC=function(){var e,t;if(!X(this,mC)){kx(this,mC,!0),Ax(this,Q,OC).call(this);try{if(customElements.upgrade(this.mediaTheme),!(this.mediaTheme instanceof Bx.HTMLElement))throw``}catch{lS(`<media-theme> failed to upgrade!`)}try{customElements.upgrade(this.media)}catch{lS(`underlying media element failed to upgrade!`)}try{if(customElements.upgrade(this.mediaController),!(this.mediaController instanceof Ru))throw``}catch{lS(`<media-controller> failed to upgrade!`)}Ax(this,Q,kC).call(this),Ax(this,Q,AC).call(this),Ax(this,Q,jC).call(this),kx(this,gC,this.mediaController?.hasAttribute(B.USER_INACTIVE)??!0),Ax(this,Q,MC).call(this),(e=this.media)==null||e.addEventListener(`streamtypechange`,X(this,yC)),(t=this.media)==null||t.addEventListener(`loadstart`,X(this,bC))}},EC=function(){var e,t;try{(e=window==null?void 0:window.CSS)==null||e.registerProperty({name:`--media-primary-color`,syntax:`<color>`,inherits:!0}),(t=window==null?void 0:window.CSS)==null||t.registerProperty({name:`--media-secondary-color`,syntax:`<color>`,inherits:!0})}catch{}},DC=function(e){Object.assign(X(this,CC),e),Ax(this,Q,OC).call(this)},OC=function(e={}){LS(zS(tC(this,{...X(this,CC),...e})),this.shadowRoot)},kC=function(){let e=e=>{var t,n;if(!(e!=null&&e.startsWith(`theme-`)))return;let r=e.replace(/^theme-/,``);if(eC.includes(r))return;let i=this.getAttribute(e);i==null?(n=this.mediaTheme)==null||n.removeAttribute(r):(t=this.mediaTheme)==null||t.setAttribute(r,i)};kx(this,vC,new MutationObserver(t=>{for(let{attributeName:n}of t)e(n)})),X(this,vC).observe(this,{attributes:!0}),this.getAttributeNames().forEach(e)},AC=function(){this.addEventListener(`error`,X(this,wC)),this.media&&(this.media.errorTranslator=(e={})=>{if(!(this.media?.error instanceof w))return e;let t=JS(this.media?.error,!1);return{player_error_code:this.media?.error.code,player_error_message:t.message?String(t.message):e.player_error_message,player_error_context:t.context?String(t.context):e.player_error_context}})},jC=function(){var e,t;(e=this.media?.textTracks)==null||e.addEventListener(`addtrack`,X(this,xC)),(t=this.media?.textTracks)==null||t.addEventListener(`removetrack`,X(this,xC))},MC=function(){var e,t;if(!/Firefox/i.test(navigator.userAgent))return;let n,r=new WeakMap,i=()=>this.streamType===T.LIVE&&!this.secondaryColor&&this.offsetWidth>=800,a=(e,t,n=!1)=>{i()||Array.from(e&&e.activeCues||[]).forEach(e=>{if(!(!e.snapToLines||e.line<-5||e.line>=0&&e.line<10))if(!t||this.paused){let t=e.text.split(`
`).length,i=-3;this.streamType===T.LIVE&&(i=-2);let a=i-t;if(e.line===a&&!n)return;r.has(e)||r.set(e,e.line),e.line=a}else setTimeout(()=>{e.line=r.get(e)||`auto`},500)})},o=()=>{a(n,this.mediaController?.hasAttribute(B.USER_INACTIVE)??!1)},s=()=>{let e=Array.from(this.mediaController?.media?.textTracks||[]).filter(e=>[`subtitles`,`captions`].includes(e.kind)&&e.mode===`showing`)[0];e!==n&&n?.removeEventListener(`cuechange`,o),n=e,n?.addEventListener(`cuechange`,o),a(n,X(this,gC))};s(),(e=this.textTracks)==null||e.addEventListener(`change`,s),(t=this.textTracks)==null||t.addEventListener(`addtrack`,s);let c=()=>{let e=this.mediaController?.hasAttribute(B.USER_INACTIVE)??!0;X(this,gC)!==e&&(kx(this,gC,e),a(n,X(this,gC)))};this.addEventListener(`userinactivechange`,c),kx(this,SC,()=>{var e,t;n?.removeEventListener(`cuechange`,o),(e=this.textTracks)==null||e.removeEventListener(`change`,s),(t=this.textTracks)==null||t.removeEventListener(`addtrack`,s),this.removeEventListener(`userinactivechange`,c)})};function PC(e,t){return e.media?e.media.getAttribute(t):e.getAttribute(t)}var FC=NC,IC=e=>{throw TypeError(e)},LC=(e,t,n)=>t.has(e)||IC(`Cannot `+n),RC=(e,t,n)=>(LC(e,t,`read from private field`),n?n.call(e):t.get(e)),zC=(e,t,n)=>t.has(e)?IC(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),BC=(e,t,n,r)=>(LC(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),VC=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends VC{}globalThis.DocumentFragment=e}var HC=class extends VC{},UC=class extends VC{},WC={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(HC)}},GC,KC=class{constructor(e,t={}){zC(this,GC),BC(this,GC,t?.detail)}get detail(){return RC(this,GC)}initCustomEvent(){}};GC=new WeakMap;function qC(e,t){return new HC}var JC={document:{createElement:qC},DocumentFragment,customElements:WC,CustomEvent:KC,EventTarget:VC,HTMLElement:HC,HTMLVideoElement:UC},YC=typeof window>`u`||globalThis.customElements===void 0,XC=YC?JC:globalThis;YC?JC.document:globalThis.document,XC.customElements.get(`mux-player`)||(XC.customElements.define(`mux-player`,FC),XC.MuxPlayerElement=FC);var ZC=!0,QC={className:`class`,classname:`class`,htmlFor:`for`,crossOrigin:`crossorigin`,viewBox:`viewBox`,playsInline:`playsinline`,autoPlay:`autoplay`,playbackRate:`playbackrate`},$C=e=>e==null,ew=(e,t)=>$C(t)?!1:e in t,tw=e=>e.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`),nw=(e,t)=>{if(!(!ZC&&typeof t==`boolean`&&!t)){if(ew(e,QC))return QC[e];if(t!==void 0)return/[A-Z]/.test(e)?tw(e):e}},rw=(e,t)=>!ZC&&typeof e==`boolean`?``:e,iw=(e={})=>{let{ref:t,...n}=e;return Object.entries(n).reduce((e,[t,n])=>{let r=nw(t,n);return r&&(e[r]=rw(n,t)),e},{})};function aw(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}function ow(...e){return t=>{let n=!1,r=e.map(e=>{let r=aw(e,t);return!n&&typeof r==`function`&&(n=!0),r});if(n)return()=>{for(let t=0;t<r.length;t++){let n=r[t];typeof n==`function`?n():aw(e[t],null)}}}}function sw(...e){return o.useCallback(ow(...e),e)}var cw=Object.prototype.hasOwnProperty,lw=(e,t)=>{if(Object.is(e,t))return!0;if(typeof e!=`object`||!e||typeof t!=`object`||!t)return!1;if(Array.isArray(e))return!Array.isArray(t)||e.length!==t.length?!1:e.some((e,n)=>t[n]===e);let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r=0;r<n.length;r++)if(!cw.call(t,n[r])||!Object.is(e[n[r]],t[n[r]]))return!1;return!0},uw=(e,t,n)=>!lw(t,e[n]),dw=(e,t,n)=>{e[n]=t},fw=(e,t,n,r=dw,i=uw)=>(0,o.useEffect)(()=>{let a=n?.current;a&&i(a,t,e)&&r(a,t,e)},[n?.current,t]),pw=(()=>{try{return`3.13.0`}catch{}return`UNKNOWN`})(),mw=()=>pw,$=(e,t,n)=>(0,o.useEffect)(()=>{let r=t?.current;if(!r||!n)return;let i=e,a=n;return r.addEventListener(i,a),()=>{r.removeEventListener(i,a)}},[t?.current,n,e]),hw=o.forwardRef(({children:e,...t},n)=>o.createElement(`mux-player`,{suppressHydrationWarning:!0,...iw(t),ref:n},e)),gw=(e,t)=>{let{onAbort:n,onCanPlay:r,onCanPlayThrough:i,onEmptied:a,onLoadStart:o,onLoadedData:s,onLoadedMetadata:c,onProgress:l,onDurationChange:u,onVolumeChange:d,onRateChange:f,onResize:p,onWaiting:m,onPlay:h,onPlaying:g,onTimeUpdate:_,onPause:ee,onSeeking:te,onSeeked:ne,onStalled:re,onSuspend:ie,onEnded:ae,onError:oe,onCuePointChange:se,onChapterChange:ce,metadata:le,tokens:ue,paused:de,playbackId:fe,playbackRates:pe,currentTime:me,themeProps:he,extraSourceParams:ge,castCustomData:_e,_hlsConfig:ve,...ye}=t;return fw(`tokens`,ue,e),fw(`playbackId`,fe,e),fw(`playbackRates`,pe,e),fw(`metadata`,le,e),fw(`extraSourceParams`,ge,e),fw(`_hlsConfig`,ve,e),fw(`themeProps`,he,e),fw(`castCustomData`,_e,e),fw(`paused`,de,e,(e,t)=>{t!=null&&(t?e.pause():e.play())},(e,t,n)=>e.hasAttribute(`autoplay`)&&!e.hasPlayed?!1:uw(e,t,n)),fw(`currentTime`,me,e,(e,t)=>{t!=null&&(e.currentTime=t)}),$(`abort`,e,n),$(`canplay`,e,r),$(`canplaythrough`,e,i),$(`emptied`,e,a),$(`loadstart`,e,o),$(`loadeddata`,e,s),$(`loadedmetadata`,e,c),$(`progress`,e,l),$(`durationchange`,e,u),$(`volumechange`,e,d),$(`ratechange`,e,f),$(`resize`,e,p),$(`waiting`,e,m),$(`play`,e,h),$(`playing`,e,g),$(`timeupdate`,e,_),$(`pause`,e,ee),$(`seeking`,e,te),$(`seeked`,e,ne),$(`stalled`,e,re),$(`suspend`,e,ie),$(`ended`,e,ae),$(`error`,e,oe),$(`cuepointchange`,e,se),$(`chapterchange`,e,ce),[ye]},_w=mw(),vw=`mux-player-react`,yw=o.forwardRef((e,t)=>{let n=(0,o.useRef)(null),r=sw(n,t),[i]=gw(n,e),[a]=(0,o.useState)(e.playerInitTime??na());return o.createElement(hw,{ref:r,defaultHiddenCaptions:e.defaultHiddenCaptions,playerSoftwareName:vw,playerSoftwareVersion:_w,playerInitTime:a,...i})});export{xr as MaxResolution,w as MediaError,Sr as MinResolution,Cr as RenditionOrder,yw as default,na as generatePlayerInitTime,vw as playerSoftwareName,_w as playerSoftwareVersion};